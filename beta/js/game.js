...
return'<div class="action-card '+cls+(isNew?' is-new':'')+' fade-in" style="'+(outgrown?'opacity:0.6;':'')+'" onclick="'+onclick+'">'+topRow+'<h4>'+a.label+'</h4><p>'+desc+'</p>'+(!done&&!locked?this.ownedPreview(a.id):'')+(!done?this.actionPreview(a):'')+'<div class="action-costs">'+
...
dealToggleInfo(id){this._dealInfo=!this._dealInfo;this.openDealControl(this._dealCat||'finance',id);},
