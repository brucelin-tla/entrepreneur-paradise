...
'New playable strategy — Velocity Banking (Finance → Debt & Credit). Run your household through a line of credit and sweep your surplus straight at your debt, paying it down years faster. You choose the vehicle: a HELOC against your property (attacks the mortgage and builds equity quicker) or a credit line (attacks revolving debt).',
...
openVelocityControl(){const s=this.state;const active=!!s._velocity_active;
