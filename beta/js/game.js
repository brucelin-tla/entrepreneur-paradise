...
// Business gets Customers > Leads+Brand Equity then Systems Maturity > Culture+Staff.
...
// render above Customers regardless of LLC status (same as Founder Freedom used to — not gated on sep).
...
B+='<div id="biz-ops">'+subLab('Marketing & Operations')+cgauge('👥 Customers',s.customer_base||0,Math.min(100,s.customer_base||0),'var(--accent)',true);
