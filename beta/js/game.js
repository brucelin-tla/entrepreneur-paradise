...
// gets Founder Freedom (moved off the Business side — it's a founder question, not a business-
// finances one) then Energy > Personal Mastery; Business gets Customers > Leads+Brand Equity then
// Systems Maturity > Staff+Culture.
...
if(this._reveal('mastery'))P+=gauge('🕊️ Founder Freedom',fr,frC,this.getFounderRole());
