...
async init(){await loadConfig();this._initSupabase();this.renderMainMenu();this.renderTitleMeta();this._renderUpdateIcon();this._checkForUpdate();this._initBetaBadge();
