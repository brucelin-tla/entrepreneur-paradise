...
if(_pm==='credit'){this.coverShortfall(_cost);}
else if(_pm==='split'){const _fc=Math.min(Math.max(0,this.state.cash),_cost);this.state.cash-=_fc;this.coverShortfall(_cost-_fc);}
else{const _fc=Math.min(Math.max(0,this.state.cash),_cost);this.state.cash-=_fc;if(_cost-_fc>0)this.coverShortfall(_cost-_fc);}
