...
const specs=[
 ...
 // Holding company before the full protection stack — the funding-ready structural layer (bank access + liability shield).
...
results.push(_ro);if(cat==='epic'||cat==='epicbuy')this._epicLastMove={label:action.label,narrative:_ro.narrative,success:success};if(action.id==='debt_restructure'&&this._deferRestructure)this._deferRestructure.ro=_ro;}
