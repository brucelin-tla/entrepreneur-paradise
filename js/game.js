...
const TRAP_META={fast_working_capital:{i:'💸',n:'Merchant Cash Advance'},offmarket_guaranteed_fund:{i:'🎰',n:'"Guaranteed" Fund Scam'},rapid_offshore_scaleup:{i:'🌏',n:'Offshore Over-Hire'},vanity_follower_boost:{i:'🤖',n:'Bought Followers'},influencer_megadeal:{i:'📣',n:'Influencer Megadeal'},national_ad_blitz:{i:'📺',n:'National Ad Blitz'},hire_highticket_closer:{i:'🎯',n:'High-Ticket Closer'}};
...
if(action.id==='establish_business'&&success&&!this.state.company_name)this._pendingCompanyName=true;
...
if(this._pendingCompanyName){this._pendingCompanyName=false;setTimeout(()=>{if(document.getElementById('popup-container').style.display!=='block')this.promptCompanyName(true);},300);}},
...
this._myLBName=name;this._lbSubmitGlobal(entry);
