...
const stats=[
{label:'Cash + Credit (P'+persUtil+' B'+bizUtil+')',value:this.fmtMoney(s.cash)+'<span style="font-size:0.62rem;color:var(--text2);"> +'+this.fmtMoney(totalAvail)+'</span>',color:s.cash>5000?'positive':s.cash<2000?'negative':'warning',info:'CreditAvail'},
