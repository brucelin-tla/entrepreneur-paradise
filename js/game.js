...
// Beta Tester access lives in the SAME game.js for root and beta (so promotion is a clean copy), but only shows on the LIVE build — hidden when you're already inside /beta/.
if(location.pathname.indexOf('/beta/')<0)h+=item('🧪','Beta Tester','Try the new overhaul (code required)','Game.showBeta()');
