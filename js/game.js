...
const ADIR={finance:[['Build Your Foundation',['establish_business','build_dnb_profile','build_personal_credit','banking_relationship']],['Debt & Credit',['pay_down_debt','debt_restructure','bank_personal_loan','business_credit_line','sba_loan','equipment_financing','merchant_cash_advance']],['Protect & Optimize Taxes',['elect_s_corp','wyoming_holding_llc','living_trust','combined_insurance','monthly_tax_reserve','retirement_plan','hire_your_kids','captive_insurance']],['Build Wealth & Passive Income',['fund_accumulation_policy','activate_passive_income','policy_loan','private_banking','buy_str','buy_real_estate','cash_out_refi']]],marketing:[['Your Team',['hire_sales_manager']],['Get Leads',['cold_outreach','basic_social_content','paid_ads_test','influencer_megadeal']],['Build Trust',['build_offer','content_engine','referral_asks']],['Close the Sale',['do_sales_yourself','crm_pipeline','hire_highticket_closer']]],operations:[['Your Team',['hire_ops_manager','hire_star_operator']],['Deliver the Work',['study_business_content','do_work_yourself','hire_first_contractor','rapid_offshore_scaleup']],['Build Systems',['write_first_sop','fulfillment_system','project_management']],['Keep Customers Happy',['basic_quality_control','client_onboarding']]]};
...
// Repeatable INVESTMENTS (not chores): taking one means you OWN another unit, so they never gray out as "done" — they show an ×N-owned badge and stay shuffled in with fresh choices (see renderActions).
...
const PATCH_NOTES=[
{v:'0.68.31',d:'2026-07-05 11:59',n:[
'Real estate leverage has real teeth now. Down payment floor raised from 10% to 20% (real investment-property loans essentially never go lower). Max out at the new floor and you now pay an ongoing high-LTV surcharge — real PMI — cutting into your rental income every month you stay over 80% loan-to-value, not just in a downturn. And the downturn crash test itself no longer taps you on the wrist for exactly one property regardless of portfolio size — spam a bunch of thin-margin deals and a bad downturn can now cost you most of them, while a conservatively-leveraged portfolio still rides straight through untouched.'
]},
...
{v:'0.68.28',d:'2026-07-05 01:21',n:[
'Fixed a real money-glitch: Debt Restructure was quietly inflating your personal available credit every time it ran, and liquidating that credit into cash (⭐ Cash Services) turned the phantom number into real spendable millions. Restructuring debt still lowers your utilization and raises your score — it just no longer hands you a fake, ever-growing personal credit limit to cash out.'
]},
{v:'0.68.27',d:'2026-07-04 21:08',n:[
'Fixed Finance sometimes running itself on \'Run the Month\' once you reached the Wealth stage — Finance is the one call that\'s always yours, so it now always needs your own pick, every turn.'
]},
{v:'0.68.26',d:'2026-07-05 06:00',n:[
'📈 <strong>Fixed: passive income score wasn\'t counting most passive income</strong> — the end-game "passive income" score used its own narrow estimate (real-estate door count × a flat rate, investments, pledged-line balance) instead of your ACTUAL passive income. If your passive income came from private lending, an acquired business, or anything else outside that narrow list, the score could read near 0 even with real money coming in every month. Now uses the same total shown everywhere else (Financial Health, the Epic Life Roadmap).',
'💼 <strong>Fixed: a delegated Finance turn could silently do nothing</strong> — once your team takes over Finance (Wealth stage or passive income on), a few moves stay a player-only call on purpose (high-risk financing, character-driven hires) and are never auto-picked. If those were the only finance options left some month, your team correctly refused to touch them — but nothing told you, so the turn just passed with zero feedback. Now shows a plain "No Finance Move This Month" note on the result screen when that happens.']},
{v:'0.68.25',d:'2026-07-05 04:30',n:[
'🛡️⚡📊💼 <strong>Cleaner Epic Life panels</strong> — Cash-Value Policy, Velocity Banking, Financial Health, and Owner Capital were reorganized the same way: a plain Dashboard up top, your controls below, Confirm at the bottom. The top-right corner of each now opens a plain-language "Understand X" explainer instead of the generic Membership link (Membership itself moved to a link right on the ⭐ Epic Life hub).',
'💵 <strong>Cash Services folded into Owner Capital</strong> — turning credit into cash (or paying utilization down) now lives in the same panel as injecting or loaning your own capital, instead of a separate tile.',
'🎛️ <strong>Concierge focus simplified</strong> — Financial Health\'s auto-pilot now offers two clear strategies, Protection or Max Leverage, instead of four overlapping ones. Tap your current pick again to go back to the default playbook order.',
'🧾 <strong>Folding your tax reserve into the policy is now a real safety net, not just at tax time</strong> — if cash ever runs out and the reserve is empty, the rescue now falls through to a tax-free policy loan automatically, same as it already did for an actual tax bill.',
'👷 <strong>New: Operator Capacity</strong> — real estate AND financed equipment (ATM routes, etc.) now draw from one staffing pool. Hire an Asset Operator (Operations) to safely cover more income assets — each operator covers 2. Go over capacity and unstaffed assets both earn less and carry more risk of losing their operator. Insure Your Operators (Finance) now covers equipment too, and losing an uninsured/insured operator plays out realistically for whichever asset type is short-staffed.']},
{v:'0.68.24',d:'2026-07-05 02:00',n:[
'🏢 <strong>Investment deals are now consistently business-funded</strong> — Pledged Asset Line and Cash-Out Refi used to have their own ad-hoc, DIFFERENT rules for whether the money came from your personal or business pocket (one compared account balances, the other just checked separation status). Now all 5 deal-panel plays (real estate, STR, equipment financing, Pledged Asset Line, Cash-Out Refi) draw from and pay into business accounts consistently, matching the "business funds business deals" principle. Want to fund a deal with personal wealth? Inject or loan it in through 💼 Owner Capital first — the real, deliberate way.',
'💸 <strong>Passive income breakdown</strong> — the Epic Life Roadmap\'s passive-income line is now clickable, showing exactly what\'s adding up to that number: real estate/STR rental income, other passive investments, tax-free policy income, and Pledged Asset Line carry, each broken out.']},
{v:'0.68.23',d:'2026-07-05 01:15',n:[
'📊 <strong>Energy, Customers, and Systems Maturity are now clickable</strong> — same as Capital, Cash Flow, and Credit Score/D&B already were. Tap the number for a real breakdown (Energy: how your recovery rate is built; Customers: what\'s filling and draining the bucket; Systems Maturity: your org capacity and what it\'s protecting). Customers and Systems Maturity also each got their OWN independent toggle for Brand Equity/Leads and Culture/Staff — opening one no longer bundles with the other.',
'🔍 <strong>Credit Score and D&B, explained for real</strong> — their breakdown popups now show the actual weighted formula behind the number: for personal, the 5 real FICO factors at their real weights (Payment History 35%, Utilization 30%, Length of History 15%, Credit Mix 10%, New Credit 10%); for business D&B, the 4 real components (Business Profile, Business Identity, Credit Depth, Vendor Tradelines) plus the utilization penalty. Plain language, real math — the same numbers that actually produced the score you\'re looking at.']},
{v:'0.68.22',d:'2026-07-05 00:20',n:[
'🧾 <strong>Fold-your-tax-reserve-in is no longer a monthly popup</strong> — it kept re-asking every few months and got annoying. It now lives as an on-demand button inside the 🛡️ Cash-Value Policy panel, available any time you\'re holding a reserve — nothing interrupts your turn anymore.']},
...
'🏖 <strong>Solo 401(k)/SEP</strong> now opens its own slider to pick your contribution rate, grounded in real 2025 IRS limits instead of a flat cap.',
'🛡️ <strong>Cash-value policy</strong> gained a Repay-the-loan slider (mutually exclusive with borrowing) — pays down the policy loan with cash, raising net cash value and passive income.',
'📋 Result screen now matches action cards — impacted stats + before/after are always visible, only the narrative/lesson collapses.',
'🏠 Property/investment deals (real estate, STR, Pledged Asset Line, cash-out refi, equipment financing) no longer show a misleading "↻ RETRY — HALF COST" badge — their cost is a fresh roll every month, not a fixed price to chip away at.',
'💰 CFO performance bonus removed (Sales &amp; Ops Manager bonuses stay); Hire Your Kids and Captive Insurance retired for now.',
'🧾 Tax-reserve → policy "fold" offer now re-checks every month (with a cooldown) instead of only the instant you fund the policy.',
'📅 Month-24 checkpoint screen removed — the run now only pauses at Month 18 (Part 1 Finale) and the end; Month 24 auto-saves quietly like Month 12 already did.']},
{v:'0.68.19',d:'2026-07-04 22:00',n:[
'📋 Action cards now show just the title — tap one to select it and see the full description, or tap "ⓘ preview" on any card to peek at it without committing. Locked moves are peekable too. A new filter bar (All / ✨ Untried / 🔑 Opens more) helps narrow a long list, and a "↺ last pick" tag marks whatever you took last time. Deal panels (Pledged Asset Line, rentals, Airbnb/STR, cash-out refi): "Understand this investment" stays collapsed until you tap it, with a NEW badge the first time. Managers/board: the bottom button now reads "Next: Finance →" / "Next: Life →" instead of surprising you with a popup after "Run the Month."']},
...
'📊 Dashboard: the 5 life-dimension stats under Personal Mastery (Body/Mind/Spirit/Heart/Luxury) are now hidden behind "Show Details", same as the other detail stats. Always-shown headlines (Capital, Cash Flow, Credit Score/D&B, Freedom, Personal Mastery, Energy, Customers, Systems Maturity) are now bolded, so once details are open it\'s obvious which were there before you tapped. Business side: Systems Maturity now shows above Customers.']},
{v:'0.68.15',d:'2026-07-04 18:00',n:[
'📊 Dashboard polish: "Accessible Capital" is now just "Capital" (with its own 💰 icon); "Founder Freedom" is now "Freedom", moved up under Personal Mastery — both now always shown, with Energy staying last at the bottom. Business side: Culture now shows above Staff.']},
{v:'0.68.14',d:'2026-07-04 17:00',n:[
'📊 Dashboard reorder: each headline number now leads its own hidden breakdown — Accessible Capital → Cash + Credit, Cash Flow → Income/Revenue + Expense, Credit Score/D&B Score → Debt. Passive/mo dropped as its own line (still counted in Cash Flow). Founder Freedom moved to the Personal side, above Energy → Personal Mastery. Business now reads Customers → Brand Equity + Leads, then Systems Maturity → Staff + Culture.']},
...
'⚡ Draw recommendations got the same duration honesty as everything else — ALIS now compares what each $1k moved actually saves over the loan\'s REMAINING LIFE against the 6% fee plus the line\'s carry, and shows you both numbers. A one-time fee vs. an annual rate was apples and oranges.',
'🧰 Equipment catalog curated for STORY — the kitchen line, CNC and solar are out; in their place: a 🎪 <strong>Bounce House Fleet</strong> (weekend money, weather risk, teenage labor) and a 🚙 <strong>Turo Fleet</strong> whose limited write-off teaches the under-6,000-lb depreciation caps — the exact reason the G-Wagon exists. Every machine earns its slot with a story now.',
'🚀 <strong>This build went LIVE</strong> — everything since v0.59.3 (deal panels, equipment collection, real Sec. 179, ALIS-driven velocity, and ~20 releases of fixes) is now the public game.']},
{v:'0.68.4',d:'2026-07-03 00:55',n:[
'⚡ ALIS now weighs your loans across <strong>both vehicles at once</strong> — if your credit line attacking a business loan beats the HELOC attacking the mortgage under your objective, it says so and switches. The loan picks the vehicle, not the other way around.']},
{v:'0.68.3',d:'2026-07-03 00:40',n:[
'⚡ <strong>ALIS drives Velocity Banking now — you pick the objective, it does the math.</strong> Choose 💰 <strong>Max interest saved</strong> (duration-aware amortization math: every loan shows lifetime interest removed per $1k chunked — a long cheap loan can beat a short expensive one) or ⏱️ <strong>Free cash flow fastest</strong> (kill the loan closest to dead so its whole payment joins the sweep — ALIS even calls the exact kill shot when your cash can finish it). ALIS also picks the vehicle (HELOC with equity, credit line otherwise) and pre-sets chunk &amp; draw with its reasoning shown. Full loan list one tap away with 🎯 on the pick, per-loan math on every row.']},
...
'🛥️ <strong>Luxury &amp; Flex equipment</strong> — the catalog grew a lifestyle section: the G-Wagon (real 179 write-off, real audit flag), a charter-managed yacht, and a light aircraft. They boost your lifestyle score and brand — the flex is genuine — but they cost you monthly, the write-offs are limited to documented business use, and every one raises your audit risk. Legal, powerful, and priced like the toys they are.',
'⚖️ <strong>Equipment rebalance</strong> — trimmed the catalog to 8 business machines and tuned yields to real-world numbers: vending route and ATM route earn like real routes now, solar is honestly "tight over the loan, gravy after," CNC and box truck came down from too-generous.']},
{v:'0.65.2',d:'2026-07-02 21:35',n:[
'💵 Cash Services: one stats box, matching the policy panel — your available credit, cash and the before→after projection all live in a single "Your credit · if you confirm" box below Confirm.']},
{v:'0.65.1',d:'2026-07-02 21:20',n:[
'🛡️ Cash-Value Policy panel: one stats box instead of two — cash value, borrowable and surrender charge now live inside the single "Your policy · if you confirm" box with the before→after rows.']},
{v:'0.65.0',d:'2026-07-02 21:00',n:[
'🚚 <strong>Equipment picker</strong> — Finance Equipment now opens a catalog of real-world plays: espresso line, vending route, box truck, food trailer, the famous 6,000-lb "Sec. 179 write-off" SUV, solar, CNC, ATM route, laundromat refit, car-wash tunnel. Bigger revenue unlocks bigger tiers; 10% down, ~9% APR over 5 years; each machine shows its payment vs. what it earns (🟢🟡🔴) — and yes, the G-Wagon is deliberately 🔴: the write-off is real, the payment is still bigger than what it earns.',
'⭐ <strong>One Epic Life Roadmap card</strong> — progress bar and your passive-income-vs-needs number are now one and the same card (the ladder and duplicate readouts are gone). Financial Health slimmed down: plain "Confirm" button, pause removed, bottom advice card removed.',
'✅ <strong>Confirm is a toggle everywhere with a color flip</strong> — tap Confirm (gold) → "✓ Confirmed" (green); tap again to undo. Deal panels and the equipment picker both.',
'🎛 Velocity: chunk-effectiveness box moved BELOW Confirm (the resizing box was making the button jump while you slide). Cash services: the projection moved below Confirm for the same reason.',
'🛡️ Switching Wash ↔ Index in the policy panel now visibly moves the passive-income numbers everywhere in the panel (Index draws 8%, Wash 6%).']},
{v:'0.64.2',d:'2026-07-02 20:20',n:[
'🛡 Insure Your Operators now leaves the menu once it\'s active — coverage automatically extends to every new operator you bring on (the premium adjusts itself), so re-taking it would just burn a move.']},
...
'🛡️ Policy projection now reacts to the <strong>loan type</strong> — flip Wash ↔ Index and watch the passive-income number change before you confirm.',
'🏝️ <strong>Freedom got honest</strong> — "financially free" now means passive income covers your living expenses AND your debt service. The Paradise ladder moved from Financial Health into the Epic Life roadmap (it IS the journey), and the roadmap bar dropped its checkpoint tick-lines — the fill is the progress.',
'📋 Results: Achievements moved to the very top; back to per-card tap-for-details (the combined card lost the playtest); the duplicate passive-income line in the concierge card removed; the CFO briefing button retired.',
'🔓 Fixed locked-action reasons blaming the wrong requirement — e.g. the Pledged Asset Line told a 800-score player they needed "680 credit" when the real blocker was the $40k. Lock reasons now name the requirement you actually fail.']},
{v:'0.63.1',d:'2026-07-02 18:50',n:[
'🛡️ <strong>Wash loan now says what it is: net 0%</strong> — the "Fixed · 3%" label read like a cost. It\'s a wash: 3% charged on the loan, 3% credited to the borrowed slice — they cancel exactly. The borrowed slice does NOT earn the index (that\'s the trade vs. the Index loan); the rest of your cash value still does. Mechanics were already right — the words weren\'t.']},
{v:'0.63.0',d:'2026-07-02 18:20',n:[
'🎛 <strong>Deal panels, decluttered</strong> — ← Back sits top-left, the slider sits right above Confirm (all the moving parts in thumb reach), and the extra buttons ("Got it", "✕ Remove") are gone. Picking a different finance move replaces a queued deal.',
'🛡️ <strong>Index loan fixed to reality</strong> — the policy\'s variable loan is now a true INDEX LOAN at a flat 5% charged (modeled on John Hancock\'s Accumulation IUL), instead of floating with the market rate. Your full cash value keeps earning the index; the spread is the play, the lapse risk is the price.',
'📚 <strong>One details card on results</strong> — all the stat chips, before→after tables and lessons now collect into a single "Details & lessons" card. Readers expand once; skippers scroll past nothing.',
'🧹 <strong>Less clutter</strong> — velocity banking leaves the finance menu once it\'s ON (manage it from the ⚡ chip); the Epic Life System bar and the Achievements button left the game screen (achievements now live on the results screen); passive income folded into the concierge card; exec performance bonuses moved next to the expense breakdown.',
'🤖 Sim-start recap now marks moves that didn\'t go through with ✗ — failed attempts never counted as completed, and now they don\'t LOOK it either.']},
...
'🟢🟡🔴 <strong>Deal ratings + "How to read a deal"</strong> — every property shows a quality tag (yield vs. price, rated against an average market deal), and each panel opens with a first-time primer on evaluating deals, sizing your draw, and reading LTV headroom.',
'💵 Property down payments are now honest: you pay your chosen % of the actual purchase price (10–50%), and more down means more of the rent is yours.']},
{v:'0.60.0',d:'2026-07-02 00:05',n:[
'🆕 Three new late-game wealth moves: open a <strong>Pledged Asset Line</strong> (borrow cheap against a portfolio that keeps compounding), buy a <strong>Short-Term Rental</strong> (double the cash flow of a rental + a tax shield on your active income — but it leans on your time and lives under city rules), and run a <strong>Cash-Out Refinance</strong> (pull trapped equity back out tax-free to buy the next deal).',
'🏠 New Portfolio view on the dashboard: your doors, monthly rent, and loan-to-value at a glance — tap for the full breakdown, including how close you are to margin-call territory.',
'🔁 Investments no longer gray out as “done” — they show ×N owned and stay up top with your fresh choices, and the menu reshuffles each month. When every fresh move is taken, the menu shifts to “grow the portfolio” mode.',
'📉 New risk: stretch a pledged line or lever a property past ~75% and a downturn can now margin-call you — forced selling at the bottom. Conservative leverage rides it out.',
'🏛 Living Trust now counts toward your Protection score (it was invisible before).',
'⚠️ New event: a city short-term-rental crackdown can hit Airbnb owners — comply or pay.',
]},
...
{v:'0.56.2',d:'2026-07-02 03:20',n:[
'💼 My Real Finances upgrades: Financial Health gets a live “drag your passive income” slider so you can watch the Paradise ladder fill; the Debt/Velocity planner now targets your 4 loan types (mortgage, personal, auto, student) and lets you attack one with a cash + HELOC + credit-line mix (with a net-annual-saving read so you see when borrowing cheaper actually wins); the Policy illustration shows monthly AND annual passive, goes up to $1M, and lets you compare a fixed vs variable loan.',
]},
...
'⚡ Velocity Banking: pick your vehicle AND the exact loan to attack, slide your chunk/draw, preview the interest removed, then Confirm. The monthly sweep is now a free Activate/Pause toggle you can flip anytime after setup.',
'💵 Cash Services: added a slider to dial in the exact amount.',
'📊 Financial Health now folds in your Concierge controls, and adds a “Is passive income beating…” ladder — debt service → living → operating → 🏝️ Paradise.',
'🗺️ Roadmap now shows the full journey with three checkpoints: Funding Ready → Epic Life System → 🏝️ Paradise.',
]},
...
'Taste passive income sooner: opening your cash-value policy now pays a small +$340/mo dividend right away — the first real “money that shows up whether you work or not,” long before the full engine switches on.',
'More to celebrate mid-game: new milestones (First Passive Dollar, The Leverage Stage, $5k/mo Passive, Wealth Stage) so progress never goes quiet on the way to the finale.',
'Q4 is now a decision, not a silent slump: when the seasonal dip hits, choose how to respond — weather it, run a discount push (spend for customers), or cut costs to protect cash.',
'Leaderboard now ranks two milestones: your Part 1 score (month 18) and your final Paradise score (month 36).',
]},
...
'New ⭐ Epic Life perk — 💵 Credit → Cash: liquidate your available credit into spendable cash for a flat 6% fee, no turn used (draws business credit first to protect your personal score). A priced cash advance for seizing opportunities — not free money.',
'Debt Restructure rebalanced: it no longer maxes out your business credit or hands you a big cash advance, and early-game credit lines/loans are sized more realistically (capacity grows with revenue, but gently). It still cleans up your utilization and score.',
]},
{v:'0.49.0',d:'2026-06-30 18:00',n:[
'Real-estate leverage fix: you can now actually buy “Insure Your Operators” — an operator loan-protection policy that pays off a property’s mortgage if you lose the person running it. It was described but never purchasable before, so an operator loss always resolved as uninsured. Coverage auto-tracks your portfolio: buy another property and its operator is covered too.',
'Clearer naming: the property-operator cover is now called “operator loan-protection” everywhere, kept separate from the key-person cover inside your Business Insurance bundle (which protects a key employee). No more confusing the two.',
'New Game+ simplified: the head start is now just Epic Life membership on/off — the starting-energy, pre-built-business, and entity-structure options were removed.',
]},
{v:'0.48.0',d:'2026-06-30 17:00',n:[
'Tidier menu: "Redeem Code" and "Beta Tester" are folded into a single "Enter a Code" box — one place for a beta code or an unlock code.',
]},
...
'Rebalanced the tough early starts (Stuck & New founders) for the leaner, more realistic economy: a bit more opening runway and a faster first ramp, so a careful player can claw their way up.',
'The Revenue and CFO breakdowns now show your addressable market and explain where your real ceiling comes from.',
]},
...
'Real-world accuracy pass on the lessons & info screens so the game teaches what actually happens: IUL growth now shown as index-linked with a cap and 0% floor (not a flat guaranteed 7%) and the lapse/MEC risks named; velocity banking clarified (the acceleration comes from your surplus cash flow, not the line itself); the merchant-cash-advance APR corrected to the brutal 80–100%+ it really is; real-estate depreciation explained as a deferral with recapture (and the 1031 exchange); the S-corp "reasonable salary" rule, captive-insurance §831(b) caps/risk-distribution, disability-insurance deduct-or-tax-free tradeoff, Section 179 limits, and quarterly estimated taxes all spelled out.',
'Wealth-stage power move — Captive Insurance (§831(b)). Form your own insurance company: your business pays it deductible premiums (lowering taxable income) and those premiums accumulate inside the captive almost tax-free as reserves you own — converting a deductible expense into a protected, compounding asset. It lowers your lawsuit exposure and shows in your net worth, but carries some audit risk (it must be real insurance). This is how the wealthy self-insure and build a tax-advantaged war chest.',
'Two new people storylines that teach the hard lessons of hiring. The High-Ticket Closer: huge short-term sales, but he gaslights the team, tanks culture, and invites lawsuits — a few months in you face a real decision (confront him, fire him and eat the settlement, or keep cashing the checks while the damage compounds). The Star Operator: a brilliant résumé who came for the opportunity, not the mission — does his job and nothing more, never owns a problem, and a mid-arc choice lets you try to win him over (culture decides your odds), let him go cleanly, or keep him until he inevitably resigns. Hire for character and vision, not just talent.',
]},
...
'New end-game leverage loop: buy income properties, then insure the people running them. If an operator is lost, an operator loan-protection policy retires that property’s specific mortgage — a real backstop, not a windfall.'
]},
...
_initBetaBadge(){if(location.pathname.indexOf('/beta/')<0&&!(location.protocol==='file:'&&window.__EP_BETA===1))return;/* offline builds carry a build-time marker: beta's game.html sets __EP_BETA=1, the promoted root build sets 0 — so the PUBLIC offline file never shows beta chrome */if(document.getElementById('beta-chip'))return;const c=document.createElement('div');c.id='beta-chip';c.textContent='🧪 BETA';c.setAttribute('role','button');c.setAttribute('aria-label','Beta testing build — tap for info');c.onclick=()=>this.showPopup('🧪 Beta — Testing Build','<div style="line-height:1.6;font-size:0.9rem;">You\'re on the <strong>testing build</strong>. New features and balance changes land here first, so things may change or break — and your progress here is <strong>separate from the live game</strong>.<br><br>Thanks for testing! If something feels off, note the <strong>month</strong> and what you did.</div>');document.body.appendChild(c);},
...
REDEEM_CODES:{
epiclife:{label:'Epic tools',msg:'Unlocked! New Game+ and 💼 Epic Tools are now on the main menu.',apply(){try{localStorage.setItem('ep_ngplus','1');}catch(e){}}},
ledger:{label:'Epic Life Ledger',msg:'Unlocked! Loading your Ledger…',redirect:'epicledger/',apply(){try{localStorage.setItem('ep_ledger','1');}catch(e){}}}
},
...
// One code box for BOTH beta access and redeem/unlock codes (folded together to cut menu clutter). Beta code → jump to the testing build (live only); anything else is checked against REDEEM_CODES.
showCode(){const inBeta=location.pathname.indexOf('/beta/')>=0;const intro=inBeta?'Have an unlock code? Enter it to unlock bonus content.':'Enter a <strong>beta code</strong> to jump to the testing build, or an <strong>unlock code</strong> for bonus content.';const h='<div style="font-size:0.8rem;color:var(--text2);line-height:1.5;margin-bottom:10px;">'+intro+'</div><input id="code-input" class="name-input" placeholder="Enter code" autocomplete="off" autocapitalize="off" spellcheck="false" onkeydown="if(event.key===\'Enter\')Game.enterCode()"><button class="btn-primary" style="margin-top:4px;" onclick="Game.enterCode()">Enter</button><div id="code-msg" style="min-height:18px;margin-top:10px;font-size:0.82rem;font-weight:600;text-align:center;line-height:1.45;"></div>';this.showPopup(inBeta?'🎟 Redeem a Code':'🧪 Beta &amp; Codes',h);setTimeout(()=>{const i=document.getElementById('code-input');if(i)i.focus();},40);},
...
const def=this.REDEEM_CODES[code];if(!def){msg.style.color='var(--red)';msg.textContent='✕ That code isn’t valid.';return;}const done=this._redeemedCodes();if(done.includes(code)){msg.style.color='var(--gold)';msg.textContent='Already redeemed — '+def.label+' is unlocked.';if(def.redirect){setTimeout(()=>{window.location.href=def.redirect;},500);}return;}try{def.apply();}catch(e){}done.push(code);try{localStorage.setItem('ep_codes',JSON.stringify(done));}catch(e){}msg.style.color='var(--accent)';msg.innerHTML='✓ '+def.msg;if(el){el.value='';el.disabled=true;}this.renderMainMenu();if(def.redirect){setTimeout(()=>{window.location.href=def.redirect;},600);}},
...
RM_BOOK_URL:'https://calendly.com/brucelife/biz',/* real Epic Life Strategist booking link */
RM_APR:{cards:0.24,mortgage:0.07,personal:0.12,auto:0.08,student:0.065,sba:0.105},RM_TERM:{mortgage:360,personal:60,auto:60,student:120,sba:120},/* today's common APRs + standard amortization terms — demo/education, not exact */
...
rmHome(){if(!this._rmUnlocked())return this.showCode();this._rmVel=null;this._rmCash=null;this._rmPol=null;this._rmHP=null;this._rmPlan=null;const d=this._rmData();if(!d)return this.rmIntake();const fm=v=>this._rmFmt(v);
 ...
 this._rmPanel('💼 Epic Tools',h,true);},
...
rmIntake(){if(!this._rmUnlocked())return this.showCode();const d=this._rmData()||{},pol=d.policy||{},re=d.re||{};
 ...
 const DT=[['cards','Credit cards',50000,500],['mortgage','Mortgage',1000000,5000],['personal','Personal loan',60000,1000],['auto','Auto loan',80000,1000],['student','Student loans',200000,2000],['sba','SBA / business loan',500000,5000]];
...
rmSaveIntake(){const n=id=>{const e=document.getElementById(id);const v=e?parseFloat(e.value):NaN;return isFinite(v)?Math.max(0,v):0;};
 const DT=[['cards','Credit cards'],['mortgage','Mortgage'],['personal','Personal loan'],['auto','Auto loan'],['student','Student loans'],['sba','SBA / business loan']];
...
rmHealth(){const d=this._rmData()||{},fm=v=>this._rmFmt(v);
 const nw=this._rmNetWorth(d),dsvc=this._rmDebtService(d),living=+d.expLiving||0,other=+d.expOther||0,income=+d.incomeMonthly||0;
 if(this._rmHP==null)this._rmHP=+d.passiveMonthly||0;const passive=Math.max(0,Math.round(this._rmHP));
...
rmHealthPassive(v){this._rmHP=Math.max(0,Math.round(+v||0));this.rmHealth();},
// Debt / Velocity planner — pick a LOAN and attack it with a cash / HELOC / credit-line mix. Shows payoff + the rate-arbitrage lesson.
rmVelocity(){const d=this._rmData()||{},fm=v=>this._rmFmt(v);
 const loans=(d.debts||[]).filter(x=>x.type!=='cards'&&(+x.balance||0)>0&&(+x.payment||0)>0);
 if(!loans.length){this._rmPanel('⚡ Debt / Velocity','<div style="font-size:0.82rem;color:var(--text2);line-height:1.55;">Add at least one loan (mortgage, personal, auto or student) in <strong>✏️ Edit my numbers</strong> to plan a payoff. (Credit cards are handled in Cash Services.)</div>');return;}
 if(!this._rmVel)this._rmVel={id:loans[0].id,cash:0,credit:0,heloc:0};const st=this._rmVel;if(!loans.find(x=>x.id===st.id))st.id=loans[0].id;
 // ALIS picks the loan for the member's objective — same math as the in-game engine (marginal interest per $1k over the loan's REMAINING life, or months-to-kill), run on their REAL numbers.
 if(!st.goal)st.goal='interest';
 const _sc=x=>{const b=+x.balance||0,p=+x.payment||0,r=+x.rate||0;if(st.goal==='cashflow'){const m=this._monthsRemaining(b,r,p);return isFinite(m)?-m:-9999;}const s1=Math.min(1000,b),sv=this._interestRemaining(b,r,p)-this._interestRemaining(Math.max(0,b-s1),r,p);return isFinite(sv)?sv/Math.max(1,s1):0;};
 {const _alis=loans.slice().sort((a,b)=>_sc(b)-_sc(a))[0];if(_alis&&st.id!==_alis.id){st.id=_alis.id;st.cash=0;st.credit=0;st.heloc=0;}}
 const dt=loans.find(x=>x.id===st.id),bal=+dt.balance,rate=+dt.rate||0,pay=+dt.payment;
 const cashMax=Math.max(0,Math.round(+d.cash||0)),creditMax=Math.max(0,Math.round((+d.creditLimit||0)-(+d.creditUsed||0)));
 const mortBal=((d.debts||[]).find(x=>x.type==='mortgage')||{}).balance||0,helocMax=Math.max(0,Math.round((+((d.re||{}).value)||0)*0.85)-Math.round(mortBal));
 const CR=0.24,HE=0.085;/* current credit-card & HELOC rates */
 st.cash=Math.max(0,Math.min(Math.round(st.cash||0),cashMax,Math.round(bal)));st.credit=Math.max(0,Math.min(Math.round(st.credit||0),creditMax,Math.round(bal)));st.heloc=Math.max(0,Math.min(Math.round(st.heloc||0),helocMax,Math.round(bal)));
 let cA=st.cash,crA=st.credit,heA=st.heloc,total=cA+crA+heA;if(total>bal&&total>0){const f=bal/total;cA=Math.round(cA*f);crA=Math.round(crA*f);heA=Math.round(heA*f);total=cA+crA+heA;}
 const eff=Math.min(total,Math.round(bal));
 ...
 {const gB=(k,l,s2)=>{const on=st.goal===k;return '<div onclick="Game.rmVelGoal(\''+k+'\')" style="cursor:pointer;flex:1;border:1px solid '+(on?'var(--gold)':'var(--border)')+';background:'+(on?'rgba(245,200,66,0.12)':'var(--surface)')+';border-radius:6px;padding:7px 6px;text-align:center;"><div style="font-size:0.7rem;font-weight:700;color:'+(on?'var(--gold)':'var(--text)')+';">'+l+'</div><div style="font-size:0.54rem;color:var(--text2);margin-top:2px;line-height:1.3;">'+s2+'</div></div>';};
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:4px;">Your objective</div><div style="display:flex;gap:8px;margin-bottom:6px;">'+gB('interest','💰 Max interest saved','duration-aware, not just the APR')+gB('cashflow','⏱️ Free cash flow fastest','finish a loan → its payment is yours again')+'</div>';
 const _tm=this._monthsRemaining(bal,rate,pay),_s1=Math.min(1000,bal),_sv=Math.round(this._interestRemaining(bal,rate,pay)-this._interestRemaining(Math.max(0,bal-_s1),rate,pay));
 h+='<div style="border:1px solid var(--gold);background:rgba(245,200,66,0.08);border-radius:6px;padding:8px 11px;margin-bottom:6px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:0.74rem;font-weight:700;color:var(--gold);">🤖 ALIS\'s pick: '+dt.name+'</span><span style="font-size:0.66rem;color:var(--text2);">'+(Math.round(rate*1000)/10)+'% · '+fm(bal)+'</span></div><div style="font-size:0.62rem;color:var(--text2);margin-top:2px;">'+(st.goal==='cashflow'?('Closest to done: gone in ~'+((isFinite(_tm))?Math.round(_tm)+' mo':'—')+' at the current payment — then '+fm(pay)+'/mo is yours again.'):('Best return per dollar: every $1k paid here removes ~'+fm(_sv)+' of remaining interest (rate × how long it would\'ve sat — the amortization math).'))+'</div></div>';
 if(loans.length>1){h+='<div onclick="Game.rmToggleLoans()" style="cursor:pointer;font-size:0.66rem;color:var(--blue);font-weight:600;margin-bottom:6px;">'+(this._rmLoansOpen?'▾ Hide':'▸ See all')+' your loans ('+loans.length+')</div>';
  if(this._rmLoansOpen){h+='<div style="display:flex;flex-direction:column;gap:4px;margin-bottom:12px;">';loans.slice().sort((a,b)=>_sc(b)-_sc(a)).forEach(x=>{const on=st.id===x.id,_b=+x.balance,_p=+x.payment,_r=+x.rate||0,_m2=this._monthsRemaining(_b,_r,_p),_ss=Math.min(1000,_b),_v2=Math.round(this._interestRemaining(_b,_r,_p)-this._interestRemaining(Math.max(0,_b-_ss),_r,_p));
   h+='<div style="border:1px solid '+(on?'var(--gold)':'var(--border)')+';background:var(--surface);border-radius:6px;padding:6px 11px;"><div style="display:flex;justify-content:space-between;"><span style="font-size:0.7rem;'+(on?'font-weight:700;color:var(--gold);':'color:var(--text2);')+'">'+(on?'🎯 ':'')+x.name+'</span><span style="font-size:0.64rem;color:var(--text2);">'+(Math.round(_r*1000)/10)+'% · '+fm(_b)+'</span></div><div style="font-size:0.58rem;color:var(--text2);margin-top:1px;">saves ~'+fm(_v2)+'/$1k paid · done in '+((isFinite(_m2))?Math.round(_m2)+' mo':'—')+'</div></div>';});h+='</div>';}}
 ...
 h+=srcSld('cash','From cash',cashMax,st.cash,'var(--accent)','0% — free')+srcSld('heloc','From HELOC',helocMax,st.heloc,'var(--gold)','~8.5%')+srcSld('credit','From credit line',creditMax,st.credit,'var(--red)','~24%');
 const proj=(l,b,a2,c)=>'<div class="breakdown-row"><span>'+l+'</span><span><span style="color:var(--text2)">'+b+'</span> → <strong style="color:'+(c||'var(--text)')+'">'+a2+'</strong></span></div>';
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:8px 0 5px;">'+dt.name+' — attack '+fm(eff)+'</div><div style="padding:4px 12px;background:rgba(16,185,129,0.06);border:1px solid var(--accent);border-radius:8px;">';
 h+=proj('Balance',fm(bal),fm(newBal),eff>0?'var(--accent)':'var(--text)')+proj('Payoff',fmMo(mB),fmMo(mA),tSave>0?'var(--accent)':'var(--text)')+proj('Interest ahead',fmI(iB),fmI(iA),'var(--accent)');
 ...
 if(iSave>0)h+='<div class="breakdown-row"><span>Interest saved (lifetime)</span><span style="color:var(--accent);font-weight:700;">'+fm(iSave)+'</span></div>';
 h+='</div>';
 if(eff>0){h+='<div style="margin-top:8px;padding:8px 12px;background:rgba(245,200,66,0.06);border:1px solid var(--gold);border-radius:8px;"><div class="breakdown-row"><span>Interest you stop paying</span><span style="color:var(--accent);font-weight:700;">'+fm(annAvoid)+'/yr</span></div>';
  if(annCost>0)h+='<div class="breakdown-row"><span>Interest on new borrowing</span><span style="color:var(--red);font-weight:700;">'+fm(annCost)+'/yr</span></div>';
  h+='<div class="breakdown-row"><span>Net annual saving</span><span style="color:'+(annNet>=0?'var(--accent)':'var(--red)')+';font-weight:800;">'+(annNet>=0?'+':'')+fm(annNet)+'/yr</span></div>';
  h+='<div class="breakdown-detail">'+(annNet>=0?'✅ Smart — you\'re paying off '+(Math.round(rate*1000)/10)+'% debt with cheaper money. Keep sweeping cash to pay the line back down.':'⚠️ This costs you — you\'re borrowing at a higher rate than the loan you\'re paying. Lean on cash or HELOC, not the credit line.')+'</div></div>';}
 this._rmPanel('⚡ Debt / Velocity',h);},
rmVelPick(id){if(!this._rmVel)this._rmVel={id:id,cash:0,credit:0,heloc:0};else{this._rmVel.id=id;this._rmVel.cash=0;this._rmVel.credit=0;this._rmVel.heloc=0;}this.rmVelocity();},/* retired from UI — ALIS picks; kept for compat */
rmVelGoal(g){if(this._rmVel){this._rmVel.goal=(g==='cashflow'?'cashflow':'interest');this._rmVel.cash=0;this._rmVel.credit=0;this._rmVel.heloc=0;}this.rmVelocity();},
rmToggleLoans(){this._rmLoansOpen=!this._rmLoansOpen;this.rmVelocity();},
...
rmPolicy(){const d=this._rmData()||{},fm=v=>this._rmFmt(v);const pol=d.policy||{};
 if(!this._rmPol)this._rmPol={cv:Math.round(+pol.cashValue||0),loan:Math.round(+pol.loan||0),surr:Math.round(+pol.surrender||0),type:'wash',loc:0,locRate:8.5};const st=this._rmPol;
 st.cv=Math.max(0,Math.round(st.cv||0));st.surr=Math.max(0,Math.min(Math.round(st.surr||0),st.cv));st.loan=Math.max(0,Math.min(Math.round(st.loan||0),st.cv));if(st.type==='fixed')st.type='wash';if(st.type==='variable')st.type='index';if(st.type!=='index')st.type='wash';st.loc=Math.max(0,Math.round(st.loc||0));const locRate=Math.max(0,+st.locRate||0);
 const CRD=0.06/* index crediting illustration */,cv=st.cv,loan=st.loan,surr=st.surr,isIdx=st.type==='index',effCV=cv+st.loc;
 const headroom=Math.max(0,Math.round(effCV*0.85)-surr-loan),borrowable=Math.max(0,Math.round(effCV*0.9)-surr-loan),passiveMo=Math.max(0,Math.min(Math.round(effCV*CRD/12),headroom)),passiveYr=passiveMo*12;
 const hr0=Math.max(0,Math.round(cv*0.85)-surr-loan),p0=Math.max(0,Math.min(Math.round(cv*CRD/12),hr0)),extra=Math.max(0,passiveMo-p0),locCost=Math.round(st.loc*locRate/100/12),netMo=extra-locCost;
 ...
 const tBtn=(key,label,sub)=>{const on=st.type===key;return '<div onclick="Game.rmPolType(\''+key+'\')" style="cursor:pointer;flex:1;border:1px solid '+(on?'var(--gold)':'var(--border)')+';background:'+(on?'rgba(245,200,66,0.12)':'var(--surface)')+';border-radius:6px;padding:7px 6px;text-align:center;"><div style="font-size:0.72rem;font-weight:700;color:'+(on?'var(--gold)':'var(--text)')+';">'+label+'</div><div style="font-size:0.55rem;color:var(--text2);margin-top:2px;line-height:1.3;">'+sub+'</div></div>';};
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:4px;">Policy loan type</div><div style="display:flex;gap:8px;margin-bottom:6px;">'+tBtn('wash','Wash · 3%','nets ~0% — safe, lapse-proof')+tBtn('index','Index · 6%','current market — higher, risk')+'</div>';
 h+='<div style="font-size:0.62rem;color:var(--text2);margin-bottom:10px;line-height:1.35;">'+(isIdx?'⚠️ An index loan (~6%, current market) lets the full value keep earning the index — more upside, but a downturn can compound the loan past your value and lapse the policy.':'A wash loan (~3%) is offset by the value still earning ~3%, so it nets ~0% and can\'t lapse on you — the safe default.')+'</div>';
 h+='<div style="border-top:1px solid var(--border);margin-top:6px;padding-top:8px;font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:3px;">💳 Boost it with a line of credit</div>';
...
if(this._rmUnlocked())h+=item('💼','Epic Tools','Plan with your real numbers','Game.rmHome()');
...
// ---- Beta access: gate the in-progress overhaul build behind a code. Correct code → redirect to the /beta/ subfolder. (Present in both root & beta game.js so promotion is a clean copy; the menu item only renders on the live build.) ----
BETA_CODE:'beta',BETA_URL:'beta/index.html',/* used by enterCode() — the combined beta/redeem code box */
...
// The old flow only checked once at page load, so a build pushed WHILE someone had the game open (mid-menu
// or mid-run) never got noticed until they happened to reload on their own — the exact "why didn't it
// prompt me" gap. Re-checks every 30s AND immediately when the tab regains focus (covers the common case
// of switching away, letting a deploy land, then switching back). Stops polling once an update is found —
// no point hammering version.json after the banner's already up; _showUpdateBanner is itself idempotent too.
_startUpdatePolling(){if(this._updatePollStarted)return;this._updatePollStarted=true;
setInterval(()=>{if(!this._updateAvailable)this._checkForUpdate();},30000);
document.addEventListener('visibilitychange',()=>{if(document.visibilityState==='visible'&&!this._updateAvailable)this._checkForUpdate();});},
...
h+=sl('💵 Starting cash','ngp-cash',0,150000,10000,1000)+sl('🏠 Living expenses / mo','ngp-living',1500,12000,3200,100);
...
h+=hdr('Head-start perk');
h+=chk('ngp-epic','⭐ Start with Epic Life membership','Your concierge runs the financial playbook from day one.');
...
is.cash=num('ngp-cash');is.available_credit=num('ngp-credit');is.total_debt=num('ngp-debt');is.debt_breakdown=num('ngp-debt')>0?{credit_card:num('ngp-debt')}:{};is.personal_guarantee_exposure=num('ngp-debt');is.living_expenses=num('ngp-living');
...
startSimProfile(kind){
 ...
 const PANEL_ACTS=['policy_loan','activate_passive_income','buy_real_estate','buy_str','private_banking','cash_out_refi','equipment_financing'];/* panel-routed for humans — a bot queues them directly */
 let simErr=null;
 for(let attempt=0;attempt<3;attempt++){/* a year-1 death is near-impossible for these personas, but reroll rather than hand the player a corpse */
  ...
  while(guard++<600){const sc=scr();
   ...
   if(sc==='checkpoint-screen')break;/* safety only — the only screen that renders into checkpoint-screen now is the m18 Part 1 Finale; m12/m24 just auto-save */
   if(sc==='game-screen'){
...
_simRecap(kind){const s=this.state,fm=v=>this.fmtMoney(Math.round(v)),log=this._playLog||[];
 const fin=log.filter(e=>e.c==='finance').map(e=>e.l+(e.s?'':' ✗')),finList=fin.slice(0,8).join(' · ')+(fin.length>8?' · +'+(fin.length-8)+' more':'');/* ✗ = attempted but did NOT go through — failed moves never count as completed */
...
// Top-right defaults to "👑 Membership"; pass rightLabel/rightOnclick to swap it for a panel-specific "Understand X" toggle instead.
_epicPanel(title,body,rightLabel,rightOnclick){const right='<button class="back-chip" style="margin:0;border-color:var(--gold);color:var(--gold);" onclick="'+(rightOnclick||'Game.showMembershipInfo()')+'">'+(rightLabel||'👑 Membership')+'</button>';
 body='<div style="display:flex;justify-content:space-between;align-items:center;gap:8px;margin-bottom:10px;"><button class="back-chip" style="margin:0;" onclick="Game.showEpicLife()">← Epic Life</button>'+right+'</div>'+body;this.showPopup(title,body);const _d=document.querySelector('#popup-container .popup-box > button.btn-secondary');if(_d)_d.style.display='none';},
// Reusable collapsed "Understand X" bullet block for a sub-panel's top-right toggle — bullets passed as an array of strings.
_understandBlock(bullets){return '<ul style="font-size:0.76rem;color:var(--text2);line-height:1.55;padding-left:18px;margin:0 0 12px;">'+bullets.map(b=>'<li>'+b+'</li>').join('')+'</ul>';},
...
TUTORIAL_STEPS:[
{sel:null,title:'Welcome to Entrepreneur Paradise',body:'The run is two parts. <strong>Part 1 (months 1–18)</strong> you build the machine — leverage, credit, and a policy that pays you whether you work or not. <strong>Part 2 (months 19–36)</strong> it runs without you, compounding into freedom. You can lock in a ranked score at the <strong>Part 1 finale (month 18)</strong> or the <strong>finish (month 36)</strong>. The endgame isn\'t a giant business; it\'s <strong>passive, tax-free income</strong> that pays for the life you want. Let\'s play your first month together.'},
...
{sel:'#tut-result-card',_noBack:true,title:'Your results',body:'Your moves play out here — the stat changes show right on each card. Tap <strong>"Hide description"</strong> (top right) to collapse the write-up and <strong>lesson</strong> once you\'ve read it.'},
...
_LOAN_TERMS:{mortgage:{rate:0.065,term:360,label:'Rental mortgage'},sba:{rate:0.105,term:120,label:'SBA loan'},equipment:{rate:0.08,term:60,label:'Equipment loan'},biz_term:{rate:0.12,term:60,label:'Business term loan'},personal_term:{rate:0.12,term:60,label:'Personal loan'},mca:{rate:0,term:12,label:'Cash advance'},owner_loan:{rate:0.045,term:60,label:'Shareholder loan'}},/* owner_loan: a documented related-party loan, priced near the IRS mid-term AFR (~4.5%) rather than a bank's markup — real, but not free */
...
_velocityTargetLoan(){const s=this.state;this._ensureLoans();const L=(s.loans||[]).filter(x=>x.balance>0.5);if(!L.length)return null;
 if(s._velocity_target_id){const pick=L.find(x=>x.id===s._velocity_target_id);if(pick)return pick;}/* player-chosen target (from the ⚡ panel) wins when it still exists */
 const heloc=s._velocity_vehicle==='heloc'&&(s.real_estate_debt||0)>0;if(heloc)return L.filter(x=>x.type==='mortgage').sort((a,b)=>b.balance-a.balance)[0]||null;const nonMort=L.filter(x=>x.type!=='mortgage'),pool=nonMort.length?nonMort:L;return pool.sort((a,b)=>b.rate-a.rate||b.balance-a.balance)[0];},
...
// SURVIVAL RUNWAY — months you could cover ESSENTIAL fixed costs (living + operating overhead + debt service) if business revenue went to ZERO (an economic shutdown). Passive income KEEPS flowing through a closure, so it offsets the gap. This is the resilience the golden path buys: reserves + passive + low leverage = you weather a bust; the lean grinder gets squeezed. (DESIGN.md: grinding is fragile, the leveraged/protected path is optimal.)
_survivalRunway(){const s=this.state;const bizAvail=Math.max(0,(s.business_credit_limit||0)-(s.business_credit_used||0));const accessible=(s.cash||0)+(s.personal_cash||0)+(s.available_credit||0)+bizAvail;
 const policyPassive=s._passive_income_active?this._policyPassiveMonthly():0,passive=(s.other_monthly_revenue||0)+policyPassive+this._pbCarry(s);
 const fixed=(s.living_expenses||0)+(s.operating_expenses||0)+this.calcDebtInterest()+this.calcDebtPrincipal(),gap=Math.max(0,fixed-passive);
 return{months:gap<=0?Infinity:accessible/gap,gap:Math.round(gap),passive:Math.round(passive),fixed:Math.round(fixed),accessible:Math.round(accessible)};},
...
openVelocityControl(){const s=this.state,fm=v=>this.fmtMoney(v);
 ...
 // Stage everything (vehicle + mode + target loan + chunk + draw); Confirm finalizes it all. Seed from current on first open.
 if(!s._velStaged)s._velStaged={vehicle:s._velocity_vehicle||(hasRE?'heloc':'line'),mode:s._velocity_mode||'balanced',target:s._velocity_target_id||null,chunk:0,draw:0};
 const st=s._velStaged;if(st.vehicle==='heloc'&&!hasRE)st.vehicle='line';
 // ALIS considers BOTH vehicles' pools (owner: the objective picks the loan; the loan picks the vehicle — not the other way around).
 const L=(s.loans||[]).filter(x=>x.balance>0.5);
 const poolH=hasRE?L.filter(x=>x.type==='mortgage'):[],poolL=hasLine?L.filter(x=>x.type!=='mortgage'):[];
 let pool=poolH.concat(poolL);if(!pool.length)pool=L;
 // ALIS picks the target FOR THE PLAYER'S OBJECTIVE (owner: amortization makes "highest rate" wrong sometimes — duration matters).
 // 'interest': max lifetime interest removed per $1k chunked (real amortization math — a long low-rate loan can beat a short high-rate one).
 // 'cashflow': the loan you can FINISH soonest — a dead loan's whole payment joins the sweep, compounding the strategy.
 if(!st.goal)st.goal=s._velocity_goal||'interest';
 const _score=ln=>{const step=Math.min(1000,ln.balance);
  if(st.goal==='cashflow'){const m=this._monthsRemaining(ln.balance,ln.rate,ln.payment);return isFinite(m)?-m:-9999;}/* fewest months to kill (higher score = better) */
  const sv=this._interestRemaining(ln.balance,ln.rate,ln.payment)-this._interestRemaining(Math.max(0,ln.balance-step),ln.rate,ln.payment);return isFinite(sv)?sv/step:0;};/* interest saved per $ chunked */
 let tgtLoan=pool.slice().sort((a,b)=>_score(b)-_score(a))[0]||null;st.target=tgtLoan?tgtLoan.id:null;
 st.vehicle=tgtLoan?(tgtLoan.type==='mortgage'?'heloc':'line'):(hasRE?'heloc':'line');/* the vehicle FOLLOWS the target: mortgage → HELOC, anything else → the credit line */
 ...
 let h='';
 h+='<div style="font-size:0.8rem;color:var(--text2);line-height:1.5;margin-bottom:8px;">Sweep surplus cash at your debt through a credit line or HELOC. <strong>Review, then Confirm</strong> — nothing moves until you do.</div>';
 if(this._velInfo)h+=this._understandBlock(['Park your income on a credit line or HELOC and sweep every surplus dollar at your debt.','Killing principal early removes the future interest that dollar would have cost — the balance clears years sooner, and on a mortgage that paid-down principal also becomes equity.','Your <strong>objective</strong> picks the strategy: max interest saved (duration-aware amortization) or free cash flow fastest (kill a loan outright so its payment joins the sweep).','ALIS picks the target loan for your objective automatically — you just choose the objective.','<strong>Chunk</strong> = a lump sum from your cash on hand. <strong>Draw</strong> = pull from your credit line to attack the loan instead (6% fee) — a balance transfer, not free money.','The monthly sweep automatically chunks 50/75/100% of that month\'s surplus cash at your target loan, based on Conservative/Balanced/Aggressive.']);
 // ---- Dashboard: aggregate totals across every loan the sweep can reach, plus your all-in monthly debt service ----
 {const instTotal=Math.round((s._installment_debt||0)+(s.business_installment_debt||0)+(s.real_estate_debt||0)),intAhead=Math.round(pool.reduce((a,ln)=>{const v=this._interestRemaining(ln.balance,ln.rate,ln.payment);return a+(isFinite(v)?v:0);},0)),dsvcNow=Math.round(this.calcDebtInterest()+this.calcDebtPrincipal());
  const row=(l,v,c)=>'<div class="breakdown-row"><span>'+l+'</span><span'+(c?' style="color:'+c+';font-weight:700;"':'')+'>'+v+'</span></div>';
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">Dashboard</div><div style="padding:4px 12px;background:var(--surface);border:1px solid var(--border);border-radius:8px;margin-bottom:12px;">';
  h+=row('Installment loans total',fm(instTotal));
  h+=row('Interest still ahead',fm(intAhead),'var(--gold)');
  h+=row('Monthly debt service',fm(dsvcNow)+'/mo');
  h+='</div>';}
 // Setup (one-time, uses finance move) — the entry gate; Active/Pause + aggressiveness live near Confirm below.
 ...
 // Vehicle — ALIS runs it, and the vehicle FOLLOWS the objective's best target (mortgage → HELOC, anything else → credit line). Shown, not chosen (owner).
 h+='<div style="border:1px solid var(--accent);background:rgba(34,197,94,0.06);border-radius:6px;padding:8px 11px;margin-bottom:12px;"><div style="font-size:0.72rem;font-weight:700;color:var(--accent);">🤖 ALIS runs it through: '+(st.vehicle==='heloc'?'🏠 your HELOC':'💳 your credit line')+'</div><div style="font-size:0.62rem;color:var(--text2);margin-top:2px;">'+(st.vehicle==='heloc'?'Because your objective\'s best target is the mortgage — home equity attacks it. If a different loan ever scores higher, ALIS switches to your credit line automatically.':'Because your objective\'s best target isn\'t the mortgage — the line attacks it directly. If the mortgage ever scores higher (and you have equity), ALIS switches to the HELOC automatically.')+'</div></div>';
 // The player picks the OBJECTIVE (strategy = their job); ALIS picks the loan for it (arithmetic = its job).
 const gBtn=(key,label,sub)=>{const on=st.goal===key;return '<div onclick="Game.velStageGoal(\''+key+'\')" style="cursor:pointer;flex:1;border:1px solid '+(on?'var(--gold)':'var(--border)')+';background:'+(on?'rgba(245,200,66,0.12)':'var(--surface)')+';border-radius:6px;padding:7px 6px;text-align:center;"><div style="font-size:0.7rem;font-weight:700;color:'+(on?'var(--gold)':'var(--text)')+';">'+label+'</div><div style="font-size:0.54rem;color:var(--text2);margin-top:2px;line-height:1.3;">'+sub+'</div></div>';};
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:4px;">Your objective</div><div style="display:flex;gap:8px;margin-bottom:6px;">'+gBtn('interest','💰 Max interest saved','duration-aware — a long cheap loan can beat a short dear one')+gBtn('cashflow','⏱️ Free cash flow fastest','kill a loan → its payment joins the sweep')+'</div>';
 if(tgtLoan){const _tm=this._monthsRemaining(tgtLoan.balance,tgtLoan.rate,tgtLoan.payment),_step=Math.min(1000,tgtLoan.balance),_sv=Math.round(this._interestRemaining(tgtLoan.balance,tgtLoan.rate,tgtLoan.payment)-this._interestRemaining(Math.max(0,tgtLoan.balance-_step),tgtLoan.rate,tgtLoan.payment));
  const _why=st.goal==='cashflow'?('Closest to dead: gone in ~'+(isFinite(_tm)?_tm+' mo':'—')+' — then its '+fm(tgtLoan.payment)+'/mo payment joins your sweep and compounds the attack.'):('Best return per dollar: every $1k chunked here removes ~'+fm(_sv)+' of lifetime interest (rate × how LONG it would\'ve sat — the amortization math, not just the APR).');
  h+='<div style="border:1px solid var(--gold);background:rgba(245,200,66,0.08);border-radius:6px;padding:8px 11px;margin-bottom:6px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:0.74rem;font-weight:700;color:var(--gold);">🤖 ALIS\'s pick: '+tgtLoan.label+'</span><span style="font-size:0.66rem;color:var(--text2);">'+(Math.round(tgtLoan.rate*1000)/10)+'% · '+fm(tgtLoan.balance)+'</span></div><div style="font-size:0.62rem;color:var(--text2);margin-top:2px;">'+_why+'</div></div>';}
 ...
 // Projection (current → after) first — chunk & draw sliders sit right below it (owner: all moving parts in thumb reach)
 if(tgtLoan){const R=tgtLoan.rate,P=tgtLoan.payment,intRem=b=>{const v=this._interestRemaining(Math.max(0,b),R,P);return isFinite(v)?Math.round(v):0;},monRem=b=>{const v=this._monthsRemaining(Math.max(0,b),R,P);return isFinite(v)?Math.round(v):0;},fmMo=m=>(!m||m<=0)?'—':m>=24?(Math.round(m/12*10)/10)+' yrs':m+' mo';
  ...
  if(!st._rec){const _burn=this.calcMonthlyBurn(),_reserve=_burn*3,_spare=Math.max(0,cash-_reserve);
   let _cRec;if(st.goal==='cashflow'&&_spare>=tgtLoan.balance)_cRec=Math.round(tgtLoan.balance);/* the kill shot — finish the loan, free its whole payment */
   else _cRec=Math.max(0,Math.min(Math.round(_spare*0.5/100)*100,Math.round(tgtLoan.balance)));
   // Draw rec — duration-aware (same amortization lesson as the chunk): per $1k moved, interest actually SAVED over the loan's remaining life must beat the 6% fee + ~6 months of line carry while the sweep pays it back. A one-time fee vs an annual rate is apples/oranges without duration.
   let _dRec=0,_dSv1=0,_dCost1=0;
   if(st.vehicle==='line'&&drawCap>0){const _s1=Math.min(1000,tgtLoan.balance);_dSv1=this._interestRemaining(tgtLoan.balance,tgtLoan.rate,tgtLoan.payment)-this._interestRemaining(Math.max(0,tgtLoan.balance-_s1),tgtLoan.rate,tgtLoan.payment);
    _dCost1=Math.round(_s1*0.06+_s1*((s._market_rate!=null?s._market_rate:0.05)+0.02)*0.5);
    if(isFinite(_dSv1)&&_dSv1>_dCost1*1.2)_dRec=Math.min(Math.round(drawCap*0.5/100)*100,Math.round(tgtLoan.balance*0.5));}
   st._rec={chunk:_cRec,draw:_dRec,kill:st.goal==='cashflow'&&_spare>=tgtLoan.balance,dSv:Math.round(_dSv1),dCost:_dCost1};if(!st.chunk)st.chunk=_cRec;if(!st.draw)st.draw=_dRec;}
  h+='<div style="border:1px solid var(--accent);background:rgba(34,197,94,0.06);border-radius:6px;padding:8px 11px;margin:10px 0 6px;"><div style="font-size:0.72rem;font-weight:700;color:var(--accent);">🤖 ALIS recommends: chunk '+fm(st._rec.chunk)+(st._rec.draw>0?' · draw '+fm(st._rec.draw):'')+'</div><div style="font-size:0.62rem;color:var(--text2);margin-top:2px;">'+(st._rec.kill?'THE KILL SHOT — finishes this loan outright; its whole payment joins your sweep from next month.':(st._rec.chunk>0?'Half your spare cash after keeping ~3 months of expenses in reserve — attack hard, never naked.':'Cash is thin — keep your reserve; the monthly sweep does the work.'))+(st._rec.draw>0?' A draw pencils: each $1k moved saves ~'+fm(st._rec.dSv)+' of this loan\'s remaining interest vs ~'+fm(st._rec.dCost)+' in fee + line carry.':(st.vehicle==='line'&&st._rec.dCost>0?' No draw — each $1k moved saves only ~'+fm(st._rec.dSv)+' of remaining interest vs ~'+fm(st._rec.dCost)+' in fee + carry. Doesn\'t pencil.':''))+' Sliders are preset — adjust if you must.</div></div>';
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:6px 0 3px;">Chunk extra now (cash) — from your '+fm(cash)+' cash</div>';
  ...
  // Draw slider (staged, line vehicle only) — the "draw from credit too" alternative to chunking cash only
  ...
  // Chunk effectiveness right under the sliders that produced it
  if(st.chunk>0){h+='<div style="margin-top:4px;margin-bottom:8px;padding:8px 12px;background:rgba(245,200,66,0.06);border:1px solid var(--gold);border-radius:8px;">';
 ...
 if(pool.length>1){h+='<div onclick="Game.velToggleLoans()" style="cursor:pointer;font-size:0.66rem;color:var(--blue);font-weight:600;margin-bottom:6px;">'+(this._velLoansOpen?'▾ Hide':'▸ See all')+' your loans ('+pool.length+')</div>';
  if(this._velLoansOpen){h+='<div style="display:flex;flex-direction:column;gap:4px;margin-bottom:12px;">';pool.slice().sort((a,b)=>_score(b)-_score(a)).forEach(ln=>{const on=tgtLoan&&tgtLoan.id===ln.id;const _m=this._monthsRemaining(ln.balance,ln.rate,ln.payment),_s2=Math.min(1000,ln.balance),_v=Math.round(this._interestRemaining(ln.balance,ln.rate,ln.payment)-this._interestRemaining(Math.max(0,ln.balance-_s2),ln.rate,ln.payment));
   h+='<div style="border:1px solid '+(on?'var(--gold)':'var(--border)')+';background:var(--surface);border-radius:6px;padding:6px 11px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:0.7rem;'+(on?'font-weight:700;color:var(--gold);':'color:var(--text2);')+'">'+(on?'🎯 ':'')+ln.label+'</span><span style="font-size:0.64rem;color:var(--text2);">'+(Math.round(ln.rate*1000)/10)+'% · '+fm(ln.balance)+(ln.payment?' · '+fm(ln.payment)+'/mo':'')+'</span></div><div style="font-size:0.58rem;color:var(--text2);margin-top:1px;">saves ~'+fm(_v)+'/$1k chunked · dead in '+(isFinite(_m)?_m+' mo':'—')+'</div></div>';});h+='</div>';}}
 // ---- Monthly sweep on/off + aggressiveness % (the free, recurring auto-chunk from cash surplus) ----
 if(setup){h+='<div style="display:flex;align-items:center;justify-content:space-between;gap:8px;padding:9px 12px;background:'+(active?'rgba(16,185,129,0.1)':'var(--surface)')+';border:1px solid '+(active?'var(--accent)':'var(--border)')+';border-radius:8px;margin-bottom:12px;"><span style="font-size:0.78rem;font-weight:700;color:'+(active?'var(--accent)':'var(--text2)')+';">Monthly sweep: '+(active?'ON':'PAUSED')+'</span><button onclick="Game.velToggleSweep()" style="background:'+(active?'var(--surface)':'var(--accent)')+';color:'+(active?'var(--text2)':'#04210f')+';border:1px solid '+(active?'var(--border)':'var(--accent)')+';border-radius:999px;padding:6px 14px;font-weight:700;font-size:0.72rem;cursor:pointer;">'+(active?'⏸ Pause':'▶ Activate')+'</button></div>';
  ...
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:4px;">Monthly sweep — % of surplus auto-chunked each month (cash only)</div><div style="display:flex;gap:6px;margin-bottom:12px;">'+mBtn('conservative','Conservative','50%')+mBtn('balanced','Balanced','75%')+mBtn('aggressive','Aggressive','100%')+'</div>';}
 {const _jc=this._justConfirmed==='vel';this._justConfirmed=null;h+='<button onclick="Game.velConfirm()" style="width:100%;margin-top:6px;background:'+(_jc?'var(--accent)':'var(--gold)')+';color:#08130c;border:none;border-radius:8px;padding:11px;font-weight:800;font-size:0.82rem;cursor:pointer;">'+(_jc?'✓ Confirmed':'Confirm')+'</button>';}
 ...
 this._epicPanel('⚡ Velocity Banking',h,'⚡ Understand velocity banking','Game.velToggleInfo()');},
...
velStageGoal(g){const s=this.state;if(s._velStaged){s._velStaged.goal=(g==='cashflow'?'cashflow':'interest');s._velStaged._rec=null;s._velStaged.chunk=0;s._velStaged.draw=0;}this.openVelocityControl();},/* objective change → ALIS re-picks and re-recommends */
...
velStageTarget(id){const s=this.state;if(s._velStaged)s._velStaged.target=id;this.openVelocityControl();},
velStageChunk(v){const s=this.state;if(s._velStaged)s._velStaged.chunk=Math.max(0,Math.round(+v||0));this.openVelocityControl();},
velStageDraw(v){const s=this.state;if(s._velStaged)s._velStaged.draw=Math.max(0,Math.round(+v||0));this.openVelocityControl();},
// Free anytime toggle of the monthly auto-sweep (once velocity has been set up via the finance action).
velToggleSweep(){const s=this.state;if(!(s._velocity_setup||s._velocity_active))return;s._velocity_setup=true;s._velocity_active=!s._velocity_active;this._refreshDashboards();this.openVelocityControl();},
// Confirm locks in the staged settings and executes the staged chunk/draw (free, no turn), then returns to the hub.
velConfirm(){const s=this.state,st=s._velStaged;if(!st){this.showEpicLife();return;}
 s._velocity_vehicle=st.vehicle;s._velocity_mode=st.mode;s._velocity_target_id=st.target||null;s._velocity_goal=st.goal||'interest';
...
openPolicyControl(){const s=this.state,fm=v=>this.fmtMoney(v);
 let h='';
 ...
 const rev=Math.round(s.monthly_revenue||0),baseRate=5/* index loan: flat 5% guaranteed charge (John Hancock Accumulation IUL) — no longer floats with the market rate */,sep=this.isSeparated(),curVar=s._iul_loan_type==='variable',curActive=!!s._passive_income_active;
 // Stage everything (loan type + funding % + loan amount + repay amount + passive on); nothing moves until Confirm. Seed from current on first open.
 if(!s._polStaged)s._polStaged={loanType:(curVar?'variable':'wash'),loanAmt:0,repayAmt:0,fundRate:Math.round((s._policy_fund_rate||0.15)*100),passiveOn:curActive,foldReserve:false};
 const st=s._polStaged;const availCash=sep?(s.personal_cash||0):(s.cash||0);
 st.loanAmt=Math.max(0,Math.min(Math.round(st.loanAmt||0),borrow));st.repayAmt=Math.max(0,Math.min(Math.round(st.repayAmt||0),loan,availCash));const isVar=st.loanType==='variable';
 const row=(l,v,c)=>'<div class="breakdown-row"><span>'+l+'</span><span'+(c?' style="color:'+c+';font-weight:700;"':'')+'>'+v+'</span></div>';
 const proj=(l,b,a2,c)=>'<div class="breakdown-row"><span>'+l+'</span><span><span style="color:var(--text2)">'+b+'</span> → <strong style="color:'+(c||'var(--text)')+'">'+a2+'</strong></span></div>';
 h+='<div style="font-size:0.8rem;color:var(--text2);line-height:1.5;margin-bottom:8px;">Your tax-free money vault. Set funding &amp; loan type, borrow against it, switch on passive income — <strong>review the projection, then Confirm</strong>. Nothing moves until you confirm.</div>';
 if(this._polInfo)h+=this._understandBlock(['<strong>Wash loan (net 0%)</strong> — charged 3%, credited 3% on the borrowed slice; cancels out exactly, and the policy structurally can\'t lapse.','<strong>Index loan (flat '+baseRate+'%)</strong> — your full cash value keeps earning the index even while borrowed; more upside, but a bad stretch can compound the loan past your cash value and lapse the policy.','Borrow against it any time — no bank, no credit check, completely tax-free.','Repaying early raises your <strong>net cash value</strong> (value − loan) — passive income draws from that same net figure, so repaying grows both.','A <strong>surrender charge</strong> (~$10,000, phasing out over ~10 years) has to clear before you can borrow — keep funding past it.','Fold your tax reserve in any time — same ~2% cost of insurance, and it still covers your tax bill later via a tax-free policy loan.']);
 // ---- Dashboard: read-only snapshot of the policy as it stands right now (not the staged/if-confirm numbers below) ----
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">Dashboard</div><div style="padding:4px 12px;background:var(--surface);border:1px solid var(--border);border-radius:8px;margin-bottom:12px;">';
 h+=row('Cash value',fm(cv),'var(--gold)');
 h+=row('Surrender charge',charge>0?('−'+fm(charge)):'Cleared',charge>0?'var(--red)':'var(--accent)');
 h+=row('Outstanding loan',fm(loan),loan>0?'var(--text)':'var(--text2)');
 h+=row('Loan type',curVar?'Index '+baseRate+'%':'Wash net 0%');
 h+='<div class="breakdown-row"><span>Tax-free passive income</span><span style="color:'+(curActive?'var(--accent)':'var(--text2)')+';font-weight:700;">'+fm(curActive?this._policyPassiveMonthly():0)+'/mo</span></div>';
 h+='</div>';
 if(curActive){const moP=Math.round(cv*(isVar?0.08:0.06)/12);h+='<div style="padding:8px 10px;background:rgba(16,185,129,0.1);border-left:3px solid var(--accent);border-radius:var(--radius-sm);font-size:0.74rem;color:var(--accent);font-weight:600;margin-bottom:12px;">✓ Passive income ON — drawn automatically each month'+(isVar!==curVar?' (your staged loan type will change the rate)':'')+'. Index draws harder (8%) than Wash (6%).</div>';}
 else if(cv>=5000)h+='<button onclick="Game.polStagePassive()" style="width:100%;border:1px solid '+(st.passiveOn?'var(--accent)':'var(--border)')+';background:'+(st.passiveOn?'rgba(16,185,129,0.12)':'var(--surface)')+';color:var(--text);border-radius:8px;padding:10px;cursor:pointer;font-weight:700;font-size:0.78rem;margin-bottom:12px;">'+(st.passiveOn?'✓ Passive income — ON (staged)':'🌴 Switch on tax-free passive income')+'</button>';
 else h+='<div style="font-size:0.7rem;color:var(--text2);margin-bottom:12px;">Passive income unlocks once your cash value passes '+fm(5000)+'.</div>';
 if(charge>0&&borrow<=0)h+='<div style="font-size:0.7rem;color:var(--gold);margin-bottom:10px;line-height:1.4;">⏳ The '+fm(charge)+' surrender charge still exceeds your borrowable value — keep funding it and your borrowing opens as the cash value grows and the charge phases out.</div>';
 // ---- Sliders: monthly funding, take a loan, repay the loan ----
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:3px;">Monthly funding</div>';
 ...
 h+='<div style="font-size:0.62rem;color:var(--text2);margin-bottom:12px;"><span id="ppc-fr" style="font-weight:700;color:var(--gold);">'+st.fundRate+'% · ≈ $'+Math.round(rev*st.fundRate/100).toLocaleString()+'/mo</span> — more builds cash value faster (opens borrowing sooner), less cash in pocket.</div>';
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:3px;">Take a loan — tax-free, no credit check</div>';
 if(borrow>0){const step=Math.max(1,Math.round(borrow/100));
  h+='<input type="range" min="0" max="'+borrow+'" step="'+step+'" value="'+st.loanAmt+'" style="width:100%;accent-color:var(--accent);" oninput="var e=document.getElementById(\'ppc-loan\');if(e)e.textContent=\'$\'+Math.round(+this.value).toLocaleString();" onchange="Game.polStageLoan(this.value)">';
  h+='<div style="margin-bottom:12px;font-size:0.78rem;font-weight:700;color:var(--accent);">Borrow <span id="ppc-loan">$'+st.loanAmt.toLocaleString()+'</span></div>';
 } else h+='<div style="font-size:0.72rem;color:var(--text2);margin-bottom:12px;">No borrowing room yet — fund the policy above the surrender charge first.</div>';
 // Repay the loan — pay it down with cash, any time, right from this panel. Lowers the outstanding
 // loan, which raises your net cash value (cash value − loan) and — since passive income draws from
 // that same net figure — raises your passive income too. Mutually exclusive with taking a new loan
 // (staging one clears the other) so the projection below always reflects one clear move.
 if(loan>0){const repayCap=Math.min(loan,availCash);
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:3px;">Repay the loan — raises net cash value &amp; passive income</div>';
  if(repayCap>0){const rstep=Math.max(1,Math.round(repayCap/100));
   h+='<input type="range" min="0" max="'+repayCap+'" step="'+rstep+'" value="'+st.repayAmt+'" style="width:100%;accent-color:var(--gold);" oninput="var e=document.getElementById(\'ppc-repay\');if(e)e.textContent=\'$\'+Math.round(+this.value).toLocaleString();" onchange="Game.polStageRepay(this.value)">';
   h+='<div style="margin-bottom:12px;font-size:0.78rem;font-weight:700;color:var(--gold);">Repay <span id="ppc-repay">$'+st.repayAmt.toLocaleString()+'</span>'+(repayCap<loan?' <span style="font-size:0.6rem;color:var(--text2);font-weight:400;">(capped by your cash on hand)</span>':'')+'</div>';
  } else h+='<div style="font-size:0.72rem;color:var(--text2);margin-bottom:12px;">No cash on hand to repay with right now.</div>';
 }
 // ---- Loan type: wash vs index ----
 const tBtn=(key,label,sub)=>{const on=st.loanType===key;return '<div onclick="Game.polStageType(\''+key+'\')" style="cursor:pointer;flex:1;border:1px solid '+(on?'var(--gold)':'var(--border)')+';background:'+(on?'rgba(245,200,66,0.12)':'var(--surface)')+';border-radius:6px;padding:7px 6px;text-align:center;"><div style="font-size:0.72rem;font-weight:700;color:'+(on?'var(--gold)':'var(--text)')+';">'+label+'</div><div style="font-size:0.55rem;color:var(--text2);margin-top:2px;line-height:1.3;">'+sub+'</div></div>';};
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:4px;">Loan type</div><div style="display:flex;gap:8px;margin-bottom:6px;">'+tBtn('wash','Wash · net 0%','3% charged, 3% credited — cancels out; lapse-proof')+tBtn('variable','Index · '+baseRate+'%','flat 5% charged; full cash value keeps earning the index — higher income, lapse risk')+'</div>';
 h+='<div style="font-size:0.62rem;color:var(--text2);margin-bottom:12px;line-height:1.35;">'+(isVar?'⚠️ Index bets the index return beats the flat '+baseRate+'% loan charge — great in good years, but a downturn can compound the loan past your cash value and lapse the policy (gains become taxable).':'Wash = net 0%: the loan is charged 3% and the borrowed slice is credited 3% — they cancel exactly. The borrowed slice does NOT earn the index (that\'s the trade); the rest of your cash value still does. Structurally can\'t lapse.')+'</div>';
 // ---- Fold the tax reserve in — on-demand here instead of a recurring popup (owner feedback 2026-07-04: the
 // monthly popup was annoying). Same math as before: ~2% cost of insurance, still covers taxes via a
 // tax-free policy loan when the bill comes. ----
 if((s.tax_reserve||0)>0){const foldAmt=Math.round(s.tax_reserve||0),foldInto=Math.round(foldAmt*0.98);
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:3px;">🧾 Fold your tax reserve in</div>';
  h+='<div style="font-size:0.68rem;color:var(--text2);margin-bottom:6px;line-height:1.4;">'+fm(foldAmt)+' sitting in a taxable ~4%/yr money-market reserve. Fold it in and it compounds tax-free instead — it still covers your taxes, via a tax-free policy loan when the bill comes.</div>';
  h+='<button onclick="Game.polStageFold()" style="width:100%;border:1px solid '+(st.foldReserve?'var(--accent)':'var(--border)')+';background:'+(st.foldReserve?'rgba(16,185,129,0.12)':'var(--surface)')+';color:var(--text);border-radius:8px;padding:10px;cursor:pointer;font-weight:700;font-size:0.78rem;margin-bottom:6px;">'+(st.foldReserve?'✓ Fold '+fm(foldAmt)+' in — staged':'Fold '+fm(foldAmt)+' in ('+fm(foldInto)+' lands as cash value)')+'</button>';}
 const afterCash=availCash+st.loanAmt-st.repayAmt,netLoan=Math.max(0,loan+st.loanAmt-st.repayAmt),curFundMo=Math.round(rev*(s._policy_fund_rate||0.15)),newFundMo=Math.round(rev*st.fundRate/100);
 const curPassive=curActive?this._policyPassiveMonthly():0,newPassive=(st.passiveOn&&cv>=5000)?this._policyPassiveMonthly(netLoan,isVar):0;/* staged loan TYPE (and now repay amount) moves the projection too — a bigger repay raises the base passive draws from */
 const foldCredit=st.foldReserve?Math.round((s.tax_reserve||0)*0.98):0,newCv=cv+foldCredit;
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:12px 0 5px;">Your policy · if you confirm</div><div style="padding:4px 12px;background:rgba(245,200,66,0.06);border:1px solid var(--gold);border-radius:8px;">';
 h+=(foldCredit>0?proj('Cash value',fm(cv),fm(newCv),'var(--accent)'):row('Cash value',fm(cv),'var(--gold)'))+row('Net cash value (value − loan)',fm(cv-netLoan),'var(--accent)')+row('Borrowable now',fm(borrow),'var(--accent)')+(charge>0?row('Surrender charge','−'+fm(charge),'var(--red)'):'')+(foldCredit>0?proj('Tax reserve',fm(s.tax_reserve||0),fm(0),'var(--accent)'):'');
 h+=proj((sep?'Cash — personal':'Cash'),fm(availCash),fm(afterCash),(st.loanAmt>0?'var(--accent)':(st.repayAmt>0?'var(--red)':'var(--text)')));
 h+=proj('Policy loan',fm(loan),fm(netLoan),st.loanAmt>0?'var(--gold)':(st.repayAmt>0?'var(--accent)':'var(--text)'));
 h+=proj('Loan type',curVar?'Index 5%':'Wash net 0%',isVar?'Index 5%':'Wash net 0%');
 h+=proj('Funding /mo',fm(curFundMo),fm(newFundMo));
 h+=proj('Passive income',fm(curPassive)+'/mo',fm(newPassive)+'/mo',newPassive>0?'var(--accent)':'var(--text)');
 h+='</div>';
 ...
 h+='<button class="btn-secondary" style="width:100%;margin-top:8px;" onclick="Game.hidePopup()">Close</button>';
 this._epicPanel('🛡️ Cash-Value Policy',h,'🛡️ Understand your policy','Game.polToggleInfo()');},
polToggleInfo(){this._polInfo=!this._polInfo;this.openPolicyControl();},
...
polStageFund(v){const s=this.state;if(s._polStaged)s._polStaged.fundRate=Math.max(10,Math.min(25,Math.round(+v||15)));this.openPolicyControl();},
polStageLoan(v){const s=this.state;if(s._polStaged){s._polStaged.loanAmt=Math.max(0,Math.round(+v||0));if(s._polStaged.loanAmt>0)s._polStaged.repayAmt=0;/* borrow and repay are mutually exclusive — one clear move at a time */}this.openPolicyControl();},
polStageRepay(v){const s=this.state;if(s._polStaged){s._polStaged.repayAmt=Math.max(0,Math.round(+v||0));if(s._polStaged.repayAmt>0)s._polStaged.loanAmt=0;}this.openPolicyControl();},
polStagePassive(){const s=this.state;if(s._polStaged)s._polStaged.passiveOn=!s._polStaged.passiveOn;this.openPolicyControl();},
polStageFold(){const s=this.state;if(s._polStaged)s._polStaged.foldReserve=!s._polStaged.foldReserve;this.openPolicyControl();},
// Epic perk: managing the policy is FREE (no finance move) and applies immediately. Confirm locks in the whole staged set at once, then returns to the hub.
polConfirm(){const s=this.state,st=s._polStaged;if(!st){this.showEpicLife();return;}
 s._iul_loan_type=(st.loanType==='variable'?'variable':'wash');s._policy_fund_rate=Math.max(0.10,Math.min(0.25,(st.fundRate||15)/100));
 const sep=this.isSeparated(),cashKey=sep?'personal_cash':'cash';
 const amt=Math.max(0,Math.min(Math.round(st.loanAmt||0),this._policyBorrowable()));
 if(amt>0){s.insurance_loan_balance=(s.insurance_loan_balance||0)+amt;s[cashKey]=(s[cashKey]||0)+amt;s._policy_act=s._policy_act||{};s._policy_act.loan=(s._policy_act.loan||0)+amt;}
 // Repay — pay the loan down with cash, any time. Raises net cash value (cash value − loan), which is
 // exactly what passive income draws from, so this is also how you grow passive income without adding
 // more cash value: pay the loan back down.
 const repay=Math.max(0,Math.min(Math.round(st.repayAmt||0),s.insurance_loan_balance||0,s[cashKey]||0));
 if(repay>0){s.insurance_loan_balance=Math.max(0,(s.insurance_loan_balance||0)-repay);s[cashKey]=(s[cashKey]||0)-repay;s._policy_act=s._policy_act||{};s._policy_act.repay=(s._policy_act.repay||0)+repay;}
 // Fold the tax reserve into the policy — on-demand here instead of a recurring popup. Same ~2% cost of insurance as before.
 if(st.foldReserve&&(s.tax_reserve||0)>0){const foldAmt=Math.round(s.tax_reserve||0),credited=Math.round(foldAmt*0.98);s.tax_reserve=0;s.insurance_cash_value=(s.insurance_cash_value||0)+credited;s.insurance_basis=(s.insurance_basis||0)+credited;s._policy_act=s._policy_act||{};s._policy_act.foldedReserve=foldAmt;}
...
// The inverse of liquidate — spend cash to pay DOWN utilization instead of drawing it. No fee (paying a balance down never carries one). Business cash pays the business line first (protects D&B/business utilization), then personal cash (if separated) clears general revolving cards.
_creditPaydownRoom(){const s=this.state;const pool=(s.cash||0)+(this.isSeparated()?Math.max(0,s.personal_cash||0):0),owed=Math.max(0,s.business_credit_used||0)+this._persRevolving();return Math.max(0,Math.min(pool,owed));},
creditPaydown(amount){const s=this.state;if(!s._epic_life)return{paid:0};amount=Math.max(0,Math.min(Math.round(amount||0),Math.floor(this._creditPaydownRoom())));if(amount<=0)return{paid:0};
 let need=amount;const fromBiz=Math.min(need,Math.max(0,s.cash||0));if(fromBiz>0){s.cash-=fromBiz;need-=fromBiz;}
 if(this.isSeparated()&&need>0){const fromPers=Math.min(need,Math.max(0,s.personal_cash||0));if(fromPers>0){s.personal_cash-=fromPers;need-=fromPers;}}
 const paid=amount-need;if(paid<=0)return{paid:0};
 const bizUsed=Math.max(0,s.business_credit_used||0),toBiz=Math.min(paid,bizUsed);
 if(toBiz>0){s.business_credit_used-=toBiz;s.total_debt=Math.max(0,(s.total_debt||0)-toBiz);}
 const toPers=paid-toBiz;if(toPers>0){s.total_debt=Math.max(0,(s.total_debt||0)-toPers);s.available_credit=(s.available_credit||0)+toPers;}
 s._credit_paydown_total=(s._credit_paydown_total||0)+paid;return{paid,toBiz,toPers};},
// Stage an amount (no money moves yet); Confirm applies it and returns to the Epic Life menu. Liquidate and pay-down are mutually exclusive — staging one clears the other, same pattern as the policy panel's borrow/repay.
// ===== Owner Capital — legal, deliberate ways to move YOUR OWN money between yourself and your business
// (not an Epic Life perk — any LLC owner can do this in real life, member or not), plus Cash Services
// (credit↔cash, a real Epic Life perk) folded into the same panel as its own section. =====
_ownerLoanBalance(){this._ensureLoans();return Math.round((this.state.loans||[]).filter(x=>x.type==='owner_loan').reduce((a,x)=>a+Math.max(0,x.balance),0));},
// Equity injection: personal cash → business cash, permanently. No interest, no repayment — it's just business money now, at business risk. Net-worth neutral (combined cash is the same pool either way); the real cost is losing it as your personal safety net.
_capitalInject(amount){const s=this.state;if(!this.isSeparated())return{amt:0};amount=Math.max(0,Math.min(Math.round(amount||0),Math.max(0,s.personal_cash||0)));if(amount<1000)return{amt:0};s.personal_cash-=amount;s.cash=(s.cash||0)+amount;s._capital_injected_total=(s._capital_injected_total||0)+amount;return{amt:amount};},
// Shareholder loan: personal cash → business cash, booked as a REAL loan (~4.5%, near the IRS related-party rate) in the same ledger every other loan uses — shows in Debt, costs real monthly debt service, and velocity banking can target it like any other loan.
_ownerLoanIn(amount){const s=this.state;if(!this.isSeparated())return{amt:0};amount=Math.max(0,Math.min(Math.round(amount||0),Math.max(0,s.personal_cash||0)));if(amount<1000)return{amt:0};s.personal_cash-=amount;s.cash=(s.cash||0)+amount;s.total_debt=(s.total_debt||0)+amount;this._addLoan('owner_loan',amount);s._owner_loan_drawn_total=(s._owner_loan_drawn_total||0)+amount;return{amt:amount};},
// Repay yourself early (unlike a bank loan, YOU are the lender — calling it in returns cash to your personal pocket, not just to the business's books). Reuses the same extra-principal math velocity banking uses.
_ownerLoanRepay(amount){const s=this.state;const bal=this._ownerLoanBalance();amount=Math.max(0,Math.min(Math.round(amount||0),bal,Math.max(0,s.cash||0)));if(amount<1000)return{amt:0};
 let remaining=amount;for(const ln of (s.loans||[]).filter(x=>x.type==='owner_loan'&&x.balance>0.5)){if(remaining<=0)break;const chunk=Math.min(remaining,Math.round(ln.balance));if(chunk<=0)continue;this._loanPayExtra(ln,chunk);remaining-=chunk;}
 const paid=amount-remaining;if(paid<=0)return{amt:0};
 s.cash=(s.cash||0)-paid;s.personal_cash=(s.personal_cash||0)+paid;s._owner_loan_repaid_total=(s._owner_loan_repaid_total||0)+paid;return{amt:paid};},
_ocStagedDefaults(){return{inject:0,loan:0,repay:0,liq:0,paydown:0};},
_ocClearOthers(keep){const st=this.state._ocStaged;if(!st)return;['inject','loan','repay','liq','paydown'].forEach(k=>{if(k!==keep)st[k]=0;});},
// Stage one of the five moves (mutually exclusive — staging one clears the rest, same pattern as every other concierge panel).
ocStageInject(v){const s=this.state;if(!s._ocStaged)s._ocStaged=this._ocStagedDefaults();s._ocStaged.inject=Math.max(0,Math.round(+v||0));if(s._ocStaged.inject>0)this._ocClearOthers('inject');this.openOwnerCapital();},
ocStageLoan(v){const s=this.state;if(!s._ocStaged)s._ocStaged=this._ocStagedDefaults();s._ocStaged.loan=Math.max(0,Math.round(+v||0));if(s._ocStaged.loan>0)this._ocClearOthers('loan');this.openOwnerCapital();},
ocStageRepay(v){const s=this.state;if(!s._ocStaged)s._ocStaged=this._ocStagedDefaults();s._ocStaged.repay=Math.max(0,Math.round(+v||0));if(s._ocStaged.repay>0)this._ocClearOthers('repay');this.openOwnerCapital();},
ocStageLiq(v){const s=this.state;if(!s._ocStaged)s._ocStaged=this._ocStagedDefaults();s._ocStaged.liq=Math.max(0,Math.round(+v||0));if(s._ocStaged.liq>0)this._ocClearOthers('liq');this.openOwnerCapital();},
ocStagePaydown(v){const s=this.state;if(!s._ocStaged)s._ocStaged=this._ocStagedDefaults();s._ocStaged.paydown=Math.max(0,Math.round(+v||0));if(s._ocStaged.paydown>0)this._ocClearOthers('paydown');this.openOwnerCapital();},
ocToggleInfo(){this._ocInfo=!this._ocInfo;this.openOwnerCapital();},
ocConfirm(){const s=this.state,st=s._ocStaged;if(!st)return;
 if(st.inject>=1000){this._capitalInject(st.inject);this._justConfirmed='oc_inject';}
 else if(st.loan>=1000){this._ownerLoanIn(st.loan);this._justConfirmed='oc_loan';}
 else if(st.repay>=1000){this._ownerLoanRepay(st.repay);this._justConfirmed='oc_repay';}
 else if(st.liq>=1000){this.liquidateCredit(st.liq);this._justConfirmed='oc_liq';}
 else if(st.paydown>=1000){this.creditPaydown(st.paydown);this._justConfirmed='oc_paydown';}
 else return;
 s._ocStaged=null;this._refreshDashboards();this.openOwnerCapital();/* stay here — the stats box shows the result */},
openOwnerCapital(){const s=this.state,fm=v=>this.fmtMoney(v);
 const sep=this.isSeparated(),member=!!s._epic_life;
 if(!sep&&!member){this._epicPanel('💼 Owner Capital','<div style="font-size:0.85rem;line-height:1.6;color:var(--text2);">Moving money between you and your business — legally — needs an LLC first. Complete <strong>Made It Legal</strong> (Finance → Build Your Foundation) to unlock capital injections and shareholder loans. Cash Services (credit → cash) is a separate Epic Life membership perk.</div>','💼 Understand owner capital','Game.ocToggleInfo()');return;}
 const pc=Math.max(0,s.personal_cash||0),bc=Math.max(0,s.cash||0),loanBal=this._ownerLoanBalance();
 const head=this._creditHeadroom(),pa=s.available_credit||0,ba=Math.max(0,(s.business_credit_limit||0)-(s.business_credit_used||0)),pdRoom=this._creditPaydownRoom();
 const bizUsed=s.business_credit_used||0,persUsed=Math.max(0,(s.total_debt||0)-(s._installment_debt||0)-bizUsed-(s.business_installment_debt||0)-(s.real_estate_debt||0)),creditUsed=bizUsed+persUsed;
 if(!s._ocStaged)s._ocStaged=this._ocStagedDefaults();const st=s._ocStaged;
 st.inject=Math.max(0,Math.min(Math.round(st.inject||0),pc));st.loan=Math.max(0,Math.min(Math.round(st.loan||0),pc));st.repay=Math.max(0,Math.min(Math.round(st.repay||0),loanBal,bc));
 st.liq=Math.min(Math.max(0,Math.round(st.liq||0)),Math.floor(head));st.paydown=Math.min(Math.max(0,Math.round(st.paydown||0)),Math.floor(pdRoom));
 const row=(l,v,c)=>'<div class="breakdown-row"><span>'+l+'</span><span'+(c?' style="color:'+c+';font-weight:700;"':'')+'>'+v+'</span></div>';
 const proj=(l,b,a2,c)=>'<div class="breakdown-row"><span>'+l+'</span><span><span style="color:var(--text2)">'+b+'</span> → <strong style="color:'+(c||'var(--text)')+'">'+a2+'</strong></span></div>';
 let h='<div style="font-size:0.82rem;line-height:1.55;color:var(--text2);">Move your own money between you and your business, or turn credit into cash. Nothing moves until you Confirm.</div>';
 if(this._ocInfo)h+=this._understandBlock(['Two ways to move YOUR OWN money into the business — an <strong>equity injection</strong> (permanent, no interest, no repayment — it\'s now business money at business risk) or a <strong>shareholder loan</strong> (~4.5%, repayable — you can call it in early too).','A shareholder loan shows up in Debt like any other loan, and Velocity Banking can target it just like a bank loan.','<strong>Cash Services</strong> (an Epic Life membership perk): turn available credit into spendable cash for a flat 6% fee, or send cash the other way to pay utilization down — no fee.','Injecting or loaning your own capital needs an LLC (any real owner can do this) — Cash Services needs Epic Life membership instead. The two gates are independent.']);
 // ---- Dashboard ----
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">Dashboard</div><div style="padding:4px 12px;background:var(--surface);border:1px solid var(--border);border-radius:8px;margin-bottom:12px;">';
 h+=row('Cash — personal',fm(pc));
 h+=row('Cash — business',fm(bc));
 h+=row('Shareholder loan balance',fm(loanBal),loanBal>0?'var(--gold)':'var(--text2)');
 h+=row('Available credit',fm(head),'var(--accent)')+'<div class="breakdown-detail">· Business '+fm(ba)+' · Personal '+fm(pa)+'</div>';
 h+=row('Credit used',fm(creditUsed),creditUsed>0?'var(--red)':'var(--text2)')+'<div class="breakdown-detail">· Business '+fm(bizUsed)+' · Personal '+fm(persUsed)+'</div>';
 h+='</div>';
 // ---- Sliders: Owner Capital (gated on having an LLC — isSeparated()) ----
 if(sep){h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">💰 Inject capital — equity, no repayment</div>';
  if(pc>=1000){const imax=Math.floor(pc);h+='<input type="range" min="0" max="'+imax+'" step="'+Math.max(1,Math.round(imax/100))+'" value="'+st.inject+'" style="width:100%;accent-color:var(--accent);" onchange="Game.ocStageInject(this.value)">';
   h+='<div style="font-size:0.72rem;font-weight:700;color:var(--accent);margin-bottom:8px;">'+fm(st.inject)+'</div>';}
  else h+='<div style="font-size:0.72rem;color:var(--text2);margin-bottom:8px;">No personal cash on hand to inject right now.</div>';
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">🏦 Loan to the business — ~4.5%, repayable</div>';
  if(pc>=1000){const lmax=Math.floor(pc);h+='<input type="range" min="0" max="'+lmax+'" step="'+Math.max(1,Math.round(lmax/100))+'" value="'+st.loan+'" style="width:100%;accent-color:var(--gold);" onchange="Game.ocStageLoan(this.value)">';
   h+='<div style="font-size:0.72rem;font-weight:700;color:var(--gold);margin-bottom:8px;">'+fm(st.loan)+'</div>';}
  else h+='<div style="font-size:0.72rem;color:var(--text2);margin-bottom:8px;">No personal cash on hand to lend right now.</div>';
  if(loanBal>0){h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">↩ Repay yourself early — pulls cash back out</div>';
   const rmax=Math.floor(Math.min(loanBal,bc));
   if(rmax>=1000){h+='<input type="range" min="0" max="'+rmax+'" step="'+Math.max(1,Math.round(rmax/100))+'" value="'+st.repay+'" style="width:100%;accent-color:var(--red);" onchange="Game.ocStageRepay(this.value)">';
    h+='<div style="font-size:0.72rem;font-weight:700;color:var(--red);margin-bottom:4px;">'+fm(st.repay)+'</div>';}
   else h+='<div style="font-size:0.72rem;color:var(--text2);">Business doesn\'t have the cash on hand to repay you right now.</div>';}}
 else h+='<div style="font-size:0.74rem;color:var(--gold);padding:8px;line-height:1.5;margin-bottom:12px;">Form an LLC first (Finance → Build Your Foundation → Made It Legal) to unlock capital injections and shareholder loans.</div>';
 // ---- Sliders: Cash Services (gated on Epic Life membership) ----
 if(member){h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">💵 Liquidate credit → cash (6% fee)</div>';
  if(head>=1000){const hmax=Math.floor(head);h+='<input type="range" min="0" max="'+hmax+'" step="'+Math.max(1,Math.round(hmax/100))+'" value="'+st.liq+'" style="width:100%;accent-color:var(--gold);" onchange="Game.ocStageLiq(this.value)">';
   h+='<div style="font-size:0.72rem;font-weight:700;color:var(--gold);margin-bottom:8px;">'+fm(st.liq)+'</div>';}
  else h+='<div style="font-size:0.72rem;color:var(--text2);margin-bottom:8px;">No available credit to liquidate right now — open a line or lower utilization first.</div>';
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">💵 Pay down utilization with cash — no fee</div>';
  if(pdRoom>=1000){const pmax=Math.floor(pdRoom);h+='<input type="range" min="0" max="'+pmax+'" step="'+Math.max(1,Math.round(pmax/100))+'" value="'+st.paydown+'" style="width:100%;accent-color:var(--accent);" onchange="Game.ocStagePaydown(this.value)">';
   h+='<div style="font-size:0.72rem;font-weight:700;color:var(--accent);margin-bottom:8px;">'+fm(st.paydown)+'</div>';}
  else h+='<div style="font-size:0.72rem;color:var(--text2);margin-bottom:8px;">No spare cash or revolving balance to pay down right now.</div>';}
 else h+='<div style="font-size:0.72rem;color:var(--gold);padding:8px;line-height:1.5;margin-bottom:12px;">👑 <strong>Cash Services is an Epic Life membership perk.</strong> Enroll to turn available credit into cash on demand (6% fee), or pay utilization down for free.</div>';
 {const jc=this._justConfirmed,labels={oc_inject:'✓ Confirmed — capital injected',oc_loan:'✓ Confirmed — loan funded',oc_repay:'✓ Confirmed — cash returned to you',oc_liq:'✓ Confirmed — cash landed',oc_paydown:'✓ Confirmed — utilization paid down'};this._justConfirmed=null;
  const anyStaged=st.inject>=1000||st.loan>=1000||st.repay>=1000||st.liq>=1000||st.paydown>=1000;
  if(labels[jc])h+='<button style="width:100%;margin-top:10px;background:var(--accent);color:#08130c;border:none;border-radius:8px;padding:11px;font-weight:800;font-size:0.82rem;">'+labels[jc]+'</button>';
  else if(anyStaged)h+='<button onclick="Game.ocConfirm()" style="width:100%;margin-top:10px;background:var(--gold);color:#1a1205;border:none;border-radius:8px;padding:11px;font-weight:800;font-size:0.82rem;cursor:pointer;">Confirm</button>';
  else h+='<div style="font-size:0.66rem;color:var(--text2);margin-top:8px;">Pick an amount above to preview the outcome — nothing happens until you Confirm.</div>';}
 const active=st.inject>=1000||st.loan>=1000||st.repay>=1000||st.liq>=1000||st.paydown>=1000;
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:12px 0 5px;">Your capital'+(active?' · if you confirm':'')+'</div><div style="padding:6px 12px;background:'+(active?'rgba(16,185,129,0.06)':'var(--surface)')+';border:1px solid '+(active?'var(--accent)':'var(--border)')+';border-radius:8px;">';
 if(st.inject>=1000){h+=proj('Cash — personal',fm(pc),fm(pc-st.inject),'var(--red)');h+=proj('Cash — business',fm(bc),fm(bc+st.inject),'var(--accent)');h+='<div class="breakdown-detail">Permanent — no interest, no repayment. That cash is now business money, at business risk.</div>';}
 else if(st.loan>=1000){h+=proj('Cash — personal',fm(pc),fm(pc-st.loan),'var(--red)');h+=proj('Cash — business',fm(bc),fm(bc+st.loan),'var(--accent)');h+=proj('Total debt',fm(s.total_debt||0),fm((s.total_debt||0)+st.loan),'var(--red)');h+='<div class="breakdown-detail">Booked as a real business loan at ~4.5% — shows in Debt, costs monthly debt service like any loan, and you can pull it back early with Repay above.</div>';}
 else if(st.repay>=1000){h+=proj('Cash — business',fm(bc),fm(bc-st.repay),'var(--red)');h+=proj('Cash — personal',fm(pc),fm(pc+st.repay),'var(--accent)');h+=proj('Shareholder loan balance',fm(loanBal),fm(Math.max(0,loanBal-st.repay)),'var(--accent)');h+='<div class="breakdown-detail">Returns your own principal to you personally — the business\'s debt shrinks by the same amount.</div>';}
 else if(st.liq>=1000){const fee=Math.round(st.liq*0.06),net=st.liq-fee,bd=Math.min(st.liq,ba),pdraw=st.liq-bd;
  h+=proj('Cash — business',fm(bc),fm(bc+net),'var(--accent)');h+=row('Cash — personal',fm(pc));
  h+=proj('Total debt',fm(s.total_debt||0),fm((s.total_debt||0)+st.liq),'var(--red)');
  if(bd>0)h+=proj('Business credit used',fm(bizUsed),fm(bizUsed+bd));
  if(pdraw>0)h+=proj('Personal credit available',fm(pa),fm(pa-pdraw),'var(--red)');
  h+='<div class="breakdown-detail">6% fee '+fm(fee)+' · you receive '+fm(net)+' cash (business credit drawn first to protect your personal score)</div>';}
 else if(st.paydown>=1000){const toBiz=Math.min(st.paydown,bizUsed),toPers=st.paydown-toBiz;
  let need=st.paydown;const fromBiz=Math.min(need,bc);need-=fromBiz;const fromPers=sep?Math.min(need,pc):0;
  h+=proj('Cash — business',fm(bc),fm(bc-fromBiz));h+=proj('Cash — personal',fm(pc),fm(pc-fromPers));
  h+=proj('Total debt',fm(s.total_debt||0),fm(Math.max(0,(s.total_debt||0)-st.paydown)),'var(--accent)');
  if(toBiz>0)h+=proj('Business credit used',fm(bizUsed),fm(Math.max(0,bizUsed-toBiz)),'var(--accent)');
  if(toPers>0)h+=proj('Personal credit available',fm(pa),fm(pa+toPers),'var(--accent)');
  h+='<div class="breakdown-detail">No fee — business balance clears first (protects your D&amp;B utilization), then personal revolving.</div>';}
 else{h+=row('Cash — personal',fm(pc))+row('Cash — business',fm(bc))+(loanBal>0?row('Shareholder loan outstanding',fm(loanBal),'var(--gold)'):'');}
 h+='</div>';
 if((s._capital_injected_total||0)>0||(s._owner_loan_drawn_total||0)>0)h+='<div style="margin-top:10px;font-size:0.64rem;color:var(--text2);">Lifetime injected '+fm(s._capital_injected_total||0)+' · loaned in '+fm(s._owner_loan_drawn_total||0)+' · repaid to you '+fm(s._owner_loan_repaid_total||0)+'.</div>';
 if((s._credit_liquidated_total||0)>0||(s._credit_paydown_total||0)>0)h+='<div style="margin-top:4px;font-size:0.64rem;color:var(--text2);">Lifetime liquidated '+fm(s._credit_liquidated_total||0)+' · fees paid '+fm(s._credit_liquidate_fees||0)+' · paid down '+fm(s._credit_paydown_total||0)+'.</div>';
 h+='<button class="btn-secondary" style="width:100%;margin-top:8px;" onclick="Game.hidePopup()">Close</button>';
 this._epicPanel('💼 Owner Capital',h,'💼 Understand owner capital','Game.ocToggleInfo()');},
...
openFinancialHealth(){const s=this.state,fm=v=>this.fmtMoney(v),sep=this.isSeparated();
 ...
 const policyPassive=s._passive_income_active?this._policyPassiveMonthly():0,passive=(s.other_monthly_revenue||0)+policyPassive+this._pbCarry(s);
 const dsvc=this.calcDebtInterest()+this.calcDebtPrincipal(),persExp=(s.living_expenses||0)+(s.lifestyle_expenses||0)+dsvc,cover=persExp>0?Math.round(passive/persExp*100):(passive>0?100:0);/* freedom covers debt service too (owner) */
 ...
 // Same asset/debt components calcNetWorth sums — showHealthAssets()/showDebt() below must show these exact same totals (display-truth).
 const totalAssets=cash+(s.investment_positions||0)+(s.real_estate_equity||0)+(s.insurance_cash_value||0)+(s.private_bank_balance||0)+(s._captive_reserve||0)+(s._retirement_balance||0);
 const totalDebt=(s.total_debt||0)+(s.insurance_loan_balance||0)+(s.private_bank_loan||0);
 ...
 const row=(l,v,c)=>'<div class="breakdown-row"><span>'+l+'</span><span style="color:'+(c||'var(--text)')+';font-weight:700;">'+v+'</span></div>';
 const crow=(l,v,fn,c)=>'<div onclick="Game.'+fn+'" style="cursor:pointer;" class="breakdown-row"><span>'+l+' <span class="info-btn">i</span></span><span style="color:'+(c||'var(--text)')+';font-weight:700;">'+v+'</span></div>';
 if(this._fhInfo)h+=this._understandBlock(['<strong>Net worth</strong> = everything you own minus everything you owe.','<strong>Passive income</strong> = money that shows up whether you work or not — real estate, other investments, your policy, pledged-line carry.','Your concierge runs ONE high-priority money move each month. <strong>Protection</strong> prioritizes insurance, entity structure and banking relationships; <strong>Max Leverage</strong> prioritizes debt restructuring and the banking relationships that expand your business credit.','<strong>Runway</strong> = how long your cash + available credit lasts if you\'re burning more than you make.','<strong>Utilization</strong> (personal/business) is how much of your credit limit you\'re using — lower is better for your score.']);
 ...
 if(s._epic_life){if(!s._fhStaged)s._fhStaged={focus:s._concierge_focus||'balanced',paused:!!s._concierge_paused};const cst=s._fhStaged;
  const FOCI=[['protection','🛡️ Protection','Insurance, entity & banking — build the infrastructure'],['leverage','📈 Max Leverage','Restructure debt & banking relationships — get more credit/loan capacity']];
  h+='<div style="font-size:0.82rem;font-weight:700;color:var(--accent);">🎛️ Concierge</div><div style="font-size:0.72rem;color:var(--text2);line-height:1.5;margin:2px 0 8px;">Runs one high-priority money move each month. Pick a focus — tap it again for no override. <strong>Confirm</strong> to lock it in.</div>';
  ...
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:16px 0 5px;">Dashboard</div>';}
 else h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin-bottom:5px;">Dashboard</div>';
 h+='<div style="background:var(--surface);border:1px solid var(--border);border-radius:8px;padding:4px 12px;">';
 h+=crow('Passive income',fm(passive)+'/mo','showPassiveIncome()',passive>0?'var(--accent)':'var(--text2)');
 h+=crow('Total cash flow',(netFlow>=0?'+':'')+fm(netFlow)+'/mo','showHealthCashFlow()',netFlow>=0?'var(--accent)':'var(--red)');
 h+=crow('Monthly total expense',fm(burn)+'/mo','showBurn()');
 h+=crow('Total asset value',fm(totalAssets),'showHealthAssets()','var(--accent)');
 h+=crow('Total debt',fm(totalDebt),'showDebt()',totalDebt>0?'var(--red)':'var(--text2)');
 ...
 h+='<button class="btn-secondary" style="width:100%;margin-top:8px;" onclick="Game.hidePopup()">Close</button>';
 this._epicPanel('📊 Financial Health',h,'📊 Understand financial health','Game.fhToggleInfo()');},
fhToggleInfo(){this._fhInfo=!this._fhInfo;this.openFinancialHealth();},
// Combined household cash flow, itemized — every line that feeds the single "Total cash flow" dashboard number.
showHealthCashFlow(){const s=this.state,fm=v=>this.fmtMoney(Math.round(v));
 const cash=(s.cash||0)+(s.personal_cash||0),bizAvail=Math.max(0,(s.business_credit_limit||0)-(s.business_credit_used||0)),accessible=cash+(s.available_credit||0)+bizAvail;
 const policyPassive=s._passive_income_active?this._policyPassiveMonthly():0,passive=(s.other_monthly_revenue||0)+policyPassive+this._pbCarry(s);
 const dsvc=this.calcDebtInterest()+this.calcDebtPrincipal();
 const netFlow=(s.monthly_revenue||0)-(s.cogs||0)-(s.operating_expenses||0)-dsvc-(s.living_expenses||0)-(s.lifestyle_expenses||0)+passive;
 const runway=netFlow>=0?-1:accessible/Math.max(1,-netFlow);
 const row=(l,v,c)=>'<div class="breakdown-row"><span>'+l+'</span><span style="color:'+(c||'var(--text)')+';font-weight:700;">'+v+'</span></div>';
 let h='<div style="font-size:0.84rem;color:var(--text2);line-height:1.55;margin-bottom:10px;">Everything moving through your combined household cash each month — business and personal together.</div>';
 h+=row('Business revenue','+'+fm(s.monthly_revenue||0)+'/mo','var(--accent)');
 if(s.cogs>0)h+=row('COGS','−'+fm(s.cogs||0)+'/mo');
 if(s.operating_expenses>0)h+=row('Operating expenses','−'+fm(s.operating_expenses||0)+'/mo');
 if(dsvc>0)h+=row('Debt service','−'+fm(dsvc)+'/mo');
 h+=row('Passive income',(passive>=0?'+':'−')+fm(Math.abs(passive))+'/mo',passive>0?'var(--accent)':'var(--text2)');
 if(s.living_expenses>0)h+=row('Living expenses','−'+fm(s.living_expenses||0)+'/mo');
 if(s.lifestyle_expenses>0)h+=row('Lifestyle expenses','−'+fm(s.lifestyle_expenses||0)+'/mo');
 h+='<div class="breakdown-row breakdown-total"><span>Net cash flow</span><span style="color:'+(netFlow>=0?'var(--accent)':'var(--red)')+'">'+(netFlow>=0?'+':'−')+fm(Math.abs(netFlow))+'/mo</span></div>';
 if(netFlow<0)h+='<div class="breakdown-detail" style="margin-top:8px;">At this rate your cash + available credit ('+fm(accessible)+') lasts about <strong>'+Math.floor(runway)+' months</strong> — that\'s your runway.</div>';
 else h+='<div class="breakdown-detail" style="margin-top:8px;">You\'re cash-flow positive — no runway clock ticking.</div>';
 {const sr=this._survivalRunway().months;h+='<div class="breakdown-detail">Survival runway (if business revenue stopped entirely): '+(!isFinite(sr)?'∞ · revenue-proof':Math.floor(sr)+' mo')+'.</div>';}
 h+=this._statFooter();this.showPopup('💰 Total Cash Flow',h);},
// Combined household assets, itemized — the exact components calcNetWorth() sums on the asset side.
showHealthAssets(){const s=this.state,fm=v=>this.fmtMoney(Math.round(v));
 const cash=(s.cash||0)+(s.personal_cash||0),inv=s.investment_positions||0,re=s.real_estate_equity||0,cv=s.insurance_cash_value||0,pbb=s.private_bank_balance||0,capRes=s._captive_reserve||0,ret=s._retirement_balance||0;
 const total=cash+inv+re+cv+pbb+capRes+ret;
 const row=(l,v,c)=>'<div class="breakdown-row"><span>'+l+'</span><span style="color:'+(c||'var(--text)')+';font-weight:700;">'+v+'</span></div>';
 let h='<div style="font-size:0.84rem;color:var(--text2);line-height:1.55;margin-bottom:10px;">Everything you own, before subtracting what you owe (see Total Debt for that side).</div>';
 h+=row('Cash (business + personal)',fm(cash),'var(--accent)');
 if(re>0)h+=row('Real estate equity',fm(re));
 if(cv>0)h+=row('Cash-value policy',fm(cv),'var(--gold)');
 if(pbb>0)h+=row('Pledged asset line balance',fm(pbb));
 if(inv>0)h+=row('Investment positions',fm(inv));
 if(capRes>0)h+=row('Captive insurance reserve',fm(capRes));
 if(ret>0)h+=row('Retirement balance',fm(ret));
 h+='<div class="breakdown-row breakdown-total"><span>Total asset value</span><span style="color:var(--accent);">'+fm(total)+'</span></div>';
 h+='<div class="breakdown-detail" style="margin-top:6px;">Total assets minus total debt = your <strong>net worth</strong> ('+fm(this.calcNetWorth())+').</div>';
 h+=this._statFooter();this.showPopup('🏛️ Total Asset Value',h);},
...
// Tap the already-selected focus again to clear it back to 'balanced' (neutral — no bubbled priority, just the natural playbook order); tap a different one to switch.
setConciergeFocus(f){const s=this.state;if(!s._fhStaged)s._fhStaged={focus:s._concierge_focus||'balanced',paused:!!s._concierge_paused};s._fhStaged.focus=(s._fhStaged.focus===f?'balanced':f);s._fhStaged.paused=false;this.openFinancialHealth();},
...
// The 4 additive components + utilization penalty behind the D&B-style number, as real point values —
// single source of truth shared by calcBizCreditScore() and the explainer popup (showCreditScore), so
// the popup's "how it's calculated" math always matches what actually produced the number on screen.
_dnbFactors(){const s=this.state;
 const prof=s.business_credit_profile==='established'?45:s.business_credit_profile==='building'?28:14, // real business credit profile status (established > building > none)
  cred=s._dnb_profile?22:0,                                    // DUNS number + business phone/address + website/social — the paperwork that makes you a checkable business
  lim=Math.min(18,(s.business_credit_limit||0)/2500),          // credit & loan history depth — more business credit extended to you
  tradelines=Math.min(15,(s._dnb_tradelines||0)*3),            // vendor accounts reporting your on-time payments to the business bureaus
  util=this.calcBizUtil(),pen=util>50?Math.round((util-50)*0.4):0; // penalty once utilization crosses 50%
 return {prof,cred,lim,tradelines,util,pen};},
...
const f=this._dnbFactors();
return Math.max(0,Math.min(100,Math.round(f.prof+f.cred+f.lim+f.tradelines-f.pen)));},
...
calcCreditCapacity(){const s=this.state;const credit=Math.max(0.3,Math.min(2.5,((s.personal_credit_score||600)-560)/120));const size=1+Math.min(2.5,(s.monthly_revenue||0)/40000);/* revenue lifts capacity, but gently — you need ~$40k/mo to add a full 1x, so early-game lines/loans stay realistic instead of 2x'ing on modest revenue */const prof=(s.business_credit_profile==='established')?1.25:1;const cfo=s._cfo_hired?1.15:1;const fund=this._perks().fundingReady?1.12:1;const bank=this._hasBanking()?1.18:1;/* a real banking relationship (deposits + history) gets you bigger lines */return Math.round(credit*size*prof*cfo*fund*bank*100)/100;},
...
actionCashCost(a){if(a.id==='debt_restructure')return a._epic?0:this._debtRestructureFee();/* min($2k, 10% success fee on the credit/loan qualified); free for Epic members */if(a.id==='buy_real_estate'||a.id==='buy_str'){const r=this.dealRoll(a.id),t=this._dealTerm(a.id);return Math.round(r.price*Math.max(0.2,Math.min(0.5,(t.downPct||20)/100)));}if(a.id==='equipment_financing'){const _s=this.state,_ch=typeof _s._equip_choice==='string'?[_s._equip_choice]:(_s._equip_choice||[]);const _sum=_ch.reduce((t,cid)=>{const _it=(a.catalog||[]).find(x=>x.id===cid&&!(_s._equip_owned||[]).includes(x.id));return t+(_it?_it.price:0);},0);return Math.round(_sum*0.10);}/* the whole basket's down payment runs through the normal funding waterfall (biz credit → biz cash → personal LAST) *//* property buys cost the HONEST down payment on this month's deal at the player's chosen % */if(a.category==='lifestyle'&&this.state._epic_life){const _lb=a.cash_cost||0;return _lb?Math.round(_lb*0.8):0;}/* Epic members: 20% off lifestyle upgrade upfront cost */const base=a.cash_cost||0;if(!base)return 0;const retry=this.isRetry(a)?0.5:1;if(a.one_time||(a.category!=='marketing'&&a.category!=='operations'))return Math.round(base*retry);return Math.round(base*Math.min(5,Math.max(1,0.4+this.calcBusinessLevel()*0.6))*retry);},
...
this._healVelocityMembership();/* retroactively switch on velocity banking for members who joined before it became an automatic membership perk (covers older saves too) */
this.showScreen('game-screen');this.selectedActions={};this.currentCategory='marketing';this._showAllActions=false;this._isQuarterlyMonth=(this.month%3===0);if(this.state){this.state._velocity_chunk=0;this.state._policy_act={};}/* reset the velocity readout + policy activity each planning turn; manual chunks/loans (this screen) + the month-end engine accumulate into them for the result card */this.updateStages();this._setupActionMenu();
...
const passiveInc=(s.other_monthly_revenue||0)+policyPassive+this._pbCarry(s);/* actual passive paid to cash each month (real estate, lending, PE, etc.) — matches the Income Sources breakdown */
...
const RICON={'Credit Score':'📊','Cash':'💵','Credit':'💳','Income/mo':'📈','Passive/mo':'👑','Expense/mo':'📉','Cash Flow/mo':'💸','Debt':'🏦','Policy Value':'🛡️','Investments':'📊','Net Worth':'💎','D&B Score':'🏢','Revenue/mo':'📈','Owner Equity':'💼','Capital':'💰'};
const _vs=s._statsViewed||{};
// primary=true bolds the label — reserved for the always-shown headline stats, so once "Show Details"
// reveals everything, it's still obvious at a glance which ones were there before you tapped.
const row=(label,valHtml,click,id,statKey,primary)=>{const onclk=statKey?('Game.statInfo(\''+statKey+'\')'):click;const ic=!!onclk;const badge=ic?(statKey&&!_vs[statKey]?'<span class="info-btn info-new">i</span>':'<span class="info-btn">i</span>'):'';return '<div'+(id?' id="'+id+'"':'')+' style="display:flex;justify-content:space-between;align-items:baseline;gap:4px;padding:3px 1px;border-bottom:1px solid rgba(127,127,127,0.14);'+(ic?'cursor:pointer;':'')+'"'+(ic?' onclick="'+onclk+'"':'')+'><span style="font-size:0.6rem;color:var(--text2);white-space:nowrap;'+(primary?'font-weight:700;':'')+'">'+(RICON[label]?'<span style="font-size:0.72rem;">'+RICON[label]+'</span> ':'')+label+(badge?' '+badge:'')+'</span><span style="font-size:0.8rem;font-weight:700;text-align:right;white-space:nowrap;">'+valHtml+'</span></div>';};
...
// Collapsed-by-default detail toggle — ONE flag per column (Personal / Business). No separate "Show
// Details" button: the section titles themselves (Money / Capacity / Marketing & Operations) are the
// click target, with a small ▸/▾ arrow next to the title as the only affordance that they're clickable.
this._dashOpen=this._dashOpen||{};
const subLab=(t,toggleKey)=>{const arrow=toggleKey?(this._dashOpen[toggleKey]?' ▾':' ▸'):'';return '<div'+(toggleKey?' onclick="Game.toggleDash(\''+toggleKey+'\')" style="cursor:pointer;font-size:0.52rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.9px;opacity:0.8;margin:8px 0 1px;text-align:center;"':' style="font-size:0.52rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.9px;opacity:0.55;margin:8px 0 1px;text-align:center;"')+'>'+t+arrow+'</div>';};
...
// primary=true bolds the gauge/cgauge label too — same "was it always visible" signal as row()'s primary.
// Optional trailing statKey (mirrors row()/hlRow()) makes the WHOLE gauge — number included — open a
// breakdown popup via Game.statInfo(), same click-anywhere-on-the-row behavior every other stat already has.
const gauge=(label,v,col,sub,id,subBelow,primary,statKey)=>{const onclk=statKey?('Game.statInfo(\''+statKey+'\')'):null;const badge=statKey?(!_vs[statKey]?'<span class="info-btn info-new">i</span>':'<span class="info-btn">i</span>'):'';
return '<div'+(id?' id="'+id+'"':'')+' style="padding:4px 1px 2px;'+(onclk?'cursor:pointer;':'')+'"'+(onclk?' onclick="'+onclk+'"':'')+'><div style="display:flex;justify-content:space-between;align-items:baseline;gap:4px;"><span style="font-size:0.6rem;color:var(--text2);white-space:nowrap;'+(primary?'font-weight:700;':'')+'">'+label+(badge?' '+badge:'')+'</span><span style="font-size:0.75rem;font-weight:700;color:'+col+';white-space:nowrap;">'+Math.round(v)+((sub&&!subBelow)?' <span style="font-size:0.54rem;color:var(--text2);font-weight:400;">'+sub+'</span>':'')+'</span></div><div class="bar-track" style="height:4px;margin-top:3px;"><div class="bar-fill" style="width:'+Math.max(0,Math.min(100,v))+'%;background:'+col+'"></div></div>'+((sub&&subBelow)?'<div style="font-size:0.54rem;color:'+col+';font-weight:600;margin-top:3px;line-height:1.2;">'+sub+'</div>':'')+'</div>';};
const cgauge=(label,val,fill,col,primary,statKey)=>{const onclk=statKey?('Game.statInfo(\''+statKey+'\')'):null;const badge=statKey?(!_vs[statKey]?'<span class="info-btn info-new">i</span>':'<span class="info-btn">i</span>'):'';
return '<div style="padding:4px 1px 2px;'+(onclk?'cursor:pointer;':'')+'"'+(onclk?' onclick="'+onclk+'"':'')+'><div style="display:flex;justify-content:space-between;align-items:baseline;gap:4px;"><span style="font-size:0.6rem;color:var(--text2);white-space:nowrap;'+(primary?'font-weight:700;':'')+'">'+label+(badge?' '+badge:'')+'</span><span style="font-size:0.75rem;font-weight:700;color:'+col+';white-space:nowrap;">'+val+'</span></div><div class="bar-track" style="height:4px;margin-top:3px;"><div class="bar-fill" style="width:'+Math.max(0,Math.min(100,fill))+'%;background:'+col+'"></div></div></div>';};
...
P+=gauge('⚡ Energy',enReal,enC,enSub,'dash-energy',enReal<=45,true,'p_energy');
...
// Systems Maturity — now its OWN toggle (b_sys_open), independent of Customers, revealing Culture +
// Staff underneath it specifically. Built once so it can render regardless of LLC status (same as
// Founder Freedom used to — not gated on sep).
const sysMatHtml=this._reveal('mastery')?('<div id="biz-sys">'+subLab('Systems','b_sys_open')+gauge('⚙️ Systems Maturity',sysMat,sysC,null,null,false,true,'b_systems')+(this._dashOpen.b_sys_open&&(s.team_size||0)>0?cgauge('🎭 Culture',Math.round(_cul),_cul,_culC)+cgauge('👷 Staff',s.team_size||0,Math.min(100,(s.team_size||0)*10),'var(--accent)'):'')+'</div>'):'';
if(sep){
...
B+='</div>';
// Customers — now its OWN toggle (b_cust_open), independent of Systems Maturity, revealing Brand
// Equity + Leads underneath it specifically (previously both shared one "Marketing & Operations" flag).
B+='<div id="biz-ops">'+subLab('Customers','b_cust_open')+cgauge('👥 Customers',s.customer_base||0,Math.min(100,s.customer_base||0),'var(--accent)',true,'b_customers');
if(this._dashOpen.b_cust_open)B+=cgauge('✨ Brand Equity',_brand,_brand,_brC)+cgauge('🎯 Leads',s.leads||0,Math.min(100,s.leads||0),'var(--accent)');
B+='</div>';
B+=sysMatHtml;
}else{
...
// Portfolio strip — appears once the player owns leveraged assets (doors / pledged line / lending positions). One glance = empire size, income, and the risk number that matters (LTV), colored. Tap for the full breakdown.
const portBtn=(()=>{const doors=s._asset_units||0,pbBal=s.private_bank_balance||0,inv=s.investment_positions||0,ops=s._operator_count||0,eqUnits=this._equipIncomeUnitsCount();if(doors<=0&&pbBal<=0&&inv<=0&&ops<=0&&eqUnits<=0)return '';
 const reVal=(s.real_estate_equity||0)+(s.real_estate_debt||0),reLTV=reVal>0?(s.real_estate_debt||0)/reVal:0;
 const parts=[];if(doors>0)parts.push(doors+' door'+(doors>1?'s':'')+' · '+this.fmtMoney(s._asset_income||0)+'/mo · <span style="color:'+this._ltvColor(reLTV)+';">LTV '+Math.round(reLTV*100)+'%</span>');
 if(pbBal>0)parts.push('📊 '+this.fmtMoney(s.private_bank_loan||0)+' drawn');
 if(doors<=0&&pbBal<=0&&inv>0)parts.push(this.fmtMoney(inv)+' deployed');
 if(doors<=0&&pbBal<=0&&inv<=0&&(ops>0||eqUnits>0)){const over=this._operatorOverextension();parts.push(eqUnits+' equipment'+(over>0?' · <span style="color:var(--red);">'+over+' unstaffed</span>':' · staffed'));}
 return '<div onclick="Game.showPortfolio()" style="cursor:pointer;text-align:center;background:var(--surface);border:1px solid var(--gold);border-radius:var(--radius-sm);padding:7px;margin-bottom:8px;font-size:0.74rem;font-weight:600;color:var(--gold);">🏠 Portfolio · '+parts.join(' · ')+'</div>';})();
const _dash=document.getElementById(targetId||'stats-dashboard');_dash.style.display='block';_dash.innerHTML=cfoBtn+achBtn+velBtn+portBtn+'<div style="display:flex;align-items:stretch;gap:16px;"><div style="flex:1;min-width:0;">'+P+'</div><div style="width:1px;background:var(--border);"></div><div id="biz-col" style="flex:1;min-width:0;">'+B+'</div></div>';},

// The full Portfolio breakdown — the "empire view". Every leveraged asset class with its income, debt, and the risk gauges (LTV / line draw) BEFORE the downturn tests them. Legibility per DESIGN.md: the player should see the margin-call coming.
showPortfolio(){const s=this.state,fm=v=>this.fmtMoney(Math.round(v));
const doors=s._asset_units||0,strs=s._str_units||0,ltrs=Math.max(0,doors-strs);
const reEq=s.real_estate_equity||0,reDebt=s.real_estate_debt||0,reVal=reEq+reDebt,reLTV=reVal>0?reDebt/reVal:0;
const rent=s._asset_income||0,depr=s._re_depreciation||0;
const pbBal=s.private_bank_balance||0,pbLoan=s.private_bank_loan||0,draw=pbBal>0?pbLoan/pbBal:0,carry=this._pbCarry(s);
const inv=s.investment_positions||0;
const line=(l,v,col)=>'<div style="display:flex;justify-content:space-between;gap:8px;font-size:0.8rem;padding:2px 0;"><span style="color:var(--text2);">'+l+'</span><span style="font-weight:700;'+(col?'color:'+col+';':'')+'">'+v+'</span></div>';
const sect=t=>'<div style="font-size:0.7rem;color:var(--gold);text-transform:uppercase;letter-spacing:0.8px;margin:12px 0 4px;border-bottom:1px solid var(--border);padding-bottom:3px;">'+t+'</div>';
let h='';
if(doors>0){h+=sect('🏠 Real Estate — '+doors+' door'+(doors>1?'s':'')+(strs>0?' ('+ltrs+' rental'+(ltrs!==1?'s':'')+' + '+strs+' STR'+(strs>1?'s':'')+')':''));
 h+=line('Portfolio value',fm(reVal))+line('Mortgage debt',fm(reDebt))+line('Your equity',fm(reEq),'var(--accent)')+line('Rent income',fm(rent)+'/mo','var(--accent)')+(depr>0?line('Depreciation shield',fm(depr)+'/mo off taxable income','var(--blue)'):'');
 h+=this._ltvBar(reLTV,'Loan-to-value');
 const headroom=Math.max(0,Math.round(reVal*0.75)-reDebt);
 h+='<div style="font-size:0.7rem;color:var(--text2);margin-top:2px;">'+(reLTV>0.75?'<span style="color:var(--red);font-weight:600;">Over the 75% line — a downturn here can force a sale (margin call).</span>':(headroom>1000?'≈ '+fm(headroom)+' refinance-able before the 75% ceiling.':'At the ceiling — let it appreciate or pay down.'))+'</div>';
 if(s._re_margin_called)h+='<div style="font-size:0.7rem;color:var(--red);margin-top:3px;">⚠ Margin-called ×'+s._re_margin_called+' this run — the score\'s safety gate remembers.</div>';
 if(strs>0)h+='<div style="font-size:0.7rem;color:var(--text2);margin-top:3px;">🏖 STRs cash-flow ~2× a rental but lean on your time and live under city rules.</div>';}
if(pbBal>0||pbLoan>0){h+=sect('📊 Pledged Asset Line');
 h+=line('Pledged (stays invested)',fm(pbBal))+line('Drawn',fm(pbLoan))+line('Net carry',(carry>=0?'+':'−')+fm(Math.abs(carry))+'/mo',carry>=0?'var(--accent)':'var(--gold)');
 h+=this._ltvBar(draw,'Line drawn vs pledged');
 h+='<div style="font-size:0.7rem;color:var(--text2);margin-top:2px;">'+(draw>0.75?'<span style="color:var(--red);font-weight:600;">Stretched — a market drop can trigger a forced sell-down.</span>':'Cushion held — a dip won\'t force your hand.')+'</div>';
 if(s._pal_margin_called)h+='<div style="font-size:0.7rem;color:var(--red);margin-top:3px;">⚠ Line margin-called ×'+s._pal_margin_called+' this run.</div>';}
if(inv>0){h+=sect('💼 Positions & Lending');h+=line('Deployed capital',fm(inv));}
{const raw=this._operatorRawAssets(),cap=this._operatorCapacity(),over=this._operatorOverextension(),ops=s._operator_count||0,eq=this._equipIncomeUnitsCount();
 if(raw>0||ops>0){h+=sect('👷 Operator Coverage');
  h+=line('Operators hired',ops)+line('Safe capacity',cap+' asset'+(cap===1?'':'s'))+line('Income assets owned',raw+' ('+doors+' door'+(doors===1?'':'s')+' + '+eq+' equipment)');
  if(over>0)h+='<div style="font-size:0.7rem;color:var(--red);margin-top:2px;font-weight:600;">⚠ '+over+' asset'+(over===1?'':'s')+' unstaffed — underperforming income and higher operator-loss risk. Hire an Asset Operator (Operations) to cover them.</div>';
  else h+='<div style="font-size:0.7rem;color:var(--accent);margin-top:2px;">Fully staffed — every asset has an operator.</div>';
  h+='<div style="font-size:0.7rem;color:var(--text2);margin-top:2px;">'+(s._keyman_active?'Loan-protection is active on '+(s._keyman_units||0)+' covered operator'+((s._keyman_units||0)===1?'':'s')+'.':'No loan-protection policy yet — see Insure Your Operators (Finance).')+'</div>';}}
if(!h)h='<div style="color:var(--text2);font-size:0.85rem;">Nothing leveraged yet — buy a property, open a pledged line, or deploy capital and it shows up here.</div>';
this.showPopup('🏠 Your Portfolio',h);},
...
// The 5 real FICO factors, at their real weights, as 0–1 factor values PLUS the weight each carries —
// single source of truth shared by calcFicoTarget() and the explainer popup (showCreditScore), so the
// popup's "how it's calculated" math always matches what actually produced the number on screen.
_ficoFactors(){const s=this.state,u=this.calcPersUtil(),neg=s.credit_negatives||0;
 ...
 return [
  {key:'pay',label:'Payment History',weight:0.35,val:fPay,desc:'Do you pay on time? This is the single biggest factor — a missed payment lingers on your file for months.'},
  {key:'util',label:'Credit Utilization',weight:0.30,val:fUtil,desc:'How much of your available credit you\'re using right now ('+u+'%). Under 30% is healthy; under 10% is ideal. This moves the fastest — pay a balance down and it recovers within a couple months.'},
  {key:'len',label:'Length of History',weight:0.15,val:fLen,desc:'How long you\'ve had credit. This only grows with time — there\'s no shortcut, just don\'t close your oldest accounts.'},
  {key:'mix',label:'Credit Mix',weight:0.10,val:fMix,desc:'Having different KINDS of credit — revolving cards, an installment loan, business credit — shows lenders you can handle variety.'},
  {key:'new',label:'New Credit',weight:0.10,val:fNew,desc:'Opening a lot of new accounts or credit checks recently makes lenders nervous. Fades the longer you go without applying for more.'}
 ];},
calcFicoTarget(){const f=this._ficoFactors();let w=0;for(const x of f)w+=x.weight*x.val;return Math.round(300+550*w);},
...
// Dashboard detail-toggle click handler (wired to the clickable section titles built by subLab() inside
// renderStats) — flips the whole Personal or Business detail group open/shut ('personal'/'business') and
// re-renders whichever dashboard is on screen.
...
const icv=s.insurance_cash_value||0,pla=this._policyBorrowable(),ilb=s.insurance_loan_balance||0;
...
{const _fr=Math.round((s._policy_fund_rate||0.15)*100),_rev=Math.round(s.monthly_revenue||0),_isVar=s._iul_loan_type==='variable';
 h+='<div class="breakdown-row"><span>Monthly funding</span><span>'+_fr+'% · '+this.fmtMoney(Math.round(_rev*_fr/100))+'/mo</span></div>';
 h+='<div class="breakdown-row"><span>Loan type</span><span>'+(_isVar?'Index 5%':'Wash · net 0%')+'</span></div>';
...
// Soft addressable-market reach (in CLIENTS) — single source of truth for the emergent revenue plateau. Conversion saturates toward this in monthlyTick (rising CAC, no hard cap). Reach is the LESSER of two real limits, so the bottleneck shifts as you grow — which is what makes a lean business plateau and forces real investment to break through:
//  • DELIVERY CAPACITY — how many recurring accounts you can actually serve & KEEP. The founder alone carries a small book; each client-facing hire adds a real head of capacity; SYSTEMS multiply how many accounts each person can hold (automation/delivery infra). A SOLO operator tops out ~$50-80k/mo no matter the demand — to serve more you must HIRE (which then triggers the management-debt + retention treadmill below: the real "No Man's Land").
//  • MARKET DEMAND — how many clients actually want you, from brand/offer/sales-infra. Once you've hired enough to serve everyone who wants you, MORE staff buys nothing; growth then requires widening the market (brand, offer) at diminishing returns.
// Net: low team → capacity-bound (hire); high team → demand-bound (build brand). Both gates are real work, the ceiling lands in the ~$2-3M/yr No Man's Land band, and the smart way up stays FINANCE. (DESIGN.md: brute-force revenue hits a ceiling; FINANCE builds the wealth.)
mktReach(s){s=s||this.state;const team=s.team_size||0,sys=Math.min(s.systems_maturity||0,100),offer=(s._completed_actions||[]).includes('build_offer');
 const perHead=22+sys*0.30,founderCap=55+sys*0.35,capacity=founderCap+Math.min(team,12)*perHead;
 const demand=45+(s.brand_equity||0)*1.3+(offer?30:0)+Math.min(s.revenue_capacity||0,60000)/1200;
...
h+='<div class="breakdown-detail">Addressable market ~'+reach+' customers ('+cust+' won). As you saturate it, new customers cost more to win — so a lean business naturally plateaus. Grow it via brand/offer, or build wealth through FINANCE.</div>';}
...
showAssets(scope){const s=this.state,cash=(s.cash||0)+(s.personal_cash||0),inv=s.investment_positions||0,re=s.real_estate_equity||0,cv=s.insurance_cash_value||0,cap=Math.max(0,s.capital_account||0),pbb=s.private_bank_balance||0,capRes=s._captive_reserve||0,ret=s._retirement_balance||0,debt=Math.max(0,(s.total_debt||0)-(s.real_estate_debt||0))+(s.insurance_loan_balance||0)+(s.private_bank_loan||0)/* mortgage excluded — already netted in Real Estate Equity */,gross=cash+inv+re+cv+cap+pbb+capRes+ret,net=gross-debt;
...
if(ret>0)h+=r('Retirement Account',ret,'Solo 401(k)/SEP — funded pre-tax, compounding tax-deferred. Taxed when you withdraw in retirement (or tax-free if Roth).');
...
if((s.monthly_revenue||0)>2000){if(dti>50)bf.push({l:'Very high DTI ('+dti+'%)',i:'negative',d:'Debt service is over 50% of revenue (a business proxy for DTI; personal DTI uses your gross income). RE excluded.'});
else if(dti>36)bf.push({l:'High DTI ('+dti+'%)',i:'warning',d:'Lenders like to see debt service under ~36% of income (here measured vs. revenue). RE excluded.'});
else if(dti>0)bf.push({l:'Healthy DTI ('+dti+'%)',i:'positive',d:'Under ~36% (debt service vs. revenue) — manageable. RE excluded.'});}
...
// "How it's built" — the real weighted formula behind the number, in plain language. Shares the exact
// same factor math as calcFicoTarget()/calcBizCreditScore() (via _ficoFactors()/_dnbFactors()), so this
// breakdown can never drift out of sync with the number actually shown on the dashboard.
const factorRow=x=>{const pct=Math.round(x.val*100),col=x.val>=0.8?'var(--accent)':x.val>=0.5?'var(--gold)':'var(--red)';
 return '<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;align-items:baseline;"><span style="font-weight:600;">'+x.label+' <span style="color:var(--text2);font-weight:400;font-size:0.68rem;">('+Math.round(x.weight*100)+'% of your score)</span></span><span style="color:'+col+';font-weight:700;">'+pct+'%</span></div><div style="font-size:0.72rem;color:var(--text2);margin-top:1px;">'+x.desc+'</div></div>';};
const dnbRow=(label,pts,max,desc)=>{const col=pts/max>=0.8?'var(--accent)':pts/max>=0.4?'var(--gold)':'var(--text2)';
 return '<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;align-items:baseline;"><span style="font-weight:600;">'+label+'</span><span style="color:'+col+';font-weight:700;">+'+Math.round(pts)+' <span style="color:var(--text2);font-weight:400;font-size:0.68rem;">/ '+max+'</span></span></div><div style="font-size:0.72rem;color:var(--text2);margin-top:1px;">'+desc+'</div></div>';};
let h=this._scopeChip(scope)+'<div style="font-size:0.84rem;color:var(--text2);line-height:1.55;margin-bottom:10px;">'+(wantB&&!wantP?'Your <strong>D&B score</strong> rates your business\'s creditworthiness — build it and the company can borrow on its own name, without your personal guarantee.':'Your <strong>credit score</strong> is how lenders judge your reliability — it sets how much you can borrow and how cheaply. The biggest levers are paying on time and keeping <strong>utilization</strong> low.')+' Here\'s exactly how it\'s built, and what\'s helping or hurting it right now.</div>';
if(wantP){h+=head('Personal — MyFICO 3B','var(--accent)',true);
h+='<div style="font-size:1.1rem;font-weight:700;color:'+(score>=700?'var(--accent)':score>=620?'var(--gold)':'var(--red)')+'">'+score+' <span style="font-size:0.7rem;color:var(--text2);">/ 850</span></div>';
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:8px 0 2px;">How it\'s built — the 5 real FICO factors</div>'+this._ficoFactors().map(factorRow).join('');
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:10px 0 2px;">What\'s moving it right now</div>'+pf.map(frow).join('');}
if(wantB){h+=head('Business — D&B','var(--blue)',!wantP);
h+='<div style="font-size:1.1rem;font-weight:700;color:'+(biz>=70?'var(--accent)':biz>=40?'var(--gold)':'var(--text2)')+'">'+(biz?biz+' <span style="font-size:0.7rem;color:var(--text2);">/ 100</span>':'—')+'</div>';
const df=this._dnbFactors();
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:8px 0 2px;">How it\'s built — the real D&amp;B components</div>';
h+=dnbRow('Business Profile',df.prof,45,'Do you have a real, established business credit profile — not just tied to your personal name? Established beats Building beats none.');
h+=dnbRow('Business Identity',df.cred,22,'A DUNS number, a real business address/phone, a website — the paperwork that makes you a checkable, legitimate business.');
h+=dnbRow('Credit Depth',df.lim,18,'How much business credit you\'ve actually been extended. More credit in the company\'s name means a deeper track record.');
h+=dnbRow('Vendor Tradelines',df.tradelines,15,'Vendors and suppliers who report your on-time payments to the business bureaus. Each one that reports adds up.');
if(df.pen>0)h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;align-items:baseline;"><span style="font-weight:600;color:var(--red);">Utilization Penalty</span><span style="color:var(--red);font-weight:700;">&minus;'+Math.round(df.pen)+'</span></div><div style="font-size:0.72rem;color:var(--text2);margin-top:1px;">Using over half of your business credit limit ('+df.util+'% right now) starts docking points. Keep it under 50%.</div></div>';
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:10px 0 2px;">What\'s moving it right now</div>'+bf.map(frow).join('');}
...
// ===== Newly-clickable dashboard headlines (owner ask, 2026-07-05): Energy, Customers, Systems Maturity —
// same click-a-number-for-a-real-breakdown treatment every other dashboard stat already has. Lighter
// than the credit-score breakdowns above (those are the two the owner wants explained in real depth). =====
showEnergy(){const s=this.state,e=Math.round(s.energy||0),rec=this.calcEnergyRecovery(),mas=this.calcPersonalMastery(),bonus=rec-6;
let h=this._scopeChip('personal')+'<div style="font-size:0.84rem;color:var(--text2);line-height:1.55;margin-bottom:10px;">Energy is your fuel for the month — actions cost it, rest and Personal Mastery restore it. Run it into the red and your moves start failing more and delivering less.</div>';
h+='<div style="font-size:1.1rem;font-weight:700;color:'+(e>60?'var(--accent)':e>30?'var(--gold)':'var(--red)')+'">'+e+' <span style="font-size:0.7rem;color:var(--text2);">/ 100</span></div>';
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:8px 0 2px;">How it regenerates</div>';
h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">Base recovery</span><span style="color:var(--accent);font-weight:700;">+6/mo</span></div><div style="font-size:0.72rem;color:var(--text2);">Everyone gets this much back each month, no matter what.</div></div>';
h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">Personal Mastery bonus</span><span style="color:var(--accent);font-weight:700;">+'+bonus+'/mo</span></div><div style="font-size:0.72rem;color:var(--text2);">Mastery is '+mas+'/100 — roughly a tenth of that comes back as extra recovery. The higher your Mastery, the faster you bounce back each month.</div></div>';
h+='<div style="font-size:0.72rem;color:var(--text2);margin-top:8px;line-height:1.5;">Total: <strong style="color:var(--accent);">+'+rec+'/mo</strong>. Life actions and some business moves cost energy up front — spend it faster than you regenerate it and you run a deficit.</div>';
h+=this._statFooter();this.showPopup('⚡ Energy',h);},
showCustomers(){const s=this.state,cust=s.customer_base||0,leads=s.leads||0;
const convRate=Math.min(0.5,0.05+(s.skill_marketing||0)/300+(s.brand_equity||0)/1000+Math.min(0.20,(s.sales_conversion||0)*0.01)),churn=Math.round((s.churn_rate||0)*100);
let h=this._scopeChip('business')+'<div style="font-size:0.84rem;color:var(--text2);line-height:1.55;margin-bottom:10px;">Your customer count is a leaky bucket — leads convert in every month, churn drains back out. Both sides matter.</div>';
h+='<div style="font-size:1.1rem;font-weight:700;color:var(--accent);">'+cust+' <span style="font-size:0.7rem;color:var(--text2);">customers</span></div>';
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:8px 0 2px;">Filling the bucket</div>';
h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">Leads in the pipeline</span><span style="color:var(--accent);font-weight:700;">'+leads+'</span></div><div style="font-size:0.72rem;color:var(--text2);">Prospects who haven\'t bought yet. Un-nurtured leads go cold over time, so fresh marketing keeps this pipeline full.</div></div>';
h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">Conversion rate</span><span style="color:var(--accent);font-weight:700;">~'+Math.round(convRate*100)+'%/mo</span></div><div style="font-size:0.72rem;color:var(--text2);">A base rate, plus your marketing skill, your brand equity, and any sales team you\'ve built. Stronger brand and a real sales process both lift this.</div></div>';
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:10px 0 2px;">Draining the bucket</div>';
h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;color:'+(churn>15?'var(--red)':churn>8?'var(--gold)':'var(--accent)')+';">Churn</span><span style="color:'+(churn>15?'var(--red)':churn>8?'var(--gold)':'var(--accent)')+';font-weight:700;">~'+churn+'%/mo</span></div><div style="font-size:0.72rem;color:var(--text2);">A bigger customer base with weak Systems Maturity churns faster — you can\'t serve everyone well without real systems behind you. Strong Systems Maturity slows this down.</div></div>';
h+=this._statFooter();this.showPopup('👥 Customers',h);},
showSystemsMaturity(){const s=this.state,sys=Math.round(s.systems_maturity||0),cap=Math.round(this._orgCapacity()),team=s.team_size||0,over=Math.max(0,team-cap);
let h=this._scopeChip('business')+'<div style="font-size:0.84rem;color:var(--text2);line-height:1.55;margin-bottom:10px;">Systems Maturity is how well your business runs on documented process instead of your own two hands — it sets how big a team you can actually support without things breaking.</div>';
h+='<div style="font-size:1.1rem;font-weight:700;color:'+(sys>60?'var(--blue)':sys>30?'var(--gold)':'var(--red)')+'">'+sys+' <span style="font-size:0.7rem;color:var(--text2);">/ 100</span></div>';
h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:8px 0 2px;">What it controls</div>';
h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">Org capacity right now</span><span style="color:'+(over>0?'var(--red)':'var(--accent)')+';font-weight:700;">'+cap+' people</span></div><div style="font-size:0.72rem;color:var(--text2);">A founder alone can only lead a few people well — systems and real managers extend how many you can support. '+(over>0?'You\'re '+over+' over that right now, and management debt is compounding.':'Your team ('+team+') fits comfortably within it.')+'</div></div>';
h+='<div style="padding:5px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">Customer retention</span><span style="color:var(--text2);font-weight:700;">linked</span></div><div style="font-size:0.72rem;color:var(--text2);">Higher Systems Maturity slows churn as your customer base grows — a bigger book needs real systems to serve well, not just more hustle.</div></div>';
h+=this._statFooter();this.showPopup('⚙️ Systems Maturity',h);},
...
// Soft addressable-market reach (mirrors the live engine): customer growth saturates here — rising CAC, no hard cap. Revenue plateaus lean on its own.
const reach=this.mktReach(s),_cy=Math.min(s.systems_maturity||0,100);
let cust=s.customer_base||0,leads=s.leads||0;for(let i=0;i<6;i++){const sat=Math.max(0,1-cust/reach),conv=Math.floor(Math.max(0,leads-cust)*convRate*sat);cust+=conv;const scn=Math.min(0.4,(s.churn_rate||0.05)+Math.max(0,(cust-30)/30*0.01)*Math.max(0.3,1-_cy/100));cust=Math.max(0,cust-Math.floor(cust*scn));}
let projRev=cust*revPerCust+(s.other_monthly_revenue||0);
...
h+='<div class="breakdown-detail">At your current conversion ('+Math.round(convRate*100)+'%) and churn ('+Math.round((s.churn_rate||0)*100)+'%/mo). Your addressable market is ~'+Math.round(reach)+' customers — as you approach it each new customer costs more to win (saturation), so revenue plateaus lean. The way up from here is FINANCE leveraging the cash &amp; credit this business throws off.</div>';
h+=head('Where I’d Focus','var(--gold)');
h+='<div class="breakdown-detail" style="margin-bottom:5px;"><strong style="color:var(--accent)">Marketing:</strong> '+this._cfoMktg(s,reach,convRate)+'</div>';
...
s._polStaged=null;s._velStaged=null;s._fhStaged=null;s._ocStaged=null;/* returning to the hub discards any un-confirmed staging so each panel opens fresh from current state */
...
// Plan details/enroll used to live behind every sub-panel's top-right corner (now each panel uses that spot for its own "Understand X" bullets instead) — one link here keeps it reachable.
h+='<div style="text-align:right;margin:2px 0 4px;"><span onclick="Game.showMembershipInfo()" style="cursor:pointer;font-size:0.66rem;color:var(--gold);font-weight:600;">👑 '+(member?'Membership details':'What membership includes')+'</span></div>';
...
{const _hasPol=(s.insurance_cash_value||0)>0||(s._completed_actions||[]).includes('fund_accumulation_policy');
 ...
 const tile=(fn,icon,label,sub,accent,forceOn,lockLabel)=>{const on=forceOn!=null?forceOn:member,col=on?(accent||'var(--gold)'):'var(--text2)',bd=on?(accent||'var(--gold)'):'var(--border)',bg=on?('rgba('+(accent==='var(--accent)'?'16,185,129':'245,200,66')+',0.1)'):'var(--surface)';return '<div onclick="Game.'+fn+'" style="cursor:pointer;flex:1 1 30%;min-width:96px;border:1px solid '+bd+';background:'+bg+';border-radius:8px;padding:10px;text-align:center;"><div style="font-size:1.15rem;">'+icon+'</div><div style="font-size:0.72rem;font-weight:700;color:'+col+';">'+label+'</div><div style="font-size:0.56rem;color:var(--text2);">'+(on?sub:(lockLabel||'👑 Members only'))+'</div></div>';};
 ...
 h+=tile('openFinancialHealth()','📊','Financial Health',((s._concierge_paused)?'Snapshot · concierge paused':'Snapshot · concierge'),'var(--accent)');
 h+=tile('openPolicyControl()','🛡️','Cash-Value Policy',(_hasPol?'Fund · loan · passive':'Open one to start'),'var(--gold)');
 h+=tile('openVelocityControl()','⚡','Velocity Banking',(s._velocity_active?'Active · tune':(s._velocity_setup?'Paused · tune':'Sweep debt faster')),'var(--accent)');
 // Owner Capital isn't a membership perk — any LLC owner can legally inject/loan capital, so it's gated on isSeparated() (formed an LLC), not on Epic Life membership. Cash Services (credit→cash, a real Epic Life perk) now lives inside this same panel as its own section.
 h+=tile('openOwnerCapital()','💼','Owner Capital',(this._ownerLoanBalance()>0?'Inject · loan · repay · cash':'Capital · cash services'),'var(--accent)',this.isSeparated(),'Form an LLC first');
 h+='</div>';}
...
// Consolidated roadmap bar (top of the Epic Life menu): one bar across THREE checkpoints — Funding Ready → Epic Life System → 🏝️ Paradise — each leg an equal third, filled by that leg's completion.
_epicRoadmapBar(locked){const D=this._epicRoadmapData();
 const frDone=D.frPct>=100,sysDone=D.systemPct>=100,para=D.freedomPct>=100,seg=100/3;
 const fillPct=Math.min(100,Math.round((D.frPct/100)*seg+(D.systemPct/100)*seg+(D.freedomPct/100)*seg));
 const cp1=Math.round(seg),cp2=Math.round(seg*2);
 const nextTxt=para?'🏝️ Paradise — your passive income covers your life':(sysDone?'⭐ Epic Life System complete — grow passive income to reach Paradise':'Next: '+(D.nextNode||'—'));
 ...
 h+='<div style="display:flex;justify-content:space-between;align-items:baseline;"><span style="font-size:0.68rem;font-weight:700;color:var(--gold);text-transform:uppercase;letter-spacing:0.5px;">'+(locked?'🔒 Epic Life Roadmap — Preview':'⭐ Epic Life Roadmap')+'</span><span style="font-size:0.82rem;font-weight:800;color:var(--gold);">'+fillPct+'%</span></div>';
 h+='<div style="position:relative;height:10px;background:var(--surface);border:1px solid var(--border);border-radius:999px;margin:20px 0 3px;">';
 h+='<div style="position:absolute;left:0;top:0;bottom:0;width:'+Math.max(0,Math.min(100,fillPct))+'%;background:linear-gradient(90deg,var(--blue),var(--gold),var(--accent));border-radius:999px;"></div>';
 h+='<div style="position:absolute;right:-3px;top:-18px;font-size:0.76rem;">'+(para?'🏝️':'🌴')+'</div>';
 h+='</div>';/* vertical checkpoint lines removed (owner) — the fill itself is the progress */
 h+='<div style="position:relative;height:12px;">';
 h+='<span style="position:absolute;left:'+cp1+'%;transform:translateX(-50%);font-size:0.52rem;color:'+(frDone?'var(--accent)':'var(--text2)')+';white-space:nowrap;">'+(frDone?'✓':'')+'Funding</span>';
 h+='<span style="position:absolute;left:'+cp2+'%;transform:translateX(-50%);font-size:0.52rem;color:'+(sysDone?'var(--accent)':'var(--text2)')+';white-space:nowrap;">'+(sysDone?'✓':'')+'Epic Life</span>';
 h+='<span style="position:absolute;right:0;font-size:0.52rem;color:'+(para?'var(--accent)':'var(--gold)')+';white-space:nowrap;">'+(para?'✓':'')+'🏝️ Paradise</span>';
 h+='</div>';
 // ONE card = progress AND passive income (owner: the roadmap and the passive number are one and the same journey).
 // Clickable (owner ask, 2026-07-05): make it obvious this opens the full breakdown of every passive income
 // source the player has picked up (real estate/STR, other investments, policy, pledged-line carry) — not
 // just the combined total. Same info-btn convention every other dashboard number already uses.
 {const s=this.state,_pp=s._passive_income_active?this._policyPassiveMonthly():0,_pi=(s.other_monthly_revenue||0)+_pp+this._pbCarry(s),_dsvc=this.calcDebtInterest()+this.calcDebtPrincipal(),_lv=Math.round(s.living_expenses||0),_ls=Math.round(s.lifestyle_expenses||0);
  h+='<div onclick="Game.showPassiveIncome()" style="cursor:pointer;display:flex;justify-content:space-between;align-items:baseline;gap:8px;font-size:0.72rem;margin-top:6px;padding-top:6px;border-top:1px solid rgba(127,127,127,0.15);"><span style="color:var(--text2);">💸 Passive <strong style="color:var(--accent);">'+this.fmtMoney(Math.round(_pi))+'/mo</strong> vs '+this.fmtMoney(Math.round(_dsvc+_lv+_ls))+'/mo needed <span class="info-btn">i</span></span><span style="font-weight:800;color:'+(D.freedomPct>=100?'var(--accent)':'var(--gold)')+';">'+D.freedomPct+'% free</span></div>';}
 h+='<div style="font-size:0.68rem;color:var(--text2);margin-top:5px;line-height:1.4;">'+nextTxt+'</div>';
 h+='</div>';return h;},
// Full breakdown of every passive-income source behind the roadmap card's single combined number (owner
// ask, 2026-07-05) — real estate/STR income is separately tracked (_asset_income); private lending, an
// acquired competitor, and similar deployed capital all land in the same other_monthly_revenue bucket
// with no further per-source split today, so they're shown together as "Other passive investments."
showPassiveIncome(){const s=this.state,fm=v=>this.fmtMoney(Math.round(v));
 const reIncome=s._asset_income||0,policyPassive=s._passive_income_active?this._policyPassiveMonthly():0,palCarry=this._pbCarry(s);
 const otherPassive=Math.max(0,(s.other_monthly_revenue||0)-reIncome);
 const total=reIncome+otherPassive+policyPassive+palCarry;
 const dsvc=this.calcDebtInterest()+this.calcDebtPrincipal(),lv=Math.round(s.living_expenses||0),ls=Math.round(s.lifestyle_expenses||0),need=dsvc+lv+ls;
 const D=this._epicRoadmapData();
 const row=(l,v,d)=>'<div style="padding:6px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">'+l+'</span><span style="color:'+(v>=0?'var(--accent)':'var(--red)')+';font-weight:700;">'+(v>=0?'+':'')+fm(v)+'/mo</span></div>'+(d?'<div style="font-size:0.72rem;color:var(--text2);margin-top:1px;">'+d+'</div>':'')+'</div>';
 let h=this._scopeChip('personal')+'<div style="font-size:0.84rem;color:var(--text2);line-height:1.55;margin-bottom:10px;">Every income stream you\'ve picked up that pays you whether you work or not. Freedom means this total covers your monthly needs.</div>';
 h+='<div style="font-size:1.1rem;font-weight:700;color:var(--accent);">'+fm(total)+' <span style="font-size:0.7rem;color:var(--text2);">/mo passive</span></div>';
 h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:8px 0 2px;">Where it comes from</div>';
 if(reIncome>0)h+=row('Real estate / STR rental income',reIncome,(s._asset_units||0)+' door'+((s._asset_units||0)===1?'':'s')+' owned — net of the mortgage.');
 if(otherPassive>0)h+=row('Other passive investments',otherPassive,'Private lending, an acquired business, and similar deployed capital.');
 if(policyPassive>0)h+=row('Tax-free policy income',policyPassive,'Drawn from your cash-value policy — completely tax-free.');
 if(palCarry!==0)h+=row('Pledged Asset Line carry',palCarry,'What the pledged portfolio earns, net of the line\'s borrow cost.');
 if(total<=0)h+='<div style="font-size:0.78rem;color:var(--text2);padding:6px 0;">No passive income yet — real estate, private lending, or a funded cash-value policy all start one.</div>';
 h+='<div style="font-size:0.66rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;margin:10px 0 2px;">What it needs to cover</div>';
 h+='<div style="padding:6px 0;border-bottom:1px solid var(--border);"><div style="display:flex;justify-content:space-between;"><span style="font-weight:600;">Living + lifestyle + debt service</span><span style="font-weight:700;">'+fm(need)+'/mo</span></div></div>';
 h+='<div style="margin-top:8px;font-size:0.84rem;font-weight:700;text-align:center;color:'+(D.freedomPct>=100?'var(--accent)':'var(--gold)')+';">'+D.freedomPct+'% free'+(D.freedomPct>=100?' — 🏝️ Paradise: passive income covers your life':'')+'</div>';
 h+=this._statFooter();this.showPopup('💸 Passive Income',h);},
...
const policyPassive=s._passive_income_active?this._policyPassiveMonthly():0;
const passiveInc=(s.other_monthly_revenue||0)+policyPassive+this._pbCarry(s);
const persExp=(s.living_expenses||0)+(s.lifestyle_expenses||0)+this.calcDebtInterest()+this.calcDebtPrincipal();/* financially free = passive covers living expenses AND debt service (owner) — separation doesn't exempt the debt */
...
/* passive income shows ONCE in this card — inside the wealth-engine detail below (owner: the extra banner row was redundant) */
...
// The wealth-engine detail on the member result card: this month's policy activity (cash-value growth, funding in, loan taken, tax-free passive drawn, loan type) and velocity banking (target, interest saved, chunk). Only shows sections that actually have activity.
_epicWealthDetail(){const s=this.state,rows=[];
 const cv=Math.round(s.insurance_cash_value||0),loan=Math.round(s.insurance_loan_balance||0),act=s._policy_act||{},hasPolicy=cv>0||(s._completed_actions||[]).includes('fund_accumulation_policy');
 if(hasPolicy){const rate=(s._policy_fund_rate||0.15),fundMo=s._auto_fund_insurance?Math.round(Math.min((s.monthly_revenue||0)*rate,this.calcBusinessLevel()*5000)):0,isVar=s._iul_loan_type==='variable';
  let pol='<div style="font-size:0.72rem;color:var(--gold);font-weight:700;margin-bottom:2px;">🛡️ Cash-Value Policy</div>';
  pol+='<div style="display:flex;justify-content:space-between;font-size:0.72rem;"><span style="color:var(--text2);">Cash value</span><span style="font-weight:700;">'+this.fmtMoney(cv)+(s._iul_last_credit?' <span style="color:var(--accent);font-size:0.64rem;">+'+s._iul_last_credit+'%</span>':'')+'</span></div>';
  if(fundMo>0)pol+='<div style="display:flex;justify-content:space-between;font-size:0.68rem;color:var(--text2);"><span>Funded this month ('+Math.round(rate*100)+'%)</span><span>+'+this.fmtMoney(fundMo)+'</span></div>';
  if(act.loan>0)pol+='<div style="display:flex;justify-content:space-between;font-size:0.68rem;"><span style="color:var(--text2);">Loan taken · '+(isVar?'variable':'fixed 3%')+'</span><span style="color:var(--accent);">+'+this.fmtMoney(act.loan)+' cash</span></div>';
  if(act.foldedReserve>0)pol+='<div style="display:flex;justify-content:space-between;font-size:0.68rem;"><span style="color:var(--text2);">Tax reserve folded in</span><span style="color:var(--accent);">+'+this.fmtMoney(Math.round(act.foldedReserve*0.98))+' cash value</span></div>';
  if(s._lastPassive&&s._lastPassive.amt>0&&s._lastPassive.month===this.month)pol+='<div style="display:flex;justify-content:space-between;font-size:0.68rem;"><span style="color:var(--text2);">Tax-free passive drawn</span><span style="color:var(--accent);">+'+this.fmtMoney(s._lastPassive.amt)+'</span></div>';
  else if(act.passiveOn)pol+='<div style="font-size:0.68rem;color:var(--accent);">✓ Tax-free passive income switched on</div>';
  if(loan>0)pol+='<div style="display:flex;justify-content:space-between;font-size:0.66rem;color:var(--text2);"><span>Loan balance</span><span>'+this.fmtMoney(loan)+'</span></div>';
  rows.push(pol);}
 if(s._velocity_active){const vd=this._velocityReadout();let vel='<div style="font-size:0.72rem;color:var(--accent);font-weight:700;margin-bottom:2px;">⚡ Velocity Banking</div>';
  vel+='<div style="display:flex;justify-content:space-between;font-size:0.68rem;color:var(--text2);"><span>Attacking '+vd.targetLabel+'</span><span>saved '+this.fmtMoney(vd.interestSaved)+' to date</span></div>';
  if((s._velocity_chunk||0)>0)vel+='<div style="display:flex;justify-content:space-between;font-size:0.68rem;"><span style="color:var(--text2);">Chunked this month</span><span style="color:var(--accent);">'+this.fmtMoney(s._velocity_chunk)+'</span></div>';
  rows.push(vel);}
...
// ===== Operator capacity — a SEPARATE headcount from team_size/org capacity above. Real estate doors and
// staffed equipment (ATM routes etc.) each need someone actually running them day to day; _orgCapacity is
// about whether YOU can manage a team, not about whether your income assets have operators. Deliberately
// its own field so hiring a remote property/fleet operator never feeds the management-debt math above (they
// don't add to your personal management load the way an in-house hire does). =====
// Owned equipment items that actually produce income (an ATM route, not a tool that only adds capacity) — the
// asset types real-world operator/key-man coverage is actually about.
_equipIncomeUnitsCount(){const s=this.state;const eqAct=(CONFIG.actions_finance&&CONFIG.actions_finance.actions||[]).find(x=>x.id==='equipment_financing'),cat=(eqAct&&eqAct.catalog)||[];return (s._equip_owned||[]).filter(id=>{const it=cat.find(x=>x.id===id);return it&&it.income>0;}).length;},
_operatorRawAssets(){return Math.max(0,this.state._asset_units||0)+this._equipIncomeUnitsCount();},
// One operator safely covers 2 income assets (a real property/fleet manager's realistic caseload at this game's scale — tunable).
_operatorCapacity(){return (this.state._operator_count||0)*2;},
_operatorOverextension(){return Math.max(0,this._operatorRawAssets()-this._operatorCapacity());},
...
_advanceMarketCycle(){const s=this.state;
 ...
 // Downturn shock — fires once when the bust lands. Outcome gated on SURVIVAL RUNWAY (reserves + passive vs fixed costs with revenue gone): the prepared weather it, the exposed get squeezed. Makes the resilience the golden path builds legible + consequential (DESIGN.md governing principle).
 if(phase==='downturn'&&!s._downturn_shocked&&(s.monthly_revenue||0)>0){s._downturn_shocked=true;const sv=this._survivalRunway(),sm=sv.months;
  if(!isFinite(sm)||sm>=4){s._pendingRipples=(s._pendingRipples||[]).concat([{source:'📉 The Downturn',narrative:'Revenue is drying up as customers pull back — but you\'re ready. Your reserves'+(sv.passive>0?' and tax-free passive income':'')+' cover your fixed costs even with the doors half-closed ('+(!isFinite(sm)?'indefinitely':'~'+Math.floor(sm)+' months of survival runway')+'). While the over-leveraged scramble to make payroll, you sit tight — or go shopping for distressed assets.'}]);}
  else if(sm<3){const before=s.personal_credit_score||0;s.personal_credit_score=Math.max(500,before-6);s._pendingRipples=(s._pendingRipples||[]).concat([{source:'📉 The Downturn',narrative:'Revenue craters, but rent, payroll and debt payments don\'t wait — and you\'ve barely '+Math.max(0,Math.floor(sm))+' month'+(Math.floor(sm)===1?'':'s')+' of cushion if it stops. You\'re forced to scramble, maxing credit just to keep the lights on (credit score dipped '+(before-s.personal_credit_score)+' pts). This is the squeeze the prepared avoid: reserves, passive income and low leverage carry a business through a shutdown.'}]);}
  else {s._pendingRipples=(s._pendingRipples||[]).concat([{source:'📉 The Downturn',narrative:'Revenue slows as the economy turns. You\'ve got a few months of cushion (~'+Math.floor(sm)+' mo survival runway), so you can ride it out — but it\'s tight. More reserves and passive income are what turn a scary bust into a buying opportunity.'}]);}
 }
 return phase;},
...
_dryPowder(){const s=this.state;
 const policy=this._policyBorrowable();/* up to ~90% of cash value, LESS the surrender charge and any existing loan */
...
_HV:{activate_passive_income:95000,fund_accumulation_policy:62000,buy_real_estate:72000,buy_str:70000,cash_out_refi:50000,private_equity_fund:66000,private_lending:60000,premium_financing:52000,acquire_competitor:55000,private_banking:46000,setup_family_office:44000,dynasty_trust:42000,elect_s_corp:40000,debt_restructure:38000,combined_insurance:30000,business_credit_line:26000,bank_personal_loan:24000,banking_relationship:22000,monthly_tax_reserve:18000,advanced_tax_strategy:30000,asset_protection_stack:28000},
...
EPIC_ONLY:['fund_accumulation_policy','policy_loan','activate_passive_income'],/* exclusive members-only plays (the advanced wealth engine) — shown in the menu as locked 👑 Epic perks so players know the strategies exist, but the mechanism unlocks only when you join. (velocity_banking retired as an action — membership switches it on directly, see epic_life_membership handler) */
_epicHandled(a){return !!this.state._epic_life&&this.EPIC_HANDLED.includes(a.id)&&!this.isActionCompleted(a);},
// Turns velocity banking on (idempotent — safe to call even if already active). Single source of truth
// for the defaults, called both at membership time and by the older-save heal below.
_activateVelocity(){const s=this.state;s._velocity_active=true;s._velocity_setup=true;s._velocity_spiral_streak=s._velocity_spiral_streak||0;if(!s._velocity_vehicle)s._velocity_vehicle=((s.real_estate_debt||0)>0&&(s.real_estate_equity||0)>0)?'heloc':'line';if(!s._velocity_mode)s._velocity_mode='balanced';},
// Members who joined Epic Life before velocity banking became an automatic membership perk (it used to
// require separately completing a "velocity_banking" finance action, now retired) never got the flag
// flipped — heal that retroactively so no existing save is stuck behind a deleted action.
_healVelocityMembership(){const s=this.state;if(s&&s._epic_life&&!s._velocity_active&&!s._velocity_setup)this._activateVelocity();},
...
// Two foci only (owner, 2026-07-04): Protection = the protective infrastructure actions (insurance, entity);
// Max Leverage = the actions that literally expand borrowing capacity (debt_restructure raises the business
// credit limit; banking_relationship builds the lending relationship bigger loans need). Pay-down-debt and
// the policy/passive actions are deliberately NOT bubbled by either — they stay in their natural specs order
// (same as the old 'balanced' default), so picking a focus never hides or skips them, just reprioritizes.
const FOCUS={protection:['combined_insurance','wyoming_holding_llc'],leverage:['debt_restructure','banking_relationship']};
...
// Most recent action id actually taken in this category (across the whole run, not strictly "last month" —
// a category can go a few months between picks under delegation). Used for the "last pick" ghost tag.
_lastPickInCat(cat){const log=this._playLog||[];for(let i=log.length-1;i>=0;i--)if(log[i].c===cat)return log[i].id;return null;},
// Tap-to-preview: expand an action's description/preview WITHOUT selecting it, so you can compare a
// couple of candidates before committing. Independent of selection state; toggled per (category,id).
togglePeek(cat,id){this._peeked=this._peeked||{};const k=cat+':'+id;this._peeked[k]=!this._peeked[k];this.renderActions();},
// Available-card description toggle — OPEN by default, closed only if the player has manually hidden
// it; independent of selection (selecting a card never changes this).
toggleCardOpen(cat,id){this._cardCollapsed=this._cardCollapsed||{};const k=cat+':'+id;this._cardCollapsed[k]=!this._cardCollapsed[k];this.renderActions();},
...
const card=a=>{const done=this.isActionCompleted(a),locked=this.isActionLocked(a),isSel=sel&&sel.id===a.id;const reason=done?'Already completed':locked?this.getLockedReason(a):'';const outgrown=!done&&!locked&&this.isActionOutgrown(a);const rc=(this.state._action_counts||{})[a.id]||0;const inv=INVEST_OWN[a.id];const takenBefore=!done&&!a.one_time&&rc>0&&!isSel&&!inv;/* investments never "sink" as taken-before — owning one is a portfolio, not a finished chore */
// Expanded (description + owned-state showing) by default — manually hidden per card, independent of
// selection. Selecting a card no longer changes its expand state at all.
const cardOpen=!(this._cardCollapsed&&this._cardCollapsed[this.currentCategory+':'+a.id]);
const cls=done?'completed-action':isSel?'selected':locked?'locked':takenBefore?'taken-before':'';const onclick=(locked||done)?'':"Game.selectActionPayment('"+this.currentCategory+"','"+a.id+"')";const desc=this.linkTerms(a.description);const repeatBadge=(!a.one_time&&rc>0&&!isSel)?(inv?'<span class="repeat-badge" style="background:rgba(212,175,55,0.16);color:var(--gold);">'+inv.i+' ×'+rc+' '+inv.w+'</span>':'<span class="repeat-badge">✓ done ×'+rc+'</span>'):'';const isNew=!done&&!locked&&this.state._action_new_month&&this.state._action_new_month[a.id]===this.month;const newBadge=isNew?'<span class="new-badge">NEW</span>':'';
// A subtle callback if this is the same move you took last time you were in this category — not urgent,
// just orienting ("oh right, this is what I did last time"). Never on the currently selected card (SELECTED already covers that).
const lastPickBadge=(!done&&!locked&&!isSel&&this._lastPickInCat(this.currentCategory)===a.id)?'<span class="repeat-badge" style="background:rgba(59,130,246,0.14);color:var(--blue);">↺ last pick</span>':'';
// Expand/Hide toggle, top-right of the card so it never overlaps the tap-to-select area. Stops the
// click from bubbling up to the card's own select handler.
const openToggle=!locked?'<span onclick="event.stopPropagation();Game.toggleCardOpen(\''+this.currentCategory+'\',\''+a.id+'\')" style="cursor:pointer;font-size:0.6rem;color:var(--blue);font-weight:600;white-space:nowrap;flex-shrink:0;">'+(cardOpen?'▾ Hide description':'▸ Expand description')+'</span>':'';
...
const topInner=grpTag+rescueBadge+rehireBadge+unlockBadge+selBadge+partialBadge+offBadge+newBadge+repeatBadge+lastPickBadge;const topRow=topInner?'<div class="card-toprow">'+topInner+'</div>':'';
// Expanded by default (description + owned-state) — "▾ Hide description" in the title row collapses
// it manually per card; selecting the card never changes this. The "Stats impacted" line stays
// visible either way — it's the compact always-there summary, only the prose description toggles.
const statsLine=!done?this.actionPreview(a):'';
return'<div class="action-card '+cls+(isNew?' is-new':'')+' fade-in" style="'+(outgrown?'opacity:0.6;':'')+'" onclick="'+onclick+'">'+topRow+'<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;"><h4 style="margin:0 0 4px;flex:1;min-width:0;">'+a.label+'</h4>'+openToggle+'</div>'+(cardOpen?('<p>'+desc+'</p>'+(!done&&!locked?this.ownedPreview(a.id):'')):'')+statsLine+'<div class="action-costs">'+
...
// One flat list with group-name tags on each card. Order: retry (finish what you started) → the FRESH POOL (never-taken choices + owned investments, SHUFFLED per month so the menu never stales into one fixed order) → other already-run repeatables (sunk) → locked (unlocks next) → completed. Once fresh choices are exhausted, the owned investments ARE the top of the menu — reinvesting becomes the late-game default. The shuffle is seeded by the month so it's stable across re-renders within a turn.
const _takenBefore=a=>!a.one_time&&((this.state._action_counts||{})[a.id]||0)>0&&!INVEST_OWN[a.id];
const _shufKey=a=>{let h=((this.month||0)+1)*2654435761>>>0;const id=a.id;for(let i=0;i<id.length;i++)h=((h^id.charCodeAt(i))*16777619)>>>0;return h;};
const avail=actions.filter(a=>!this.isActionCompleted(a)&&!this.isActionLocked(a)).sort((a,b)=>{const pa=isPartialA(a)?1:0,pb=isPartialA(b)?1:0;if(pa!==pb)return pb-pa;const na=isNewA(a)?1:0,nb=isNewA(b)?1:0;if(na!==nb)return nb-na;/* a just-unlocked action is pinned on top for its debut month only — after that it joins the shuffle */const ta=_takenBefore(a)?1:0,tb=_takenBefore(b)?1:0;if(ta!==tb)return ta-tb;/* chores you've already run sink below the fresh pool */return _shufKey(a)-_shufKey(b);});
...
// Locked rows are tappable too — a "ⓘ" reveals what the action actually does, so you can judge whether
// chasing its prerequisite is worth it, without waiting until it unlocks to find out.
const lockRow=a=>{const _gw=this._neededBy(a.id).some(id=>!(this.state._completed_actions||[]).includes(id));const pk=!!(this._peeked&&this._peeked['locked:'+a.id]);
return '<div style="opacity:0.55;"><div style="display:flex;justify-content:space-between;align-items:center;gap:10px;padding:6px 12px;font-size:0.78rem;cursor:pointer;" onclick="Game.togglePeek(\'locked\',\''+a.id+'\')"><span style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">🔒 '+a.label+(_gw?' <span title="prerequisite — unlocks more actions once taken" style="color:var(--blue);">🔑</span>':'')+(_grpOf[a.id]?' <span class="group-tag" style="opacity:0.8;">'+_grpOf[a.id]+'</span>':'')+' <span style="color:var(--blue);font-size:0.62rem;font-weight:600;">'+(pk?'▾':'ⓘ')+'</span></span><span style="color:var(--text2);font-size:0.68rem;text-align:right;flex-shrink:0;">'+this.getLockedReason(a)+'</span></div>'+(pk?'<div style="padding:0 12px 8px;font-size:0.7rem;color:var(--text2);line-height:1.4;">'+this.linkTerms(a.description)+'</div>':'')+'</div>';};
// When every fresh (never-taken) move here is done and the player owns repeatable investments, reframe the menu: this isn't "nothing new" — it's the scaling phase.
const _cnts=this.state._action_counts||{};
const _freshLeft=avail.some(a=>((_cnts[a.id]||0)===0)&&!isPartialA(a));
const _ownsInvest=avail.some(a=>INVEST_OWN[a.id]&&(_cnts[a.id]||0)>0);
if(!_freshLeft&&_ownsInvest)listHtml+='<div style="background:rgba(212,175,55,0.08);border:1px solid rgba(212,175,55,0.35);border-radius:var(--radius-sm);padding:8px 12px;margin:4px 0 8px;font-size:0.74rem;color:var(--gold);"><strong>🔁 Grow the portfolio</strong> — every fresh move here is taken. Now you scale: each unit you add compounds your cash flow and leverage.</div>';
...
let epicPanel='';
/* Epic Life System bar removed from the game screen (owner: redundant) — it lives in the ⭐ Epic hub and the results-screen concierge card */
document.getElementById('action-list').innerHTML=banner+epicPanel+listHtml;},
// One button runs the month with the team's plan: fill any category the player didn't set with the exec pick, then resolve.
// Finance is NEVER delegated — there's no CFO/board hire in the game to hand it to, and the money decisions are the game's core lesson. Marketing & Ops can be delegated from the day you hire their exec; Finance always stays the player's own pick, every turn.
_canDelegateFinance(){return false;},
// SILENT anti-stuck safety net (no player-facing "optional" label): is there a finance move the player is genuinely meant to pick this month? Excludes membership itself (never an action to "pick"), concierge-handled actions, completed and locked actions. (Velocity banking is no longer a pickable action at all — it switches on directly with membership — so it needs no exclusion here.) Used ONLY to avoid hard-blocking the team/board "pick a Finance move" gate when the menu has nothing pickable — the visible flow still treats Finance as a normal step.
_hasRequiredFinance(){return this.getAvailableActions('finance').some(a=>a.id!=='epic_life_membership'&&!this._epicHandled(a)&&!this.isActionCompleted(a)&&!this.isActionLocked(a));},
...
// bestAction() deliberately refuses to auto-pick traps, the variable IUL loan, the pre-tax DB plan, merchant
// cash advance, and the two character-arc hires — real high-stakes choices only a player should make. Once
// delegated, if THOSE are the only finance moves left this month, bestAction() returns null and finance
// would otherwise resolve with zero visible trace (owner report, 2026-07-05: "lost a turn without
// confirmation") — flag it so showResults() can tell the player their team found nothing worth acting on,
// instead of silently doing nothing.
else if(c==='finance'&&delegFin&&this._hasRequiredFinance())this.state._financeAutoSkipped={month:this.month};}
...
selectActionPayment(cat,id){const action=this.getAvailableActions(cat).find(a=>a.id===id);if(!action||this.isActionLocked(action))return;if(id==='policy_loan'||id==='activate_passive_income'){this.openPolicyControl();return;}/* policy management lives in the ⭐ hub panel — taking a loan / switching on passive is done there (and queued as the finance move) */if(id==='buy_real_estate'||id==='buy_str'||id==='private_banking'||id==='cash_out_refi'){this.openDealControl(cat,id);return;}if(id==='equipment_financing'){this.openEquipControl(cat,id);return;}/* equipment opens its catalog picker */if(id==='retirement_plan'){this.openRetirementControl(cat,id);return;}/* pick your contribution rate before opening the plan *//* investment deals open the deal panel — review this month's roll, set your terms, then confirm to queue */this._paymentMethod='cash';this.selectAction(cat,id);},

getLockedReason(a){const s=this.state,bizAvail=Math.max(0,(s.business_credit_limit||0)-(s.business_credit_used||0)),totalFunds=(s.cash||0)+(s.available_credit||0)+bizAvail,pr=a.prerequisites||{};if(this._epicOnlyLocked(a))return'👑 Epic Life members only';if(pr.needs){const miss=pr.needs.find(id=>!(s._completed_actions||[]).includes(id));if(miss)return'Needs: '+this.actionLabel(miss);}{const cc=this.actionCashCost(a);if(cc&&totalFunds<cc)return'Not enough cash or credit';}{const ec=this.actionEnergyCost(a);if(ec>0&&(s.energy||0)-ec<-40)return'Too exhausted';}for(const[k,v]of Object.entries(pr)){if(k==='needs')continue;/* only report a prerequisite the player actually FAILS — the first-listed one may already be met (e.g. PAL blamed the 680 score at a player sitting on 800 when the real blocker was the $40k) */
if(k==='liquid_cash_gte'){if(((s.cash||0)+(s.personal_cash||0))<v)return'Need '+this.fmtMoney(v)+' in cash';continue;}
if(k==='cash_gte'){if(totalFunds<v)return'Need '+this.fmtMoney(v)+' in cash or credit';continue;}
if(k==='net_worth_gte'){if(this.calcNetWorth()<v)return'Need '+this.fmtMoney(v)+' net worth';continue;}
if(k.endsWith('_gte')){if((s[k.replace('_gte','')]||0)<v)return'Need '+k.replace('_gte','').replace(/_/g,' ')+' ≥ '+v;continue;}
if(k.endsWith('_lte')){if((s[k.replace('_lte','')]||0)>v)return'Need '+k.replace('_lte','').replace(/_/g,' ')+' ≤ '+v;continue;}
if(k.endsWith('_in')){if(!v.includes(s[k.replace('_in','')]))return'Need upgrade';continue;}
if((k==='entity_structure'||k==='business_credit_profile')&&s[k]!==v)return'Need upgrade';}
return'Locked';},
...
return curLine;},
// Live "your numbers" strip on owned investment cards (+ the always-on LTV meter for the refi): each reinvest decision shows YOUR current portfolio, not a generic pitch. LTV color: green <60% (safe), gold 60-75% (warm), red >75% (margin-call territory).
_ltvColor(ltv){return ltv>0.75?'var(--red)':ltv>0.6?'var(--gold)':'var(--accent)';},
_ltvBar(ltv,label){const pct=Math.max(0,Math.min(100,Math.round(ltv*100)));const col=this._ltvColor(ltv);return '<div style="margin:4px 0 2px;"><div style="display:flex;justify-content:space-between;font-size:0.62rem;color:var(--text2);"><span>'+label+'</span><span style="color:'+col+';font-weight:700;">'+pct+'%</span></div><div class="bar-track" style="height:5px;margin-top:2px;position:relative;"><div class="bar-fill" style="width:'+pct+'%;background:'+col+';"></div><div style="position:absolute;left:75%;top:-1px;bottom:-1px;width:1px;background:var(--red);opacity:0.6;" title="75% — the cash-out ceiling & margin-call territory"></div></div></div>';},
ownedPreview(id){const s=this.state,fm=v=>this.fmtMoney(Math.round(v)),rc=(s._action_counts||{})[id]||0;
const reEq=s.real_estate_equity||0,reDebt=s.real_estate_debt||0,reVal=reEq+reDebt,reLTV=reVal>0?reDebt/reVal:0;
const doors=s._asset_units||0,strs=s._str_units||0,ltrs=Math.max(0,doors-strs),rent=s._asset_income||0;
let h='';
if((id==='buy_real_estate'||id==='buy_str')&&doors>0){
 const mix=(ltrs>0?ltrs+' rental'+(ltrs>1?'s':''):'')+(ltrs>0&&strs>0?' + ':'')+(strs>0?strs+' STR'+(strs>1?'s':''):'');
 h='<p style="margin:0;font-size:0.72rem;color:var(--text);">🏠 <strong>Your portfolio:</strong> '+doors+' door'+(doors>1?'s':'')+' ('+mix+') · '+fm(rent)+'/mo rent · <span style="color:'+this._ltvColor(reLTV)+';font-weight:700;">LTV '+Math.round(reLTV*100)+'%</span></p>';
}else if(id==='private_banking'&&((s.private_bank_balance||0)>0||rc>0)){
 const bal=s.private_bank_balance||0,loan=s.private_bank_loan||0,draw=bal>0?loan/bal:0,carry=this._pbCarry(s);
 h='<p style="margin:0;font-size:0.72rem;color:var(--text);">📊 <strong>Your line:</strong> '+fm(bal)+' pledged · '+fm(loan)+' drawn (<span style="color:'+this._ltvColor(draw)+';font-weight:700;">'+Math.round(draw*100)+'%</span>) · carry '+(carry>=0?'+':'−')+fm(Math.abs(carry))+'/mo</p>';
}else if(id==='cash_out_refi'&&reVal>0){
 const headroom=Math.max(0,Math.round(reVal*0.75)-reDebt);
 h=this._ltvBar(reLTV,'Portfolio loan-to-value')+'<p style="margin:0;font-size:0.7rem;color:var(--text2);">'+(headroom>1000?('≈ <strong style="color:var(--gold);">'+fm(headroom)+'</strong> pullable before the 75% ceiling'):'At the 75% ceiling — no equity to pull; let it appreciate or pay down')+(reLTV>0.75?' · <span style="color:var(--red);font-weight:600;">over-levered: a downturn can force a sale</span>':'')+'</p>';
}
return h;},
// ---- DEAL-OF-THE-MONTH + DEAL CONTROL PANELS ----
// Seeded per-month RNG (month+key → 0..1): the month's deal is FIXED (no reroll by re-opening), and rerolls next month. Preview, panel and the resolveMonth handler all read the same roll, so what you see is what you buy.
_dealRand(key,n){let h=((this.month||0)+1)*2654435761>>>0;const k=key+'#'+n;for(let i=0;i<k.length;i++)h=((h^k.charCodeAt(i))*16777619)>>>0;h^=h>>>15;h=(h*2246822519)>>>0;h^=h>>>13;return ((h>>>8)%16777216)/16777216;},
// The market offers ONE specific property per month per action — a size tier and a yield-quality roll. Scarcity of the DEAL, not the action: pass, and next month's roll is different. Most rolls are average; great and thin deals are the tails.
dealRoll(id){const s=this.state,isSTR=id==='buy_str';
 const tiers=isSTR?[['beach condo',0.6],['lakeside cabin',1],['downtown loft',1.35],['mountain chalet',1.8]]:[['starter condo',0.55],['single-family rental',1],['duplex',1.5],['small 4-plex',2.2]];
 const t=tiers[Math.floor(this._dealRand(id,1)*tiers.length)];
 const capQ=0.8+this._dealRand(id,2)*0.45;/* yield quality 0.80–1.25 — sometimes a small property is a GREAT deal, or a big one is mediocre */
 const mult=Math.max(1,Math.min(isSTR?3:4,1+(s.monthly_revenue||0)/40000));
 const disc=Math.max(0.6,Math.min(1.05,s._asset_discount!=null?s._asset_discount:1));
 const fairValue=Math.round((isSTR?90000:100000)*mult*t[1]/500)*500;
 const price=Math.round(fairValue*disc/500)*500;
 const baseYield=isSTR?0.018:0.008;
 const noi=Math.round(fairValue*baseYield*capQ);
 const q=capQ/disc;/* deal quality = yield earned vs price paid; 1.0 = an average market deal */
 return {tier:t[0],fairValue,price,noi,capQ,disc,baseYield,rating:q>=1.12?'strong':q>=0.92?'fair':'thin'};},
_dealTag(r){const M={strong:['🟢 strong deal','var(--accent)'],fair:['🟡 fair deal','var(--gold)'],thin:['🔴 thin deal','var(--red)']}[r.rating];return '<span style="color:'+M[1]+';font-weight:700;white-space:nowrap;">'+M[0]+'</span>';},
// Player-set terms per investment (persist run-long as "your usual terms"; defaults are middle-of-the-road, NOT max leverage).
_dealTerm(id){const d={buy_real_estate:{downPct:20},buy_str:{downPct:20},private_banking:{drawPct:50},cash_out_refi:{ltvPct:70},retirement_plan:{pct:8}};return Object.assign({},d[id]||{},(this.state._dealTerms||{})[id]||{});},
_dealStageSet(id,k,v){const s=this.state;s._dealTerms=s._dealTerms||{};s._dealTerms[id]=s._dealTerms[id]||{};s._dealTerms[id][k]=Math.round(+v||0);this.openDealControl(this._dealCat||'finance',id);},
dealToggleInfo(id){this._dealInfo=!this._dealInfo;if(this._dealInfo){const s=this.state,ptype=(id==='buy_real_estate'||id==='buy_str')?'property':(id==='private_banking'?'pal':'refi');s._deal_primer_seen=s._deal_primer_seen||{};s._deal_primer_seen[ptype]=true;}this.openDealControl(this._dealCat||'finance',id);},
dealBack(){this._dealInfo=false;this.hidePopup();},/* back to the action list — the deal (and any queued terms) stays as-is */
// ===== Equipment catalog picker — real-world equipment plays, tiers gated by ability to pay. 10% down, ~9% APR, 5yr; the asset collateralizes the loan; Section 179 writes the price off. =====
_equipPmt(financed){const r=0.09/12,n=60;return Math.round(financed*(r*Math.pow(1+r,n))/(Math.pow(1+r,n)-1));},
...
openEquipControl(cat,id){const s=this.state,fm=v=>this.fmtMoney(Math.round(v));this._equipCat=cat;
 ...
 if(typeof s._equip_choice==='string')s._equip_choice=[s._equip_choice];/* migrate old single pick → cart */
 const cart=(s._equip_choice||[]).map(cid=>catalog.find(x=>x.id===cid&&!owned.includes(x.id)&&rev>=(x.min_rev||0))).filter(Boolean);
 ...
 const renderItem=it=>{const locked=rev<(it.min_rev||0),on=cart.some(c=>c.id===it.id),isOwned=owned.includes(it.id);
  ...
  h+='<div onclick="Game.equipPick(\''+it.id+'\')" style="cursor:pointer;border:1px solid '+(on?'var(--gold)':'var(--border)')+';background:'+(on?'rgba(245,200,66,0.10)':'var(--surface)')+';border-radius:8px;padding:7px 10px;margin-bottom:6px;">';
  h+='<div style="display:flex;justify-content:space-between;gap:8px;font-size:0.76rem;font-weight:700;"><span>'+it.icon+' '+it.label+'</span><span style="white-space:nowrap;">'+fm(it.price)+'</span></div>';
  h+='<div style="display:flex;justify-content:space-between;gap:8px;font-size:0.62rem;color:var(--text2);margin-top:2px;"><span>'+(it.income?'+'+fm(it.income)+'/mo income':(it.cap?'+'+fm(it.cap)+'/mo capacity':(it.opex?fm(-it.opex)+'/mo expenses cut':'')))+(it.upkeep?' · −'+fm(it.upkeep)+'/mo upkeep':'')+' · −'+fm(pmt)+'/mo payment</span><span>'+tag+'</span></div>';
  if(on)h+='<div style="font-size:0.64rem;color:var(--text2);line-height:1.4;margin-top:4px;">'+it.blurb+'</div>';
  h+='</div>';};
 ...
 if(cart.length){const sum=f=>cart.reduce((t,x)=>t+(f(x)||0),0);
  const price=sum(x=>x.price),down=Math.round(price*0.10),financed=price-down,pmt=cart.reduce((t,x)=>t+this._equipPmt(Math.round(x.price*0.9)),0);
  const income=sum(x=>x.income),cap=sum(x=>x.cap),opex=sum(x=>x.opex),upkeep=sum(x=>x.upkeep),exp=sum(x=>x.exp),rel=sum(x=>x.rel),brand=sum(x=>x.brand),audit=sum(x=>x.audit);
  const deduct=Math.round(sum(x=>x.price*(x.taxmult!=null?x.taxmult:1))),ytd=Math.round(s._ytd_taxable_income||0),taxBack=Math.round(deduct*(s.tax_rate||0.25));
  ...
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:8px 0 5px;">If you buy '+(cart.length===1?('the '+cart[0].label):(cart.length+' machines'))+' — one finance move</div><div style="padding:4px 12px;background:rgba(16,185,129,0.06);border:1px solid var(--accent);border-radius:8px;">';
  if(cart.length>1)h+='<div class="breakdown-detail">'+cart.map(x=>x.icon+' '+x.label).join(' · ')+'</div>';
  ...
  h+=(income?'<div class="breakdown-row"><span>Income</span><span style="font-weight:700;color:var(--accent);">+'+fm(income)+'/mo</span></div>':'')+(cap?'<div class="breakdown-row"><span>Revenue capacity</span><span style="font-weight:700;color:var(--accent);">+'+fm(cap)+'/mo</span></div>':'')+(opex?'<div class="breakdown-row"><span>Operating expenses</span><span style="font-weight:700;color:var(--accent);">'+fm(opex)+'/mo</span></div>':'');
  h+=(upkeep?'<div class="breakdown-row"><span>Upkeep</span><span style="font-weight:700;color:var(--red);">−'+fm(upkeep)+'/mo</span></div>':'')+(exp?'<div class="breakdown-row"><span>Lifestyle — experiences</span><span style="font-weight:700;color:var(--accent);">+'+exp+'</span></div>':'')+(rel?'<div class="breakdown-row"><span>Lifestyle — relationships</span><span style="font-weight:700;color:var(--accent);">+'+rel+'</span></div>':'')+(brand?'<div class="breakdown-row"><span>Brand / flex</span><span style="font-weight:700;color:var(--accent);">+'+brand+'</span></div>':'');
  h+='<div class="breakdown-row"><span>Sec. 179 write-off</span><span style="font-weight:700;color:var(--gold);">−'+fm(deduct)+' taxable income</span></div>';
  ...
  h+=(audit?'<div class="breakdown-row"><span>Audit risk</span><span style="font-weight:700;color:var(--red);">+'+audit+'</span></div><div class="breakdown-detail">Luxury write-offs are legal with documented business use — and they\'re what auditors look for first. The flex is real; so is the flag.</div>':'')+'</div>';
  if(!canGo)h+='<div style="margin-top:8px;font-size:0.72rem;color:var(--red);font-weight:600;text-align:center;">Not enough cash or credit for the '+fm(down)+' down payment — drop a machine or two.</div>';
  else{h+='<button onclick="Game.equipConfirm()" style="width:100%;margin-top:10px;background:'+(sel?'var(--accent)':'var(--gold)')+';color:#08130c;border:none;border-radius:8px;padding:11px;font-weight:800;font-size:0.82rem;cursor:pointer;">'+(sel?'✓ Confirmed — tap to undo':'Confirm '+(cart.length>1?cart.length+' machines':''))+'</button>';
   h+='<div style="font-size:0.58rem;color:'+(sel?'var(--accent)':'var(--text2)')+';text-align:center;margin-top:5px;">'+(sel?'✓ Queued as this month\'s finance move.':'One finance move buys the whole basket.')+'</div>';}}
 else h+='<div style="font-size:0.68rem;color:var(--text2);text-align:center;margin-top:4px;">Tap machines to build your basket — one finance move buys them all.</div>';
...
equipPick(itemId){const s=this.state;if((s._equip_owned||[]).includes(itemId))return;/* one each — it's a collection */
 if(typeof s._equip_choice==='string')s._equip_choice=[s._equip_choice];let c=s._equip_choice||[];
 c=c.includes(itemId)?c.filter(x=>x!==itemId):c.concat([itemId]);/* tap toggles in/out of the basket */
 s._equip_choice=c;this.openEquipControl(this._equipCat||'finance','equipment_financing');},
...
_DEAL_PRIMERS:{
// Simplified reading level (owner, 2026-07-04): shorter sentences, plain words, jargon defined the
// first time it's used instead of assumed. Same teaching content, easier to actually read.
property:'<div style="font-size:0.72rem;font-weight:800;color:var(--gold);margin-bottom:5px;">HOW TO READ A DEAL</div><ol style="margin:0;padding-left:18px;font-size:0.72rem;color:var(--text2);line-height:1.55;"><li><strong style="color:var(--text);">Good price or bad price?</strong> Is this cheaper or pricier than it\'s really worth? Prices drop in a downturn and rise in a boom — same building either way.</li><li><strong style="color:var(--text);">The main number: monthly cash flow</strong> — how much money is left over each month, per dollar you paid. The 🟢/🟡/🔴 tag compares this deal to a typical one. It only rates the DEAL — not whether you should buy it. That call is yours.</li><li><strong style="color:var(--text);">How much cushion you have</strong> — put down less cash and you owe more (this ratio is called loan-to-value, or LTV). Above ~75% owed, a downturn could force you to sell. Below ~65%, you can ride out a crash.</li><li><strong style="color:var(--text);">A tax bonus most people miss</strong> — buildings "lose value" on paper every year (called depreciation) even while making you money — that lowers your tax bill. Airbnb-style rentals get a bigger bonus, but eat more of your time.</li><li><strong style="color:var(--text);">You don\'t have to buy</strong> — a new deal shows up every month. Skipping a weak one is smart. So is waiting with cash ready for a great one.</li></ol>',
pal:'<div style="font-size:0.72rem;font-weight:800;color:var(--gold);margin-bottom:5px;">HOW MUCH TO BORROW</div><div style="font-size:0.72rem;color:var(--text2);line-height:1.55;">This line lets you borrow money using your investments as collateral (a promise, not a sale) — <strong style="color:var(--text);">your money stays invested and keeps growing</strong>. You never sell anything, so there\'s no tax on gains. The interest you pay roughly matches what your investments earn, so borrowing here is nearly free. How much you draw is the whole decision:<br><br>• <strong style="color:var(--text);">Draw a little (≤55%)</strong> — even a bad crash can\'t force you to repay early. The safe way to use it.<br>• <strong style="color:var(--text);">Draw a lot (&gt;65%)</strong> — if the market drops, you could owe more than your investments are worth. Then the bank can force-sell them at the worst possible time — that\'s called a <strong style="color:var(--red);">margin call</strong>.<br><br>Rule: keep this line ready for a good opportunity. Don\'t max it out just because you can.</div>',
refi:'<div style="font-size:0.72rem;font-weight:800;color:var(--gold);margin-bottom:5px;">HOW MUCH CASH TO PULL OUT</div><div style="font-size:0.72rem;color:var(--text2);line-height:1.55;">Loan-to-value (LTV) = how much you owe on your properties ÷ what they\'re worth. This move lets you pull cash out of your properties as a <strong style="color:var(--text);">loan, not a sale</strong> — so you don\'t pay tax on it. It works by raising your LTV, up to a 75% limit.<br><br>• <strong style="color:var(--text);">Stop around 60–65%</strong> and you keep a safety cushion if prices drop.<br>• <strong style="color:var(--text);">Go to the 75% max</strong> and you pull out the most cash — but a downturn could leave you owing more than the property is worth, risking a forced sale.<br><br>Rule: only pull cash out if it\'s going into something that pays you back monthly. Never pull out your whole safety cushion.</div>'},
openDealControl(cat,id){const s=this.state,fm=v=>this.fmtMoney(Math.round(v));this._dealCat=cat;
 const a=this.getAvailableActions(cat).find(x=>x.id===id);if(!a)return;
 // Render even when the current terms make it unaffordable (e.g. sliding the down payment past your cash) — the panel explains and disables Confirm instead of silently refusing.
 const lockedNow=this.isActionLocked(a),lockReason=lockedNow?this.getLockedReason(a):'';
 const t=this._dealTerm(id),sel=!!(this.selectedActions[cat]&&this.selectedActions[cat].id===id);
 const ptype=(id==='buy_real_estate'||id==='buy_str')?'property':(id==='private_banking'?'pal':'refi');
 // Collapsed by default (owner, 2026-07-04) — no longer auto-expands on first view. dealBack() already
 // resets _dealInfo=false on close, so a fresh open always starts collapsed; the NEW badge on the toggle
 // (below) is the only invitation, and it clears once the player actually taps it open (dealToggleInfo).
 s._deal_primer_seen=s._deal_primer_seen||{};
 ...
 const infoLbl=(this._dealInfo?'✕ Hide':'ℹ️ Understand this investment')+((!this._dealInfo&&!s._deal_primer_seen[ptype])?'<span class="new-badge">NEW</span>':'');/* toggle wording (owner): collapsed invites, open dismisses; a NEW badge — not auto-expand — invites the first tap */
 ...
 let canGo=true;
 if(ptype==='property'){const r=this.dealRoll(id),down=Math.max(20,Math.min(50,t.downPct||20))/100;
  const mort=Math.round(r.price*(1-down)),cashDown=Math.round(r.price*down),equity=r.fairValue-mort;
  const noiAdj=Math.max(0,Math.round(r.noi+r.price*(down-0.2)*0.0065));/* more down = smaller mortgage payment = more of the rent is yours */
  const yld=Math.round(noiAdj*12/r.price*1000)/10;
  const reEq=s.real_estate_equity||0,reDebt=s.real_estate_debt||0,newLTV=(reDebt+mort)/((reEq+reDebt)+r.fairValue);
  const depr=Math.round(r.price*0.8/27.5/12*(id==='buy_str'?2.4:1));
  h+='<div style="padding:8px 12px;background:rgba(245,200,66,0.06);border:1px solid var(--gold);border-radius:8px;">';
  h+='<div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;">This month\'s deal · a new one rolls next month</div>';
  h+='<div style="font-size:0.86rem;font-weight:800;color:var(--text);margin:3px 0;">'+(id==='buy_str'?'🏖 ':'🏠 ')+r.tier+' — '+fm(r.price)+' · '+this._dealTag(r)+'</div>';
  h+=(r.disc<0.98?'<div style="font-size:0.68rem;color:var(--accent);">Soft market: it\'s worth ~'+fm(r.fairValue)+' — you\'re buying '+Math.round((1-r.disc)*100)+'% under fair value.</div>':(r.disc>1.01?'<div style="font-size:0.68rem;color:var(--red);">Hot market: ~'+Math.round((r.disc-1)*100)+'% over its '+fm(r.fairValue)+' fair value.</div>':'<div style="font-size:0.68rem;color:var(--text2);">Priced at fair value.</div>'));
  h+='</div>';
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:8px 0 5px;">If you buy</div><div style="padding:4px 12px;background:rgba(16,185,129,0.06);border:1px solid var(--accent);border-radius:8px;">';
  h+=row('Cash down',fm(cashDown));
  h+=row('Mortgage (bank\'s money)',fm(mort));
  h+=row('Net cash flow',fm(noiAdj)+'/mo · '+yld+'%/yr','var(--accent)');
  h+=row('Instant equity',fm(equity),'var(--accent)');
  h+=row('Tax shield (depreciation)',fm(depr)+'/mo','var(--accent)');
  h+=row('Portfolio LTV after',Math.round(newLTV*100)+'%',this._ltvColor(newLTV));
  h+='<div class="breakdown-detail">'+(newLTV>0.75?'⚠ Over the 75% line — a downturn can force a sale. More down = more cushion.':(newLTV>0.65?'Workable, but a crash would squeeze you — consider more down, or keep reserves.':'Conservative leverage — you can ride out a downturn.'))+'</div>';
  if(id==='buy_str')h+='<div class="breakdown-detail">🏖 Hands-on hospitality: +8 key-person risk (leans on your time), exposed to city STR rules — and the depreciation shields your ACTIVE income, which a normal rental can\'t.</div>';
  if((a.success_rate||1)<1)h+='<div class="breakdown-detail">Closing odds ~'+Math.round((a.success_rate||1)*100)+'% — a rough close still buys it, on thinner cash flow.</div>';
  h+='</div>';
  h+=slider('Down payment — your cash in the deal',20,50,Math.round(down*100),Math.round(down*100)+'% = '+fm(cashDown)+' down','downPct');/* slider LAST, right above Confirm — all the moving parts in thumb reach. Floor is 20% — real DSCR/conventional investment loans essentially never go lower. */}
 else if(ptype==='pal'){const pledge=Math.round((s.cash||0)*0.85);/* business cash — matches the actual handler (private_banking), same rule as every other deal-panel action */
  const draw=Math.max(20,Math.min(70,t.drawPct||50))/100,drawAmt=Math.round(pledge*draw);
  const moEarn=Math.round(pledge*0.004),moCost=Math.round(drawAmt*0.0054),net=moEarn-moCost;
  h+='<div style="padding:8px 12px;background:rgba(245,200,66,0.06);border:1px solid var(--gold);border-radius:8px;font-size:0.74rem;color:var(--text2);line-height:1.5;">You pledge <strong style="color:var(--text);">'+fm(pledge)+'</strong> (85% of your cash) into a portfolio that <strong style="color:var(--text);">stays invested</strong> — then choose how hard to lean on it.'+(pledge<10000?'<div style="color:var(--gold);margin-top:4px;">⚠ Not much to pledge yet — the line sizes off your cash. Build the pot first.</div>':'')+'</div>';
  h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:8px 0 5px;">If you open it</div><div style="padding:4px 12px;background:rgba(16,185,129,0.06);border:1px solid var(--accent);border-radius:8px;">';
  h+=row('Pledged & still compounding',fm(pledge)+' (+'+fm(moEarn)+'/mo)','var(--accent)');
  h+=row('Cash drawn now',fm(drawAmt),'var(--gold)');
  h+=row('Interest (~SOFR + 2%)','−'+fm(moCost)+'/mo');
  h+=row('Net carry',(net>=0?'+':'−')+fm(Math.abs(net))+'/mo',net>=0?'var(--accent)':'var(--gold)');
  const vd=draw<=0.55?['🟢 Margin-call-proof','Even a deep crash can\'t force your hand — the bank never gets to sell you out.','var(--accent)']:(draw<=0.68?['🟡 Safe in a typical downturn','A deep crash would still margin-call the line — forced selling into the dip.','var(--gold)']:['🔴 Stretched','Any real downturn margin-calls this line: the bank force-sells your portfolio at the bottom and your credit takes the hit.','var(--red)']);
  h+='<div class="breakdown-row"><span>Downturn stress test</span><span style="font-weight:800;color:'+vd[2]+';">'+vd[0]+'</span></div><div class="breakdown-detail">'+vd[1]+'</div>';
  if((a.success_rate||1)<1)h+='<div class="breakdown-detail">Approval odds ~'+Math.round((a.success_rate||1)*100)+'% — a decline costs only the fee; reapply next month.</div>';
  h+='</div>';
  h+=slider('Draw — how aggressive you run the line',20,70,Math.round(draw*100),Math.round(draw*100)+'% = '+fm(drawAmt)+' cash in hand','drawPct');}
 else{const eq=s.real_estate_equity||0,debt=s.real_estate_debt||0,value=eq+debt,curLTV=value>0?debt/value:0;
  const minL=Math.min(75,Math.max(50,Math.ceil(curLTV*100/5)*5));
  const ltv=Math.max(minL,Math.min(75,t.ltvPct||70))/100,cashOut=Math.max(0,Math.round(value*ltv)-debt),svc=Math.round(cashOut*0.0065);
  h+='<div style="padding:8px 12px;background:rgba(245,200,66,0.06);border:1px solid var(--gold);border-radius:8px;">';
  h+='<div style="font-size:0.74rem;color:var(--text2);line-height:1.5;">Your portfolio is worth <strong style="color:var(--text);">'+fm(value)+'</strong> with <strong style="color:var(--text);">'+fm(debt)+'</strong> owed on it.</div>'+this._ltvBar(curLTV,'Current loan-to-value');
  h+='</div>';
  if(curLTV>=0.73){h+='<div style="font-size:0.74rem;color:var(--gold);line-height:1.5;margin-top:8px;">Already at the 75% ceiling — nothing meaningful to pull. Let it appreciate or pay debt down, then come back.</div>';canGo=false;}
  else{h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:8px 0 5px;">If you refinance</div><div style="padding:4px 12px;background:rgba(16,185,129,0.06);border:1px solid var(--accent);border-radius:8px;">';
  h+=row('Tax-free cash out',fm(cashOut),'var(--gold)');
  h+=row('New LTV',Math.round(curLTV*100)+'% → '+Math.round(ltv*100)+'%',this._ltvColor(ltv));
  h+=row('Added debt service','~'+fm(svc)+'/mo');
  h+='<div class="breakdown-detail">'+(ltv>0.7?'⚠ Thin cushion — one downturn from margin-call territory. Only pull this hard if the cash is going straight into something that cash-flows.':(ltv>0.6?'Reasonable recycle — cushion intact in a typical downturn.':'Conservative pull — crash-proof cushion, the textbook BRRRR.'))+'</div>';
  if((a.success_rate||1)<1)h+='<div class="breakdown-detail">Appraisal odds ~'+Math.round((a.success_rate||1)*100)+'% — a weak appraisal pulls only ~55% of what you asked for.</div>';
  h+='</div>';
  h+=slider('Target LTV — how much equity you pull',minL,75,Math.round(ltv*100),Math.round(ltv*100)+'% LTV = '+fm(cashOut)+' tax-free cash','ltvPct');}}
...
// Solo 401(k)/SEP — same deal-panel pattern as property/PAL/refi (slider + live preview + Confirm),
// but its own control since it doesn't fit the property/pal/refi ptype split. Real 2025 IRS figures:
// $23,500/yr personal elective-deferral limit (~$1,958/mo) and $70,000/yr combined employee+employer
// limit (~$5,833/mo) for a Solo 401(k)/SEP — the chosen rate is capped by whichever applies.
_RETIREMENT_PRIMER:'<div style="font-size:0.72rem;font-weight:800;color:var(--gold);margin-bottom:5px;">HOW MUCH TO PUT IN EACH MONTH</div><div style="font-size:0.72rem;color:var(--text2);line-height:1.55;">A Solo 401(k) lets you set aside part of your business profit before taxes come out. You only pay tax on it later, when you withdraw it, and it grows tax-deferred until then.<br><br>• <strong style="color:var(--text);">Up to about $1,958/mo</strong> ($23,500/yr) — the standard yearly limit for what YOU can personally set aside. Most businesses can comfortably do this.<br>• <strong style="color:var(--text);">Above that, up to about $5,833/mo</strong> ($70,000/yr combined) — your business can ALSO contribute on your behalf, on top of your own amount. This needs real profit behind it.<br><br>Every dollar you put in costs you less than a dollar of cash — the tax deduction covers part of it — and the rest compounds for years. Rule: don\'t starve your business of cash just to max this out. Steady beats maxed.</div>',
openRetirementControl(cat,id){const s=this.state,fm=v=>this.fmtMoney(Math.round(v));this._dealCat=cat;
 const a=this.getAvailableActions(cat).find(x=>x.id===id);if(!a)return;
 const sel=!!(this.selectedActions[cat]&&this.selectedActions[cat].id===id);
 const t=this._dealTerm(id);
 const EMP_DEFERRAL_MO=1958,COMBINED_CAP_MO=5833;
 const pctVal=Math.max(2,Math.min(30,t.pct||8)),pct=pctVal/100;
 const raw=Math.round((s.monthly_revenue||0)*pct);
 const cap=raw>EMP_DEFERRAL_MO?COMBINED_CAP_MO:EMP_DEFERRAL_MO;
 const contrib=Math.min(raw,cap),capped=raw>cap;
 const cashCost=Math.round(contrib*(1-(s.tax_rate||0.25)));
 let bal=s._retirement_balance||0;for(let i=0;i<12;i++)bal=(bal+contrib)*1.005;/* same ~6%/yr credited monthly in monthlyTick */
 const row=(l,v,c)=>'<div class="breakdown-row"><span>'+l+'</span><span style="font-weight:700;color:'+(c||'var(--text)')+'">'+v+'</span></div>';
 const slider=(lbl,min,max,val,valTxt,key)=>'<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:10px 0 3px;">'+lbl+'</div><input type="range" min="'+min+'" max="'+max+'" step="1" value="'+val+'" style="width:100%;accent-color:var(--gold);" onchange="Game._retStageSet(\''+id+'\',\''+key+'\',this.value)"><div style="font-size:0.78rem;font-weight:700;color:var(--gold);">'+valTxt+'</div>';
 const infoLbl=(this._retInfo?'✕ Hide':'ℹ️ Understand this investment')+((!this._retInfo&&!(s._deal_primer_seen&&s._deal_primer_seen.retirement))?'<span class="new-badge">NEW</span>':'');
 let h='<div style="display:flex;justify-content:space-between;align-items:center;gap:8px;margin-bottom:8px;"><button class="back-chip" style="margin:0;" onclick="Game.retirementBack()">← Back</button><span onclick="Game.retirementToggleInfo()" style="cursor:pointer;font-size:0.66rem;color:var(--text2);">'+infoLbl+'</span></div>';
 if(this._retInfo)h+='<div style="margin-bottom:10px;padding:9px 12px;background:var(--surface);border:1px solid var(--border);border-radius:6px;">'+this._RETIREMENT_PRIMER+'</div>';
 h+='<div style="font-size:0.58rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.6px;margin:8px 0 5px;">At this rate</div><div style="padding:4px 12px;background:rgba(16,185,129,0.06);border:1px solid var(--accent);border-radius:8px;">';
 h+=row('Monthly contribution',fm(contrib)+'/mo','var(--accent)');
 h+=row('Real cash cost (after deduction)','−'+fm(cashCost)+'/mo','var(--gold)');
 h+=row('Tax saved',fm(contrib-cashCost)+'/mo','var(--accent)');
 h+=row('Balance in 12 months',fm(bal),'var(--accent)');
 h+='<div class="breakdown-detail">'+(capped?('⚠ Capped by the '+(cap===EMP_DEFERRAL_MO?'$23,500/yr personal deferral limit — to put in more, your business needs enough profit to contribute on your behalf too.':'$70,000/yr combined limit — you\'re already at the max a Solo 401(k) allows.')):'Well within IRS limits — there\'s room to put in more if you want to.')+'</div>';
 h+='</div>';
 h+=slider('Contribution rate — % of monthly revenue',2,30,pctVal,pctVal+'% of revenue = '+fm(contrib)+'/mo','pct');
 h+='<button onclick="Game.retirementConfirm(\''+cat+'\',\''+id+'\')" style="width:100%;margin-top:12px;background:'+(sel?'var(--accent)':'var(--gold)')+';color:#08130c;border:none;border-radius:8px;padding:11px;font-weight:800;font-size:0.82rem;cursor:pointer;">'+(sel?'✓ Confirmed — tap to undo':'Confirm')+'</button>';
 h+='<div style="font-size:0.58rem;color:'+(sel?'var(--accent)':'var(--text2)')+';text-align:center;margin-top:5px;">'+(sel?'✓ Queued as this month\'s finance move — slider changes update it instantly.':'Uses this month\'s finance move. Your rate is remembered going forward.')+'</div>';
 h+='<button class="btn-secondary" style="width:100%;margin-top:8px;" onclick="Game.retirementBack()">Close</button>';
 this.showPopup(a.label,h);const _d=document.querySelector('#popup-container .popup-box > button.btn-secondary');if(_d)_d.style.display='none';},
_retStageSet(id,k,v){const s=this.state;s._dealTerms=s._dealTerms||{};s._dealTerms[id]=s._dealTerms[id]||{};s._dealTerms[id][k]=Math.round(+v||0);this.openRetirementControl(this._dealCat||'finance',id);},
retirementToggleInfo(){this._retInfo=!this._retInfo;if(this._retInfo){const s=this.state;s._deal_primer_seen=s._deal_primer_seen||{};s._deal_primer_seen.retirement=true;}this.openRetirementControl(this._dealCat||'finance','retirement_plan');},
retirementConfirm(cat,id){this._paymentMethod='cash';this.selectAction(cat,id);this._retInfo=false;this.openRetirementControl(cat,id);},
retirementBack(){this._retInfo=false;this.hidePopup();},
...
case 'debt_restructure':txt='≈ '+fm(12000*cf)+' business line to move balances onto, sized to your credit';break;
case 'buy_real_estate':{const r=this.dealRoll(id);txt='🏠 This month: '+r.tier+' — '+fm(r.price)+', '+fm(r.noi)+'/mo net · '+this._dealTag(r)+' · tap to review';break;}
case 'buy_str':{const r=this.dealRoll(id);txt='🏖 This month: '+r.tier+' — '+fm(r.price)+', '+fm(r.noi)+'/mo (≈2× a rental) · '+this._dealTag(r)+' · tap to review';break;}
case 'cash_out_refi':{const eq=s.real_estate_equity||0,debt=s.real_estate_debt||0,value=eq+debt,pull=Math.max(0,Math.round(value*0.75)-debt);txt='≈ up to '+fm(pull)+' tax-free at the 75% ceiling — tap to choose how much cushion to keep';break;}
case 'private_banking':{const pledge=Math.round((s.cash||0)*0.85);txt='≈ '+fm(pledge)+' pledged & still compounding — tap to choose how hard to draw against it';break;}
...
primaryActionBtn(){const s=this.state,team=(s._cro_hired&&s._coo_hired)||s._board_active;
if(team){const ac=this._activeCats||CATS;
// Navigate to the still-required category FIRST (matches the "Next: …" button text above) instead of
// calling runTeamMonth and letting it interrupt with a popup after the fact — same tap-to-advance feel
// as solo mode, just for the two categories execs can't take over (Finance pre-Wealth, Life always).
if(ac.includes('finance')&&!this._canDelegateFinance()&&this._hasRequiredFinance()&&!this.selectedActions.finance){if(this.currentCategory!=='finance')this.switchCategory('finance');return this._focusActionList();}
if(ac.includes('lifestyle')&&!this.selectedActions.lifestyle){if(this.currentCategory!=='lifestyle')this.switchCategory('lifestyle');return this._focusActionList();}
return this.runTeamMonth();}/* both gates clear: execs fill any other line you didn't override, then the month runs */
...
{const s=this.state,team=(s._cro_hired&&s._coo_hired)||s._board_active;if(team){
// Team mode still tells you what's next instead of just "Run the Month" — Finance and Life stay the
// player's own pick (execs can't be handed them yet), so the button reads "Next: …" exactly like solo
// mode until those are set, THEN it becomes the one clear "Run the Month" action.
if(sec)sec.style.display='none';
if(ac.includes('finance')&&!this._canDelegateFinance()&&this._hasRequiredFinance()&&!this.selectedActions.finance)btn.textContent='Next: Finance →';
else if(ac.includes('lifestyle')&&!this.selectedActions.lifestyle)btn.textContent='Next: Life →';
else btn.textContent='▶ Run the Month';
return;}}
...
_tapTaxReserveToSurvive(need){const s=this.state;if(need<=0)return need;
 if((s.tax_reserve||0)>=need){s.tax_reserve-=need;this._taxRescue=(this._taxRescue||0)+need;return 0;}
 // Reserve alone doesn't cover it — often because it was folded into the policy. The fold's own promise
 // ("it still covers you via a tax-free policy loan when the bill comes") was only honored for actual tax
 // bills (showTaxEvent's drawWaterfall) — extend the same rescue to every OTHER kind of shortfall, so
 // folding never silently removes a safety net, just relocates it.
 const borrow=this._policyBorrowable();
 if(borrow>=need){s.insurance_loan_balance=(s.insurance_loan_balance||0)+need;this._taxRescue=(this._taxRescue||0)+need;this._policyRescue=(this._policyRescue||0)+need;return 0;}
 return need;},
...
applyDebtRestructure(dr){const s=this.state;dr=dr||{};const persRev=Math.max(0,(s.total_debt||0)-(s._installment_debt||0)-(s.business_credit_used||0)-(s.business_installment_debt||0));const persLim=persRev+(s.available_credit||0);const beforeUtil=persLim>0?Math.round(persRev/persLim*100):0;const movable=Math.max(0,persRev-(s.real_estate_debt||0));let swap=Math.max(0,Math.min(movable,Math.round(persRev-0.22*persLim)));if(swap>0){s._installment_debt=(s._installment_debt||0)+swap;}/* moving a card balance into a fixed installment loan lowers utilization via persRev shrinking — it doesn't raise your personal credit LIMIT, so available_credit must not move here either. */const afterUtil=this.calcPersUtil();if(swap>0)s.personal_credit_score=Math.min(850,(s.personal_credit_score||0)+Math.max(4,Math.round((beforeUtil-afterUtil)/2)));const parts=[];if(dr.lim)parts.push('opened a '+this.fmtMoney(dr.lim)+' business line at 0%');if(swap>0)parts.push('moved '+this.fmtMoney(swap)+' of revolving card debt into a fixed-rate installment loan (utilization '+beforeUtil+'% → '+afterUtil+'%)');if(dr.moveAmt>0)parts.push('shifted '+this.fmtMoney(dr.moveAmt)+' of personal balances onto your business credit, off your personal report');return parts.length?('Your lending expert '+parts.join('; ')+'. Same debt — restructured into a higher score and a healthier credit profile, with business borrowing headroom left intact.'):('Your utilization is already healthy at '+beforeUtil+'%. Little revolving debt left to restructure.');},
resolveMonth(){
...
// Deal-panel/investment actions are excluded from the retry/half-cost mechanic (owner, 2026-07-04):
// their cost is a fresh roll every month (dealRoll/basket total), not a fixed price you're chipping
// away at, so "retry at half cost" never actually applied to their real cost (buy_real_estate/buy_str/
// equipment_financing were already bypassing the halving in actionCashCost's early-return) — it just
// showed a misleading "HALF COST" badge. A new deal rolls next month regardless; no special-cased retry state needed.
const DEAL_PANEL_IDS=['buy_real_estate','buy_str','private_banking','cash_out_refi','equipment_financing'];
if(!this.state._partial_actions)this.state._partial_actions={};if(cat!=='lifestyle'&&!DEAL_PANEL_IDS.includes(action.id)){if(success)delete this.state._partial_actions[action.id];else this.state._partial_actions[action.id]=true;}
...
// CFO/Finance is deliberately excluded (owner, 2026-07-04) — Sales Manager and Ops Manager keep their
// performance bonus on a successful auto-pick; the CFO does not get one.
if(this._autoPicked&&this._autoPicked[cat]===action.id&&success&&['marketing','operations'].includes(cat)){const role=cat==='marketing'?'Sales Manager':'Ops Manager';const bonus=Math.max(1000,Math.min(15000,Math.round((this.state.monthly_revenue||0)*0.03)));this.payCost(bonus,false);_execBonuses.push({role,bonus,label:action.label});}
...
// (velocity_banking's own action-completion handler removed — the action is retired; activation now happens directly in the epic_life_membership handler above via _activateVelocity())
...
// Active credit management sometimes prompts a card issuer to auto-raise your limit — free utilization relief that quietly lifts the score. Real issuers review accounts for an automatic CLI roughly every 6-12 months, not every time you so much as touch your credit — gate this the same way (a 6-month cooldown) so it can't fire back-to-back just because build_personal_credit gets taken again right away.
const _cliReady=(s._lastCLIBonusMonth==null||(this.month-s._lastCLIBonusMonth)>=6);if(_cliReady&&Math.random()<0.5){const persRev=Math.max(0,(s.total_debt||0)-(s._installment_debt||0)-(s.business_credit_used||0)-(s.business_installment_debt||0)-(s.real_estate_debt||0)),lim=persRev+(s.available_credit||0),bump=Math.round(Math.max(1500,lim*0.15));s.available_credit=(s.available_credit||0)+bump;s._lastCLIBonusMonth=this.month;s._dyn_narrative=(s._dyn_narrative||'')+' <strong>Bonus:</strong> a card issuer automatically raised your limit by '+this.fmtMoney(bump)+' — that drops your utilization and quietly lifts your score, no payment required.';}}
...
if(action.id==='fund_accumulation_policy'&&success){const s=this.state;s._auto_fund_insurance=true;s._policy_open_month=this.month;/* start the surrender-charge clock */const cur=Math.round(Math.min((s.monthly_revenue||0)*0.15,this.calcBusinessLevel()*5000));
// First passive DRIP (spec §3, retention): a small policy dividend the month you open — the earliest legible taste of "money that shows up whether you work or not," well before full tax-free passive income is switched on nearer the Wealth stage. Persistent stream (other_monthly_revenue survives the monthly revenue recompute); fires the "First Passive Dollar" milestone.
if(!s._policy_first_drip){s._policy_first_drip=340;s.other_monthly_revenue=(s.other_monthly_revenue||0)+340;}
s._dyn_narrative='Policy opened and automatic funding is on — about '+this.fmtMoney(cur)+'/mo (scaling up with your revenue) flows in, a ~2% cost of insurance off the top, all compounding tax-free. And it already pays you a small <strong style="color:var(--accent)">+'+this.fmtMoney(340)+'/mo dividend</strong> — money that shows up whether you work or not. That\'s the engine; switch on full tax-free passive income once it\'s funded.'+((s.tax_reserve||0)>0?' You\'ve also got a tax reserve sitting idle — fold it into the policy any time from the 🛡️ Cash-Value Policy panel.':'');}
if(action.id==='debt_restructure'){let _dr={success};if(success){const s=this.state,cf=this.calcCreditCapacity(),wantLim=Math.round(12000*cf),lim=this._stackBusinessCredit(wantLim);const persRev=Math.max(0,(s.total_debt||0)-(s._installment_debt||0)-(s.business_credit_used||0)-(s.business_installment_debt||0)-(s.real_estate_debt||0)),bizAvail=Math.max(0,(s.business_credit_limit||0)-(s.business_credit_used||0));
// Move only enough personal balance onto the business line (new-or-existing — a fresh line only opens every ~6mo/within the $250k stacking ceiling, see _stackBusinessCredit) to keep business utilization HEALTHY (≤50%) — never max it out. Leaves borrowing headroom; the rest of the personal-utilization cleanup happens via the installment swap in applyDebtRestructure. This is a credit RESTRUCTURE, not a cash advance — no working cash is pulled (cash comes from SBA / term loans, which are installment debt that deposits money; a line is credit, not cash).
const moveCap=Math.max(0,Math.round(0.5*(s.business_credit_limit||0))-(s.business_credit_used||0)),moveAmt=Math.min(persRev,bizAvail,moveCap);s.business_credit_used=(s.business_credit_used||0)+moveAmt;/* NOT a personal available_credit increase — moving a balance onto the business line already lowers personal utilization via persRev (which subtracts business_credit_used); your personal LIMIT didn't grow. */if(!s._completed_actions.includes('business_credit_strategy'))s._completed_actions.push('business_credit_strategy');_dr.lim=lim;_dr.moveAmt=moveAmt;if(lim>0)effects.business_credit_limit=(effects.business_credit_limit||0)+lim;effects.business_credit_used=(effects.business_credit_used||0)+moveAmt;}else{/* even a declined restructure still opens a small starter line per the narrative — but it draws from the SAME realistic stacking cap/cooldown as a success, not a free uncapped grant every repeated attempt. */const s=this.state,lim=this._stackBusinessCredit(3000);if(lim>0)effects.business_credit_limit=(effects.business_credit_limit||0)+lim;}this._deferRestructure=_dr;}
...
s._toxic_closer=false;s._toxic_streak=0;s.team_size=Math.max(0,(s.team_size||0)-1);if(s.company_culture!=null)s.company_culture=Math.min(100,s.company_culture+5);/* the team exhales once he's gone */let closerOpex=this._clearRecurring('hire_highticket_closer');if(closerOpex===0){closerOpex=Math.min(s.operating_expenses||0,9000);s.operating_expenses=Math.max(0,(s.operating_expenses||0)-closerOpex);}
...
// Velocity banking is a members-only perk — it switches on the moment membership does, no separate action/turn needed (used to require completing a standalone "velocity_banking" finance action; that action is retired).
this._activateVelocity();
...
if(action.id==='equipment_financing'&&success){const s=this.state;
 const _ch=typeof s._equip_choice==='string'?[s._equip_choice]:(s._equip_choice||[]);
 const basket=_ch.map(cid=>(action.catalog||[]).find(x=>x.id===cid&&(s.monthly_revenue||0)>=(x.min_rev||0)&&!(s._equip_owned||[]).includes(x.id))).filter(Boolean);
 if(basket.length){/* the whole basket in ONE finance move: downs were charged via actionCashCost → payCost; each machine finances the rest against itself. */
  let totDeduct=0,totFin=0,totDown=0;const names=[];
  for(const it of basket){
   const down=Math.round(it.price*0.10),financed=it.price-down;totDown+=down;totFin+=financed;names.push(it.icon+' '+it.label);
   s.total_debt=(s.total_debt||0)+financed;this._addLoan('equipment',financed);
   if(it.cap)s.revenue_capacity=(s.revenue_capacity||0)+it.cap;
   // _equip_income is a shadow ledger (mirrors real estate's _asset_income) purely for the operator-capacity
   // math below — it does NOT change what actually lands in other_monthly_revenue, just tracks how much of
   // it is attributable to staffed equipment so overextension/haircut/key-man math has a real number to read.
   if(it.income){s.other_monthly_revenue=(s.other_monthly_revenue||0)+it.income;s._equip_income=(s._equip_income||0)+it.income;
    if(s._keyman_active){s._keyman_units=(s._keyman_units||0)+1;this._keymanReconcile();}}
   if(it.opex)s.operating_expenses=Math.max(0,(s.operating_expenses||0)+it.opex);
   if(it.brand)s.brand_equity=Math.min(100,(s.brand_equity||0)+it.brand);
   if(it.sys)s.systems_maturity=Math.min(100,(s.systems_maturity||0)+it.sys);
   if(it.exp)s.lifestyle_experiences=Math.min(100,(s.lifestyle_experiences||0)+it.exp);
   ...
   (s._equip_owned=s._equip_owned||[]).push(it.id);
   totDeduct+=Math.round(it.price*(it.taxmult!=null?it.taxmult:1));s._equip_units=(s._equip_units||0)+1;}
  s._equip_choice=[];
  // Section 179 the REAL way: the write-off reduces this year's TAXABLE INCOME (absorbed against profit as it accrues — it can't create a loss), and the saving shows up as a smaller bill at tax season.
  const estSave=Math.round(totDeduct*(s.tax_rate||0.25));
  s._sec179_carry=(s._sec179_carry||0)+totDeduct;
  ...
  s._dyn_narrative=names.join(', ')+' financed and in service — '+this.fmtMoney(totDown)+' down, the bank funded the other '+this.fmtMoney(totFin)+'. Sec. 179 writes off '+this.fmtMoney(totDeduct)+' of this year\'s taxable income — worth ~'+this.fmtMoney(estSave)+' at tax season.'+(basket.some(x=>x.luxury)?' The flex is real — and so is the audit flag. Keep the logs clean.':'')+(basket.length>1?' '+basket.length+' machines, one move — that\'s what leverage on your TIME looks like.':'');
...
if(action.id==='retirement_plan'&&success){const s=this.state;s._retirement_active=true;s._retirement_balance=s._retirement_balance||0;s._dyn_narrative='Your Solo 401(k) is open. Each month a slice of profit sweeps in pre-tax — the deduction covers part of the cost, so sheltering a dollar costs you only about 75¢ of cash — and the full amount compounds tax-deferred into a nest egg you own. It\'s a deferral: you\'ll pay tax when you draw it in retirement (or choose Roth to pay now and withdraw tax-free).';}
// HIRE YOUR KIDS — put family on payroll for real work: flips on the monthly income-shifting tax benefit in monthlyTick, plus a small one-time family + legacy lift.
if(action.id==='hire_your_kids'&&success){const s=this.state;s._family_payroll=true;s.lifestyle_relationships=(s.lifestyle_relationships||0)+4;s.lifestyle_legacy=(s.lifestyle_legacy||0)+3;s._dyn_narrative='Your kids are on the payroll doing legitimate work at a fair wage. Each month the business deducts their wages while they owe ~$0 (it sits under their standard deduction), so income shifts out of your high bracket at almost no tax cost — and the savings stay in the family. Keep it real and documented: the work and the pay have to be genuine, or it won\'t survive an audit.';}
...
if(action.id==='hire_star_operator'&&success){const s=this.state;s._star_stage='active';s._star_month=this.month;s._star_streak=0;s.team_size=(s.team_size||0)+1;s.systems_maturity=Math.min(100,(s.systems_maturity||0)+12);s.revenue_capacity=(s.revenue_capacity||0)+8000;s.churn_rate=Math.max(0,(s.churn_rate||0)-0.02);s.key_person_dependency=Math.min(100,(s.key_person_dependency||0)+5);}
...
if(action.id==='buy_real_estate'){const s=this.state,fmt=v=>this.fmtMoney(Math.round(v));
// The deal panel, card preview and this handler all read the same seeded monthly roll — what you saw is what you buy. Terms (down payment %) come from the deal panel; the ECONOMY sets the entry price (downturn = discount, boom = overpay).
const r=this.dealRoll('buy_real_estate'),t=this._dealTerm('buy_real_estate'),down=Math.max(0.2,Math.min(0.5,(t.downPct||20)/100));
const fairValue=r.fairValue,price=r.price;
const mort=Math.round(price*(1-down));/* the player chose the leverage — less down = more leverage, thinner cushion */
...
// Cash flow is modest and NOT the point — but it scales with the roll's yield quality AND the down payment (smaller mortgage = more of the rent is yours). A rough close (failure) means thinner margins, not a lost deal.
const noi=Math.max(0,Math.round((success?r.noi:r.noi*0.62)+price*(down-0.2)*0.0065));
s.other_monthly_revenue=(s.other_monthly_revenue||0)+noi;
s._asset_units=(s._asset_units||0)+1;s._asset_income=(s._asset_income||0)+noi;
// Key-Man Leverage: if a policy is active, the new operator is auto-covered (premium scales) so you can't silently fall out of cover by expanding the portfolio.
if(s._keyman_active){s._keyman_units=(s._keyman_units||0)+1;this._keymanReconcile();}
...
s._dyn_narrative=success?('You closed on the '+r.tier+' — worth '+fmt(fairValue)+', bought for '+fmt(price)+(r.disc<0.95?' (a soft market handed you a discount, so you start with extra equity)':'')+' with '+Math.round(down*100)+'% down. It nets '+fmt(noi)+'/mo, and that\'s fine: the real win is the <strong>'+fmt(reDepr)+'/mo depreciation write-off</strong> sheltering your income, plus tenants paying down your loan and the property appreciating.'):('The '+r.tier+' closed on tougher terms — thinner cash flow ('+fmt(noi)+'/mo) — but you still locked in the depreciation tax shield and a foothold in the market.');}
if(action.id==='buy_str'){const s=this.state,fmt=v=>this.fmtMoney(Math.round(v));
// Same seeded monthly roll + player terms as buy_real_estate — the panel's projection IS the purchase.
const r=this.dealRoll('buy_str'),t=this._dealTerm('buy_str'),down=Math.max(0.2,Math.min(0.5,(t.downPct||20)/100));
const fairValue=r.fairValue,price=r.price,mort=Math.round(price*(1-down)),equity=fairValue-mort;
this._addLoan('mortgage',mort);s.total_debt+=mort;s.real_estate_equity=(s.real_estate_equity||0)+equity;
// STR: ~2× a long-term rental's cash flow, but a hospitality operation (leans on your time) exposed to local regulation (see str_regulation_crackdown event)
const noi=Math.max(0,Math.round((success?r.noi:r.noi*0.62)+price*(down-0.2)*0.0065));s.other_monthly_revenue=(s.other_monthly_revenue||0)+noi;
s._asset_units=(s._asset_units||0)+1;s._asset_income=(s._asset_income||0)+noi;s._str_units=(s._str_units||0)+1;
if(s._keyman_active){s._keyman_units=(s._keyman_units||0)+1;this._keymanReconcile();}
// STR tax loophole: material participation + cost-seg/bonus depreciation front-loads a bigger write-off that can shield ACTIVE income, not just passive rents
const strDepr=Math.round(price*0.8/27.5/12*2.4);s._re_depreciation=(s._re_depreciation||0)+strDepr;
s.key_person_dependency=Math.min(100,(s.key_person_dependency||0)+8);/* it's a hands-on operation — costs you Freedom */
s._dyn_narrative=success?('You closed on the '+r.tier+' — worth '+fmt(fairValue)+', bought for '+fmt(price)+(r.disc<0.95?' (a soft market handed you a discount)':'')+' with '+Math.round(down*100)+'% down — and furnished it. It throws off '+fmt(noi)+'/mo — roughly double a long-term rental — and because you materially participate, the accelerated cost-seg + bonus depreciation ('+fmt(strDepr)+'/mo) can offset your ACTIVE income, a shield a normal rental can\'t give. The trade-off: it\'s a hospitality business that leans on your time, and it lives or dies by the local STR rules.'):('The deal closed on tougher terms — thinner first-season margins — but the Airbnb is yours, throwing off '+fmt(noi)+'/mo with the depreciation shield intact. Mind the local ordinances.');}
if(action.id==='cash_out_refi'){const s=this.state,fmt=v=>this.fmtMoney(Math.round(v));const eq=s.real_estate_equity||0,debt=s.real_estate_debt||0,value=eq+debt;
// Target LTV comes from the deal panel (50–75%): the player chooses how much cushion to keep. 75 is the DSCR ceiling, not the default.
const _t=this._dealTerm('cash_out_refi'),targetLTV=Math.max(0.5,Math.min(0.75,(_t.ltvPct||70)/100));
if(value>0){const maxDebt=Math.round(value*targetLTV),headroom=Math.max(0,maxDebt-debt),cashOut=Math.max(0,success?headroom:Math.round(headroom*0.55));
 if(cashOut>=1000){this._addLoan('mortgage',cashOut);s.total_debt+=cashOut;s.real_estate_equity=Math.max(0,eq-cashOut);s.cash=(s.cash||0)+cashOut;/* business cash — same rule as every other deal-panel action, see private_banking/buy_real_estate/buy_str/equipment_financing */const newLTV=Math.round((debt+cashOut)/value*100);
  s._dyn_narrative='Cash-out refinance closed. You pulled '+fmt(cashOut)+' of equity out as a new loan — tax-free, because it\'s borrowed money, not a sale (no capital gains). That\'s the BRRRR engine: recycle your capital into the next deal instead of leaving it trapped in the walls. Your loan-to-value is now ~'+newLTV+'% — a bigger mortgage and less cushion, which is exactly what bites in a downturn. Deploy the cash into something that cash-flows, and keep a reserve.';
 }else{s._dyn_narrative='Your property is already financed at or above your '+Math.round(targetLTV*100)+'% target LTV, so there\'s little equity left to pull this round. Let it appreciate or pay down debt — or raise the target in the deal panel if you want to lean harder (75% is the ceiling).';}
}else{s._dyn_narrative='You don\'t own a property to refinance yet — buy a rental or short-term rental first, then you can recycle its equity.';}}
...
if(action.id==='private_banking'&&success){const s=this.state,fmt=v=>this.fmtMoney(Math.round(v));const pledge=Math.round((s.cash||0)*0.85);/* business cash — same rule as every other deal-panel action, see cash_out_refi/buy_real_estate/buy_str/equipment_financing */if(pledge>=10000){s.cash-=pledge;s.private_bank_balance=(s.private_bank_balance||0)+pledge;
// Draw % comes from the deal panel (20–70%): the player chose how hard to lean on the line. ≤55% is margin-call-proof even in a deep crash; the monthlyTick squeeze tests exactly this.
const _t=this._dealTerm('private_banking'),drawF=Math.max(0.2,Math.min(0.7,(_t.drawPct||50)/100));
const draw=Math.round(pledge*drawF);s.cash+=draw;s.private_bank_loan=(s.private_bank_loan||0)+draw;const moEarn=Math.round(pledge*0.004),moCost=Math.round(draw*0.0054);s._dyn_narrative='Pledged Asset Line open. You moved '+fmt(pledge)+' into a pledged portfolio that stays invested and keeps compounding (~'+fmt(moEarn)+'/mo), and drew <strong>'+Math.round(drawF*100)+'% of it — '+fmt(draw)+'</strong> — at about SOFR + 2% (~'+fmt(moCost)+'/mo interest). '+(drawF<=0.55?'A conservative draw: even a deep crash can\'t margin-call this line. ':'An aggressive draw: a market drop can push the line past its limit and force a margin call — you chose the leverage, you own the risk. ')+'The point is the cheap dry powder now in your account while your assets keep working — deploy it into something that cash-flows.';}else{s._dyn_narrative='Your Pledged Asset Line is approved, but there\'s little to pledge right now. Build up an investment or cash portfolio and the line scales with it.';}}
...
if(action.id==='key_man_policy'&&success){const s=this.state;s._keyman_active=true;s._keyman_units=(s._asset_units||0)+this._equipIncomeUnitsCount();this._keymanReconcile();const targetPrem=s._keyman_premium||0;s._dyn_narrative='Loan-protection policies are in force on the operators running your income assets — <strong>'+(s._keyman_units||0)+' operator'+((s._keyman_units===1)?'':'s')+' covered</strong>, ~'+this.fmtMoney(targetPrem)+'/mo in premiums. Coverage tracks your portfolio — buy another property or finance another staffed piece of equipment and the new operator is covered too. If one is lost, the policy retires that asset\'s specific financing so the leverage can\'t bury you. A backstop, not a windfall.';}
...
this._monthExecBonuses=_execBonuses;/* rendered as rows in the expense breakdown (next to Manager pay), not their own result cards */
...
// Toxic high-ticket closer: while he's on the team his fake promises and guarantees keep doing damage — rising churn, brand erosion, climbing lawsuit risk, AND he gaslights and demoralizes the team (culture craters, key-person risk rises). The pressure builds until you fire him (via Restructure & Downsize).
if(s._toxic_closer){s.churn_rate=Math.min(0.5,(s.churn_rate||0)+0.03);s.brand_equity=Math.max(0,(s.brand_equity||0)-3);s.litigation_exposure=(s.litigation_exposure||0)+6;if(s.company_culture==null)s.company_culture=45;s.company_culture=Math.max(0,s.company_culture-6);s.key_person_dependency=Math.min(100,(s.key_person_dependency||0)+3);s._toxic_streak=(s._toxic_streak||0)+1;if(s._toxic_streak%2===1)s._pendingRipples=(s._pendingRipples||[]).concat([{source:'Your high-ticket closer',narrative:'He\'s gaslighting the whole team — taking credit, shifting blame, undermining anyone who questions his fake guarantees. Your best people are quietly checking out, culture is sinking, and refunds/complaints from his over-promises keep coming. He drives revenue and poisons everything around it. The longer he stays, the deeper the damage.'}]);}
// SUPERSTAR OPERATOR — a talented ops hire who came for the opportunity, not the mission. While 'active' he does his job well but won't go beyond scope: no systems growth from him, and he escalates problems to you instead of solving them (a quiet energy drain). A mid-arc decision is forced (see _dueArcEvent); the arc ends in resignation unless you win him over or let him go cleanly.
if(s._star_stage==='active'){s.energy=Math.max(-40,(s.energy||0)-2);s._star_streak=(s._star_streak||0)+1;if(s._star_streak%2===0)s._pendingRipples=(s._pendingRipples||[]).concat([{source:'Your star operator',narrative:'He\'s genuinely good — at exactly what\'s in his job description, and not an inch past it. He flags every problem in crisp detail, then waits for YOU to solve it. He never caught the vision; this is just a stop on the way to somewhere else. Talent without buy-in is a clock quietly running down.'}]);}
else if(s._star_stage==='leaving'){const sysHit=Math.min(s.systems_maturity||0,10);s.systems_maturity=Math.max(0,(s.systems_maturity||0)-sysHit);s.team_size=Math.max(0,(s.team_size||0)-1);s.key_person_dependency=Math.min(100,(s.key_person_dependency||0)+10);s.churn_rate=Math.min(0.5,(s.churn_rate||0)+0.01);s.cash=(s.cash||0)-5000;this._clearRecurring('hire_star_operator');s._star_stage=null;s._star_streak=0;s._pendingRipples=(s._pendingRipples||[]).concat([{source:'Your star operator resigned',narrative:'He gave two weeks\' notice — "startups just aren\'t for me." He was never going to ride out the hard part; he came for a line on his résumé. His work walks out with him: systems take a hit, the knowledge gap lands back on you, and you\'re hiring again. The lesson the hard way — hire people who see the vision, not just the ones who look great on paper.'}]);}
// CAPTIVE INSURANCE — the deductible-premium → tax-advantaged-reserve loop. The business pays a premium (deductible, so only the after-tax portion is a real cash cost), and the FULL premium accumulates in your captive reserve, which compounds nearly tax-free (~5%/yr) under §831(b). Net: money that would have gone to the IRS becomes a protected, compounding asset you own. Carries a little audit risk (the IRS scrutinizes captives).
if(s._captive_active){const premium=Math.min(Math.round((s.monthly_revenue||0)*0.06),25000);if(premium>0){const net=Math.round(premium*(1-(s.tax_rate||0.25)));s.cash=(s.cash||0)-net;s._captive_reserve=(s._captive_reserve||0)+premium;}if((s._captive_reserve||0)>0)s._captive_reserve=Math.round((s._captive_reserve||0)*1.004);s.litigation_exposure=Math.max(0,(s.litigation_exposure||0)-1);if(this.month%6===0)s.audit_risk=Math.min(100,(s.audit_risk||0)+2);}
// RETIREMENT PLAN — the pre-tax sweep. Player-chosen rate (openRetirementControl's slider, stored in
// _dealTerms.retirement_plan.pct, default 8%) of revenue goes in PRE-TAX, capped by the real IRS limits:
// ~$1,958/mo ($23,500/yr personal elective-deferral) alone, or ~$5,833/mo ($70,000/yr combined
// employee+employer) once the rate is high enough to draw on the employer/profit-sharing side too. The
// deduction means only the after-tax portion (contribution×(1−tax_rate)) actually leaves cash, while the
// FULL contribution lands in _retirement_balance and compounds tax-deferred (~6%/yr).
if(s._retirement_active){const EMP_DEFERRAL_MO=1958,COMBINED_CAP_MO=5833;const pct=(((s._dealTerms&&s._dealTerms.retirement_plan&&s._dealTerms.retirement_plan.pct)||8))/100;const raw=Math.round((s.monthly_revenue||0)*pct);const cap=raw>EMP_DEFERRAL_MO?COMBINED_CAP_MO:EMP_DEFERRAL_MO;const contribution=Math.min(raw,cap);if(contribution>0){const cashCost=Math.round(contribution*(1-(s.tax_rate||0.25)));s.cash=(s.cash||0)-cashCost;s._retirement_balance=(s._retirement_balance||0)+contribution;}if((s._retirement_balance||0)>0)s._retirement_balance=Math.round((s._retirement_balance||0)*1.005);}
// HIRE YOUR KIDS — the income-shifting benefit. A modest deductible wage (≈2% of revenue, capped ~$1,200/mo) is paid to family for real work; the business deducts it and the child owes ~$0 under their standard deduction, so the household simply keeps the tax that wage would have cost in your bracket (~wage×tax_rate). Deliberately modest — a smart efficiency, not a windfall. (Wage flows pocket-to-pocket inside the household, so only the tax saved is a net gain.)
if(s._family_payroll){const wage=Math.min(Math.round((s.monthly_revenue||0)*0.02),1200);if(wage>0){const taxSaved=Math.round(wage*(s.tax_rate||0.25));s.cash=(s.cash||0)+taxSaved;s._kids_tax_saved=(s._kids_tax_saved||0)+taxSaved;}}
...
{const sizeChurn=Math.max(0,((s.customer_base||0)-30)/30*0.01)*Math.max(0.3,1-(s.systems_maturity||0)/100);const effChurn=Math.min(0.4,(s.churn_rate||0)+sizeChurn);s.customer_base=Math.max(0,s.customer_base-Math.floor(s.customer_base*effChurn));}
...
// SOFT ADDRESSABLE MARKET (rising CAC / saturation) — a lean business can only win & keep so many customers before each new one costs more to acquire and retain. Conversion falls toward zero as your base approaches this reach, so customer count finds a NATURAL equilibrium instead of climbing forever. Reach widens with brand (demand), systems (delivery + retention capacity) and a lean team, and expands via offer/market plays. THIS is what makes the business plateau lean — no artificial wall; to grow you must genuinely widen the market, at diminishing returns. (DESIGN.md: brute-force revenue hits a ceiling; FINANCE builds the wealth.)
const reach=this.mktReach(s);
s._mktReach=Math.round(reach);
const satFactor=Math.max(0,1-(s.customer_base||0)/reach); // 1 when the market is wide open, →0 as you saturate it (rising CAC)
...
const convRate=Math.min(0.5,baseConv+skillConv+brandConv+salesConv)*satFactor;const pool=Math.max(0,(s.leads||0)-(s.customer_base||0));const converted=Math.floor(pool*convRate);
s.customer_base=(s.customer_base||0)+converted; // converting a lead doesn't delete the contact — leads stay
// OVER-CAPACITY RETENTION — you can ACQUIRE more clients than you can serve (a big launch, aggressive sales, a viral month, action effects that add customers directly), but you can't KEEP them: service slips past your delivery reach and the overflow churns back to what you can actually deliver well. Capacity — not just demand — is the real constraint, which is why a lean business can't simply buy its way past the ceiling. (Closes the funnel-bypass: the saturation above only throttles NEW conversions; this governs the total book however it grew.)
if((s.customer_base||0)>reach){const overflow=(s.customer_base||0)-reach;s.customer_base=Math.round(reach+overflow*0.45);s._overserved=Math.round(overflow);}else s._overserved=0;
...
// NO HARD WALL — the lean plateau is now EMERGENT (DESIGN.md; Gerber's E-Myth, Greiner's coordination crisis, Tatum's "No Man's Land"). Revenue = customers × value, and customer growth self-limits at your addressable-market reach (rising CAC, above), a residual size-churn floor means a bigger base always leaks, and over-hiring triggers management-debt drag below. A lean op tops out ~$80-120k/mo and a fully-systematized one ~$180-220k — not because a clamp says so, but because the market saturates and the bucket leaks. To push higher you must genuinely widen the market (brand, offer, systems) at diminishing returns; the real way forward is FINANCE leveraging the cash & credit this business throws off.
...
{const cap=this._orgCapacity(),team=s.team_size||0,over=Math.max(0,team-cap);s._orgCap=Math.round(cap);s._orgOver=Math.round(over*10)/10;
 ...
 // OPERATOR CAPACITY — real estate doors + staffed equipment each need someone actually running them. Raw
 // count + overextension recomputed fresh every tick (single source of truth, no per-purchase syncing to
 // drift out of date). _operator_assets is what key_operator_loss's probability_scales_with reads — an
 // uncovered asset weighs 2x an operator-covered one, since it's carrying real risk with no one minding it.
 {const raw=this._operatorRawAssets(),over=this._operatorOverextension();s._operatorOver=Math.round(over*10)/10;
  s._operator_assets=raw+over;
  // Neglect haircut: assets beyond capacity underperform (unmanaged property/route), same delta-tracking
  // pattern as calcExecComp above — recompute the INTENDED haircut fresh, adjust other_monthly_revenue by
  // only the change since last month, so this never permanently destroys the underlying _asset_income/
  // _equip_income figures other code (sale payouts, key-man claims) still reads as the real numbers.
  const totalIncome=(s._asset_income||0)+(s._equip_income||0);
  const target=raw>0&&over>0?-Math.round(totalIncome*(over/raw)*0.35):0;
  const delta=target-(s._operator_haircut_applied||0);
  if(delta){s.other_monthly_revenue=Math.max(0,(s.other_monthly_revenue||0)+delta);s._operator_haircut_applied=target;}}
 // HIGH-LTV SURCHARGE (real PMI) — once your real-estate portfolio's aggregate LTV crosses 80%, a real
 // lender charges private mortgage insurance (~0.5-1.5%/yr of the loan, modeled at 0.8%) until you pay it
 // down or values recover — so over-leveraging costs you something every month from day one, not just on
 // the rare downturn dice roll. Same delta-tracking pattern as the operator haircut above.
 {const reVal=(s.real_estate_equity||0)+(s.real_estate_debt||0),reLTV=reVal>0?(s.real_estate_debt||0)/reVal:0;
  const target=reLTV>0.8?-Math.round((s.real_estate_debt||0)*0.008/12):0;
  const delta=target-(s._re_pmi_applied||0);
  if(delta){s.other_monthly_revenue=Math.max(0,(s.other_monthly_revenue||0)+delta);
   if(target<0&&(s._re_pmi_applied||0)===0)s._pendingRipples=(s._pendingRipples||[]).concat([{source:'Real Estate — High-LTV Surcharge',narrative:'Your portfolio\'s loan-to-value crossed 80% — real lenders charge PMI once you\'re this leveraged. A monthly surcharge (~'+this.fmtMoney(-target)+') is now cutting into your rental income until you pay debt down or values recover. This is real PMI: it cancels automatically once you\'re back under ~80% LTV.'}]);
   s._re_pmi_applied=target;}}
...
if(s._credit_tight&&(s.real_estate_debt||0)>0&&(s._asset_units||0)>0&&!s._re_squeeze_cycle){s._re_squeeze_cycle=true;
 ...
 if(ltv>0.90&&reDSCR<1.1&&reserves<reSvc*6){
  // MARGIN CALL — underwater, the property can't carry itself, and there's no cushion or refinance. Real
  // lenders don't treat a portfolio as one blended average: if it was ALL bought thin, a uniform price drop
  // pushes EVERY unit underwater at once, not just a token one. Scale how many get force-sold by how far
  // over the danger line the portfolio is AND how deep the downturn ran — a portfolio bought at the (now)
  // 20% floor barely over the line still loses just one; a portfolio spammed at max leverage in a severe
  // downturn can lose most of it. Never sell more than you own, and always at least one (the trigger fired).
  const sellFrac=Math.max(1/units,Math.min(1,(ltv-0.90)*2.5+(depth-0.8)*0.6)),unitsToSell=Math.max(1,Math.min(units,Math.round(units*sellFrac)));
  const perDebt=Math.round(debt/units)*unitsToSell,perEq=Math.round(eq/units)*unitsToSell,perInc=Math.round((s._asset_income||0)/units)*unitsToSell;
  ...
  s.real_estate_equity=Math.max(0,eq-perEq);s._asset_units=Math.max(0,units-unitsToSell);
  if(s._keyman_active&&(s._keyman_units||0)>0){s._keyman_units=Math.max(0,(s._keyman_units||0)-unitsToSell);this._keymanReconcile();}/* sold units no longer need coverage — stop paying their premium */
  ...
  s.personal_credit_score=Math.max(300,(s.personal_credit_score||0)-25);/* a forced sale / loan workout craters your credit — same hit whether it's one property or several */
  s._re_margin_called=(s._re_margin_called||0)+1;
  s._pendingRipples=(s._pendingRipples||[]).concat([{source:'Real Estate — MARGIN CALL',narrative:'The crash caught you over-leveraged. Property values fell ~'+Math.round(haircut*100)+'%, your loan-to-value blew past 90% (underwater), the rents no longer cover the mortgage, and with credit frozen you can\'t refinance. The lender forced a sale of <strong>'+unitsToSell+' of your '+units+' propert'+(units===1?'y':'ies')+'</strong> — and selling into the bottom, the '+this.fmtMoney(proceeds)+' didn\'t even clear the '+this.fmtMoney(perDebt)+' owed on '+(unitsToSell>1?'them':'it')+'. You ate '+this.fmtMoney(deficiency+sellCost)+' in deficiency and costs, lost '+this.fmtMoney(perInc)+'/mo of income, and your credit took a 25-point hit. THIS is over-leverage: the more of your portfolio you bought thin, the more of it went down together. More equity down, property that covers its own debt, and reserves are what carry you through.'}]);
 } else {
...
// PLEDGED ASSET LINE — the SBLOC margin-call test. Same discipline as real estate: if the market falls while your line is stretched, the bank forces you to pay it down — selling pledged assets into the dip. Conservative draws ride it out.
if(s._credit_tight&&(s.private_bank_loan||0)>0&&(s.private_bank_balance||0)>0&&!s._pal_squeeze_cycle){s._pal_squeeze_cycle=true;
 const depth=s._downturn_depth||1,drop=Math.min(0.35,0.14*depth+0.05),marked=Math.round(s.private_bank_balance*(1-drop)),ltv=marked>0?s.private_bank_loan/marked:2;
 if(ltv>0.85){const target=Math.round(marked*0.7),paydown=Math.max(0,s.private_bank_loan-target),fromPledge=Math.min(s.private_bank_balance,paydown);
  s.private_bank_balance-=fromPledge;s.private_bank_loan-=fromPledge;const short=paydown-fromPledge;
  if(short>0){s.cash=(s.cash||0)-short;/* business cash — the line was funded from business cash, so the margin call draws from the same pocket */s.private_bank_loan=Math.max(0,s.private_bank_loan-short);if(s.cash<0){const unc=this.coverShortfall(-s.cash);s.cash=unc>0?-unc:0;}}
  s._pal_margin_called=(s._pal_margin_called||0)+1;s.personal_credit_score=Math.max(300,(s.personal_credit_score||0)-12);
  s._pendingRipples=(s._pendingRipples||[]).concat([{source:'Pledged Asset Line — MARGIN CALL',narrative:'The market dropped ~'+Math.round(drop*100)+'% and your pledged portfolio fell with it — pushing your line past its limit. The bank issued a margin call and force-sold '+this.fmtMoney(fromPledge)+' of your holdings into the dip to pay it down'+(short>0?', and still needed '+this.fmtMoney(short)+' from your cash':'')+'. This is the SBLOC\'s teeth: borrow against assets that can fall, stretch the line, and a downturn forces you to sell low. Keep the draw well under the limit and hold a cushion.'}]);
 } else {s._pendingRipples=(s._pendingRipples||[]).concat([{source:'Pledged Asset Line',narrative:'Your pledged portfolio dipped ~'+Math.round(drop*100)+'% in the downturn, but your line was drawn conservatively — so no margin call. You hold your positions and they recover with the market. This is why you never draw an SBLOC to the max.'}]);}
}
if(!s._credit_tight)s._pal_squeeze_cycle=false;
...
{const idx=(s._index_return!=null)?s._index_return:0.0058,variable=s._iul_loan_type==='variable',washRate=0.03/12/* Wash loan = NET 0%: loan charged 3% (below) while the borrowed slice is credited 3% (not the index) — they cancel exactly */,varRate=0.05/12/* Index loan: 5% guaranteed charge (per John Hancock Accumulation IUL fixed index loan) — the borrowed slice keeps earning the index; the spread is the play, the lapse risk is the price */;
...
if((s.private_bank_balance||0)>0||(s.private_bank_loan||0)>0){s.cash=(s.cash||0)+this._pbCarry(s);} // pledged portfolio yields (~5%/yr) NET of the SBLOC borrow cost (~6.5%/yr) — roughly carry-neutral. Business cash — the line was funded from business cash (see private_banking's handler), so its ongoing carry lands there too.
...
// Folding the reserve into the policy used to be a recurring popup (re-checked every month with a
// 3-month cooldown) — owner feedback 2026-07-04: "every month it's asking to fold taxes into the
// policy... dont want the pop up every month." Removed the proactive popup entirely; folding now lives
// as an on-demand control inside the policy panel (openPolicyControl → polStageFold/polConfirm), so it's
// available whenever there's a reserve to fold but never interrupts a turn.
...
if(s._completed_actions&&s._completed_actions.includes('hire_fractional_cfo')){if(s.business_credit_profile==='building')s.business_credit_profile='established';s.personal_credit_score=Math.min(850,s.personal_credit_score+1);/* the CFO's real lending edge is already the 1.15x multiplier baked into calcCreditCapacity() (used by every stacking action) — no separate free monthly credit-limit growth on top of that; real lenders don't hand out new limits every month with no application. */const pr=Math.max(0,(s.total_debt||0)-(s._installment_debt||0)-(s.business_credit_used||0)-(s.business_installment_debt||0)-(s.real_estate_debt||0));if(pr>1000){const as=Math.round(pr*0.05);s._installment_debt=(s._installment_debt||0)+as;/* converting a card balance to a fixed installment loan lowers utilization via persRev shrinking — it doesn't raise your personal credit LIMIT, so available_credit must not move here. */}}
...
// Scripted character-arc decisions (superstar operator, toxic closer) preempt the random event when they come due — deterministic timing, resolved on the event screen via resolveEvent's id handlers.
_dueArcEvent(){const s=this.state;
 if(s._star_stage==='active'&&(this.month-(s._star_month||this.month))>=3){s._star_stage='choice';return {id:'star_operator_choice',category:'people',_arc:true,narrative:'Your star operator just waved off a stretch project — "not in my lane" — and it clicks: he\'s mentally halfway out the door. He\'s sharp and his lane is clean, but he\'s never owned a problem or bought into where this is going. You can feel the resignation coming. How do you play it?',choices:[{label:'Take him to dinner and sell him the vision',effects:{},outcome_narrative:''},{label:'Let him go now, on good terms',effects:{},outcome_narrative:''},{label:'Keep him as-is — the work\'s getting done',effects:{},outcome_narrative:''}]};}
 if(s._toxic_closer&&(s._toxic_streak||0)>=3){return {id:'toxic_closer_choice',category:'people',_arc:true,narrative:'It boils over: two of your best people corner you privately — they\'ll walk if the closer stays. He\'s gaslit the team, taken the credit, and his fake guarantees are spawning refund demands and a whiff of legal trouble. The revenue he brings is real. So is the wreckage. What do you do?',choices:[{label:'Confront him and demand he change',effects:{},outcome_narrative:''},{label:'Fire him now (he\'ll threaten to sue)',effects:{},outcome_narrative:''},{label:'Keep him — the revenue\'s too good to lose',effects:{},outcome_narrative:''}]};}
 return null;},
...
// Scripted character arcs come due first — a forced decision preempts the random roll this month.
{const arc=this._dueArcEvent();if(arc)return arc;}
// Guaranteed Part-1 seasonal beat (spec §5): the silent Q4 dip becomes a DECISION, once, in the m10–12 window — turning the quiet mid-game stretch into agency + drama (and managed downside even a skilled operator has to answer). Revenue dips no matter what; the choice is how you respond.
if(this.month>=10&&this.month<=12&&!cs._q4_event_seen){cs._q4_event_seen=true;return {id:'q4_seasonal',category:'macro',_arc:true,narrative:'Q4 hits and the seasonal slowdown sets in — buyers go quiet and sales soften across your whole market for the quarter. Every business feels it. Revenue dips no matter what; the question is how you respond.',choices:[{label:'Weather it — ride out the slow quarter',effects:{energy:-6},outcome_narrative:'You held steady and rode the slowdown out. Revenue dipped for the quarter, but you spent nothing chasing it and kept your powder dry for the rebound.'},{label:'Run a holiday discount push',effects:{},outcome_narrative:''},{label:'Cut costs to protect cash',effects:{},outcome_narrative:''}]};}
...
// Result-card description toggle — top-right of the card, matching the action-card pattern (owner,
// 2026-07-04): impacted stats + before/after changes always show; only the narrative/lesson prose
// collapses. Expanded by default, same as action cards.
toggleResultDesc(id,el){const d=document.getElementById(id);if(!d)return;const open=d.style.display!=='none';d.style.display=open?'none':'block';if(el)el.textContent=open?'▸ Expand description':'▾ Hide description';},
...
let html='';
if(this._reveal('achievements'))html+='<div onclick="Game.showAchievements()" style="cursor:pointer;text-align:center;background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-sm);padding:7px;margin-bottom:9px;font-size:0.74rem;font-weight:600;color:var(--gold);">🏆 Achievements — '+((this.state._milestones_achieved||[]).length)+'/'+MILESTONES.length+'</div>';/* owner: all the way at the top */
if(this.state._epic_life&&!this._pendingLose)html+=this._epicMonthCard();
...
// Finance was delegated (Wealth stage / passive income active) but your team found nothing worth acting on
// this month — traps, the variable IUL loan, the pre-tax DB plan, MCA, and character-arc hires are always
// the player's own call, never auto-picked. Say so plainly instead of silently doing nothing.
{const _fas=this.state._financeAutoSkipped;if(_fas&&_fas.month===this.month){html+='<div class="fade-in" style="background:rgba(212,175,55,0.06);border:1px solid var(--gold);border-left-width:3px;border-radius:var(--radius-sm);padding:9px 12px;margin-bottom:9px;"><div style="font-size:0.86rem;font-weight:700;color:var(--gold);">💼 No Finance Move This Month</div><div style="font-size:0.74rem;color:var(--text2);margin-top:3px;line-height:1.45;">Your team reviewed this month\'s finance options and found nothing worth acting on. Some moves (high-risk financing, character-driven hires) are always your own call and never auto-picked — check the Finance tab yourself if you want to act.</div></div>';}this.state._financeAutoSkipped=null;}
...
// One compact card per action: title + badge, short narrative, tap-to-expand details (owner playtested the combined-card variant and preferred per-card expand).
...
// Impacted stats + before/after changes always show now (matching the action-card pattern); only the
// narrative/lesson prose collapses, via a top-right toggle instead of "tap anywhere on the card".
...
const descId='rdesc'+_ci,hasDesc=!!(r.narrative||_lesH);
const descBlock=hasDesc?'<div id="'+descId+'" style="display:block;">'+(r.narrative?'<div style="font-size:0.8rem;color:var(--text2);line-height:1.5;margin-top:5px;">'+r.narrative+'</div>':'')+_lesH+'</div>':'';
const toggleLink=hasDesc?'<span'+(_firstCard?' id="tut-result-detail"':'')+' onclick="Game.toggleResultDesc(\''+descId+'\',this)" style="cursor:pointer;font-size:0.6rem;color:var(--blue);font-weight:600;white-space:nowrap;flex-shrink:0;">▾ Hide description</span>':'';
html+='<div class="fade-in"'+(_firstCard?' id="tut-result-card"':'')+' style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-sm);padding:11px 13px;margin-bottom:9px;">'+
'<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;"><div style="display:flex;align-items:baseline;gap:8px;flex-wrap:wrap;min-width:0;"><strong style="font-size:0.92rem;'+(r.action._epic?'color:var(--gold);':'')+'">'+(r.action._epic?'🌟 ':'')+r.action.label+'</strong><span style="font-size:0.64rem;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:'+(r.action._epic?'var(--gold)':(r.success?'var(--accent)':'var(--gold)'))+';white-space:nowrap;">'+(r.action._epic?'⭐ Epic Life':(r.success?'Success':'Didn\'t finish'))+'</span></div>'+toggleLink+'</div>'+
descBlock+
_chipsH+_baH+
...
const accCol=accessible<=0?'var(--red)':'var(--accent)';/* out of cash + credit → highlight the number red (the run is over) */
// Survival runway: months of essential fixed costs your reserves + passive income could cover if business revenue stopped (an economic shutdown). Surfaced so "Profitable" doesn't read as invincible.
const _sr=this._survivalRunway(),_srMo=_sr.months,_srCol=(!isFinite(_srMo)||_srMo>=6)?'var(--accent)':(_srMo>=3?'var(--gold)':'var(--red)'),_srTxt=(!isFinite(_srMo))?'🛡️ Revenue-proof — passive income covers your fixed costs':('🛡️ If revenue stopped: ~'+Math.max(0,Math.floor(_srMo))+' mo');
const _srLine=((s.monthly_revenue||0)>0||!isFinite(_srMo))?'<div style="font-size:0.62rem;color:'+_srCol+';font-weight:600;margin-bottom:7px;padding-bottom:7px;border-bottom:1px solid var(--border);">'+_srTxt+' <span style="color:var(--text2);font-weight:400;">· reserves + passive with the doors closed</span></div>':'';
const capBlock='<div style="display:flex;justify-content:space-between;align-items:flex-end;gap:8px;margin-bottom:7px;"><span><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;">💰 Accessible capital</div><div id="result-accessible" style="font-size:1.15rem;font-weight:800;color:'+accCol+';white-space:nowrap;">'+fm(accessible)+(accSwing?' <span style="font-size:0.7rem;">'+accSwing+'</span>':'')+'</div><div style="font-size:0.58rem;color:var(--text2);">cash + credit</div></span><span style="text-align:right;"><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:0.5px;">Runway</div><div id="result-runway" style="font-size:1.05rem;font-weight:800;color:'+runCol+';">'+runway+(runSwing?' <span style="font-size:0.7rem;">'+runSwing+'</span>':'')+'</div><div style="font-size:0.58rem;color:var(--text2);">'+(netFlow>=0?'cash-flow positive':'at current burn')+'</div></span></div>'+_srLine;
...
const _bkHtml='<div style="margin-top:6px;background:rgba(127,127,127,0.07);border-radius:6px;padding:7px 9px;">'+
  ...
  ((this._monthExecBonuses||[]).map(b=>_iRow(b.role+' performance bonus 🎯','−'+fm(b.bonus),'var(--red)')).join(''))+
...
// Reserve→policy fold is no longer a proactive popup (see the monthlyTick comment above) — it's a button inside openPolicyControl() instead.
...
// Episodic structure: Part 1 (m1–18) ends in a themed FINALE at m18 (the payoff — your wealth machine is built), with a carry-state handoff into Part 2 (m19–36). Only TWO checkpoint screens exist now (owner, 2026-07-04: "we are doing 18/36 only") — m12 and m24 just quietly auto-save and continue, no screen, no off-ramp; m18 is the Part 1 Finale; m36 goes straight to the final score.
if(this.month===12){this.autoSave();}
if(this.month===18){this.showPart1Finale();return;}
if(this.month===24){this.autoSave();}
...
// Q4 SEASONAL (spec §5) — the dip hits regardless; the choice is the response. Weather (do nothing, −energy, handled by choice effects) / discount push (spend for customers) / cut costs (protect cash, small systems hit).
if(evt.id==='q4_seasonal'){const s=this.state;
 if(ci===1){const promo=Math.round(Math.max(2500,(s.monthly_revenue||0)*0.5));s.cash=(s.cash||0)-promo;if(s.cash<0){const u=this.coverShortfall(-s.cash);s.cash=0;if(u>0)s.cash=-u;}const add=Math.round((s.customer_base||0)*0.08)+3;s.customer_base=(s.customer_base||0)+add;s.leads=(s.leads||0)+Math.round(add*1.5);c.outcome_narrative='You ran a holiday push — '+this.fmtMoney(promo)+' into promos and ads. It pulled demand forward: '+add+' new customers in the door softened the seasonal dip, though the margin came out of your pocket. Spending to defend share — when you can afford it.';}
 else if(ci===2){const cut=Math.round(Math.min((s.operating_expenses||0)*0.15,4000));s.operating_expenses=Math.max(0,(s.operating_expenses||0)-cut);s.systems_maturity=Math.max(0,(s.systems_maturity||0)-4);c.outcome_narrative='You trimmed '+this.fmtMoney(cut)+'/mo of overhead to protect cash through the slow quarter. The runway is safer — but you cut into some of the systems and slack that keep things running smoothly.';}}
// SUPERSTAR OPERATOR — mid-arc decision (sell the vision / let go cleanly / keep and lose him later).
if(evt.id==='star_operator_choice'){const s=this.state;
 if(ci===0){const cul=s.company_culture==null?45:s.company_culture,chance=cul>=60?0.55:cul>=40?0.33:0.18;if(Math.random()<chance){s._star_stage='engaged';s._star_streak=0;s.systems_maturity=Math.min(100,(s.systems_maturity||0)+10);s.key_person_dependency=Math.max(0,(s.key_person_dependency||0)-3);c.outcome_narrative='Over dinner something clicked — he saw the bigger game and decided he wanted in. He\'s owning problems now, not just flagging them, and he started documenting the system so it doesn\'t live in his head. A strong culture gave you the opening. THIS is what buy-in looks like.';}else{s._star_stage='leaving';c.outcome_narrative='He nodded along, said the right things — but it didn\'t land. The vision was yours, never his. He\'s still leaving; you only bought time. Culture is what wins these — the stronger it is, the better your odds.';}}
 else if(ci===1){s._star_stage=null;s._star_streak=0;s.team_size=Math.max(0,(s.team_size||0)-1);s.systems_maturity=Math.max(0,(s.systems_maturity||0)-6);s.key_person_dependency=Math.min(100,(s.key_person_dependency||0)+4);s.cash=(s.cash||0)-3000;this._clearRecurring('hire_star_operator');c.outcome_narrative='You let him go on good terms before resentment set in. It stings — you lose his output and eat a small backfill cost — but you controlled the timing, kept the relationship, and stopped pouring energy into someone halfway out the door. Clean exits beat slow bleeds.';}
 else{s._star_stage='leaving';c.outcome_narrative='You keep him — the work\'s getting done and you don\'t have time to rehire. But a mercenary on a ticking clock is borrowed time. Brace for the resignation; it\'s coming.';}}
// TOXIC CLOSER — mid-arc decision (confront / fire now / keep for the revenue).
if(evt.id==='toxic_closer_choice'){const s=this.state;
 if(ci===0){s._toxic_streak=0;if(Math.random()<0.15){if(s.company_culture!=null)s.company_culture=Math.min(100,s.company_culture+3);c.outcome_narrative='You laid down the law and, to your surprise, he dialed it back — for now. Toxic people rarely change for long, but you bought the team some breathing room. Watch him; the pattern usually returns.';}else{if(s.company_culture!=null)s.company_culture=Math.max(0,s.company_culture-5);s.brand_equity=Math.max(0,(s.brand_equity||0)-3);c.outcome_narrative='He turned it around on YOU — smiled, denied everything, implied your best people are the problem. Textbook gaslighting. Nothing changed except morale dropped further. You can\'t coach character; you can only remove it.';}}
 else if(ci===1){s._toxic_closer=false;s._toxic_streak=0;s.team_size=Math.max(0,(s.team_size||0)-1);if(s.company_culture!=null)s.company_culture=Math.min(100,s.company_culture+5);s.key_person_dependency=Math.max(0,(s.key_person_dependency||0)-2);this._clearRecurring('hire_highticket_closer');const legal=12000;s.cash=(s.cash||0)-legal;if(s.cash<0){const unc=this.coverShortfall(-s.cash);s.cash=0;if(unc>0)s.cash=-unc;}s.litigation_exposure=Math.max(0,(s.litigation_exposure||0)-10);c.outcome_narrative='You fired him. He lawyered up and threatened to sue — a '+this.fmtMoney(legal)+' settlement made it disappear. The moment he was gone the team exhaled: culture began healing and the refund complaints slowed. Expensive, but the bleeding stopped. Hire for character — you can\'t fire your way out fast enough otherwise.';}
 else{s._toxic_streak=0;c.outcome_narrative='You keep him for the revenue. The numbers stay up — and so does the damage. Culture keeps eroding, lawsuit risk keeps climbing, and your best people start polishing their résumés. Every month you wait, the cleanup gets more expensive.';}}
...
if(evt.id==='key_operator_loss'){const s=this.state;const covered=(s._keyman_units||0)>0;
 const reUnits=Math.max(0,s._asset_units||0),eqUnits=this._equipIncomeUnitsCount();
 // Which asset type loses its operator this time — weighted by each pool's real share of your operator-run assets (not a coin flip that ignores what you actually own).
 const hitEquip=eqUnits>0&&(reUnits<=0||Math.random()<eqUnits/Math.max(1,reUnits+eqUnits));
 if(hitEquip){
  const eqAct=(CONFIG.actions_finance&&CONFIG.actions_finance.actions||[]).find(x=>x.id==='equipment_financing'),cat=(eqAct&&eqAct.catalog)||[];
  const owned=(s._equip_owned||[]).filter(id=>{const it=cat.find(x=>x.id===id);return it&&it.income>0;});
  const pickId=owned[Math.floor(Math.random()*owned.length)],it=cat.find(x=>x.id===pickId)||{};
  const eqLoanBal=(s.loans||[]).filter(l=>l.type==='equipment').reduce((a,l)=>a+Math.max(0,l.balance),0);
  const perDebt=Math.round(eqLoanBal/Math.max(1,eqUnits)),perInc=Math.round((s._equip_income||0)/Math.max(1,eqUnits));
  s.other_monthly_revenue=Math.max(0,(s.other_monthly_revenue||0)-perInc);s._equip_income=Math.max(0,(s._equip_income||0)-perInc);
  const idx=(s._equip_owned||[]).indexOf(pickId);if(idx>=0)s._equip_owned.splice(idx,1);
  if(covered){let claim=Math.min(perDebt,eqLoanBal),remaining=claim;
   for(const ln of (s.loans||[]).filter(l=>l.type==='equipment'&&l.balance>0.5)){if(remaining<=0)break;const chunk=Math.min(remaining,Math.round(ln.balance));if(chunk<=0)continue;this._loanPayExtra(ln,chunk);remaining-=chunk;}
   const paid=claim-remaining;s.total_debt=Math.max(0,(s.total_debt||0)-paid);s._keyman_units=Math.max(0,(s._keyman_units||0)-1);s._keyman_claims_total=(s._keyman_claims_total||0)+paid;this._keymanReconcile();
   c.outcome_narrative=paid>0
    ?'Tragic — but you had insured them. The <strong>operator loan-protection policy paid out '+this.fmtMoney(paid)+'</strong> against '+(it.label||'the equipment')+'\'s financing. You have lost its '+this.fmtMoney(perInc)+'/mo income while you place a new operator, but the debt is gone — the loss is contained, not catastrophic.'
    :'Tragic — but '+(it.label||'that equipment')+' was already <strong>financed free and clear</strong>, so there was no balance for the loan-protection policy to retire. You have lost its '+this.fmtMoney(perInc)+'/mo income while you place a new operator, but with no debt weighing on it, the loss is contained.';}
  else{const hit=Math.max(0,Math.round(perInc*2));if(hit>0){s.cash=(s.cash||0)-hit;if(s.cash<0){const u=this.coverShortfall(-s.cash);s.cash=0;if(u>0)s.cash=-u;}}c.outcome_narrative='You had no loan-protection coverage on that operator. '+(it.label||'That equipment')+' still owes <strong>'+this.fmtMoney(perDebt)+'</strong> on its financing, but the '+this.fmtMoney(perInc)+'/mo income that serviced it just stopped — and you are out '+this.fmtMoney(hit)+' scrambling to cover the gap and re-staff. This is the danger of leveraging on people you have not insured.';}
 }else{
  const units=Math.max(1,reUnits);const perDebt=Math.round((s.real_estate_debt||0)/units),perInc=Math.round((s._asset_income||0)/units);
...
if(taxOwed<=0){choices.push('<div class="choice-card fade-in" onclick="Game.resolveTax(\'cash\',0)"><h4>Nothing owed — a loss year</h4><div class="choice-effects">Your deductions and write-offs wiped out taxable income. File and move on.</div></div>');}
else{
 const canCover=(pb+res+cashAvail)>=taxOwed;
 if(canCover){
  let rem=taxOwed,uP=Math.min(rem,pb);rem-=uP;let uR=Math.min(rem,res);rem-=uR;let uC=Math.min(rem,cashAvail);rem-=uC;
  const seg=[];if(uP>0)seg.push('🛡️ '+this.fmt(uP)+' policy loan (tax-free)');if(uR>0)seg.push(this.fmt(uR)+' reserve');if(uC>0)seg.push(this.fmt(uC)+(sep?' personal cash':' cash'));
  const single=((uP>0?1:0)+(uR>0?1:0)+(uC>0?1:0))===1;
  const head=single?(uP>0?'🛡️ Borrow against your policy (tax-free)':uR>0?'Pay from your tax reserve':'Pay in full from '+(sep?'personal cash':'cash')):'✅ Pay in full — the smart order';
  choices.push('<div class="choice-card fade-in" onclick="Game.resolveTax(\'smart\','+taxOwed+')"><h4>'+head+'</h4><div class="choice-effects">'+seg.join(' → ')+(uP>0?' · cash value keeps compounding behind the loan':'')+'</div></div>');
  // Debt-averse alternative: just write the whole check from cash (a real choice — but that cash stops working for you).
  if(cashAvail>=taxOwed&&(pb>0||res>0))choices.push('<div class="choice-card fade-in" onclick="Game.resolveTax(\'cash\','+taxOwed+')"><h4>Just write a check from '+(sep?'personal cash':'cash')+'</h4><div class="choice-effects">−$'+this.fmt(taxOwed)+(sep?' personal cash':' cash')+' · simple, but that money stops compounding for you</div></div>');
 }else{
  const affordable=pb+res+cashAvail,rest=taxOwed-affordable;
  choices.push('<div class="choice-card fade-in" onclick="Game.resolveTax(\'installment\','+taxOwed+')"><h4>Pay what you can + IRS installment plan</h4><div class="choice-effects">Pays '+this.fmt(affordable)+' now (policy → reserve → cash); the '+this.fmt(rest)+' shortfall goes on an IRS plan (~8%/yr penalties &amp; interest, lien risk)</div></div>');
 }
 // The escape hatch — defer the whole bill onto an IRS plan. Realistic: an extension is time to FILE, never time to PAY, so penalties + interest run and a lien can attach.
 choices.push('<div class="choice-card fade-in" onclick="Game.resolveTax(\'cant_pay\','+taxOwed+')"><h4>Can\'t pay now — put it all on an IRS plan</h4><div class="choice-effects">+$'+this.fmt(taxOwed)+' tax debt · ~8%/yr penalties &amp; interest · lien risk (hurts borrowing) · +audit risk</div></div>');
}
document.getElementById('event-choices').innerHTML=choices.join('');this.currentEvent=null;},

resolveTax(method,amount){const s=this.state,sep=this.isSeparated(),cashKey=sep?'personal_cash':'cash';let narrative='';
amount=Math.max(0,Math.round(amount||0));
// Draw the bill from real sources in the advisor's order — tax-free policy loan (up to ~90% of cash value), then the earmarked reserve, then cash. Each draw is capped at what's actually available, so nothing ever goes negative. Returns what's still unpaid.
const drawWaterfall=(owe)=>{let uP=0,uR=0,uC=0,rem=owe;const pb=this._policyBorrowable();if(rem>0&&pb>0){uP=Math.min(rem,pb);s.insurance_loan_balance=(s.insurance_loan_balance||0)+uP;rem-=uP;}if(rem>0&&(s.tax_reserve||0)>0){uR=Math.min(rem,s.tax_reserve);s.tax_reserve-=uR;rem-=uR;}if(rem>0){const c=Math.max(0,s[cashKey]||0);uC=Math.min(rem,c);s[cashKey]=(s[cashKey]||0)-uC;rem-=uC;}return{uP,uR,uC,unpaid:rem};};
if(amount<=0){narrative='No tax owed this year — your deductions and write-offs covered it. File and move on.';}
else if(method==='cash'){s[cashKey]=(s[cashKey]||0)-amount;if(sep)s.personal_tax_ytd=(s.personal_tax_ytd||0)+amount;narrative='Check written — clean, but that cash is gone. The wealthy pay the same bill by borrowing against a policy so their money never stops compounding.';}
...
// showCheckpoint() (the old month-24 "Two-Thirds There" screen) removed 2026-07-04 — checkpoints are
// 18/36 only now; m24 just quietly auto-saves (see the episodic-structure comment above). Kept
// continueFromCheckpoint() below since showPart1Finale()'s "Begin Part 2" button still uses it.
...
const passive=Math.round((s.other_monthly_revenue||0)+(s._passive_income_active?this._policyPassiveMonthly():0)+this._pbCarry(s));
...
html+='<div style="text-align:center;font-size:1rem;font-weight:800;color:'+rank.c+';margin:6px 0 2px;">'+rank.t+'</div>';
html+='<div class="checkpoint-label">PART 1 SCORE</div><div class="checkpoint-score">'+composite+' <span style="font-size:0.9rem;color:var(--text2)">/ 600</span></div>';
html+='<div style="text-align:center;font-size:0.62rem;color:var(--text2);margin-top:-4px;">scored on what Part 1 is about — leverage, protection, and your passive engine</div>';
...
this.autoSave();
html+='<button class="btn-primary" onclick="Game.continueFromCheckpoint()">▶ Begin Part 2 — Watch It Compound</button>';
html+='<div style="text-align:center;font-size:0.72rem;color:var(--text2);margin-top:6px;">Part 2 (months 19–36): the machine runs without you — scale passive income, upgrade your lifestyle, and reach Paradise.</div>';
html+='<button class="btn-outline" onclick="Game.endGame()" style="margin-top:10px;">🏁 Finish here &amp; post my Part 1 score</button>';
if(this.archetype&&this.archetype.id==='new')html+='<div style="margin-top:14px;background:linear-gradient(135deg,rgba(212,175,55,0.15),rgba(59,130,246,0.1));border:1px solid var(--gold);border-radius:var(--radius-sm);padding:12px 14px;"><div style="font-size:0.82rem;font-weight:700;color:var(--gold);margin-bottom:5px;">🔁 New Game+ Unlocked!</div><div style="font-size:0.72rem;color:var(--text2);line-height:1.5;">You completed <strong>Part 1</strong> — <strong>New Game+</strong> is unlocked: a fresh sandbox run where you set your own starting hand (and can begin with Epic Life). Your progress is saved above; pick <strong>🔁 New Game+</strong> on the title screen anytime.</div></div>';
{const _co=(s.company_name||'').trim(),_dt=new Date().toISOString().split('T')[0];html+='<div style="margin-top:14px;background:rgba(16,185,129,0.08);border:1px solid var(--accent);border-radius:var(--radius-sm);padding:11px 14px;font-size:0.74rem;color:var(--text2);line-height:1.5;">💾 <strong style="color:var(--accent);">Progress auto-saved</strong>'+(_co?' — '+this._esc(_co):'')+' · '+_dt+'.<br>Close anytime and continue from <strong>Continue</strong> on the title screen.</div>';}
...
// Extended (owner, 2026-07-04) to also surface the ENERGY GENERATION effect — Mastery drives your
// monthly recovery rate (calcEnergyRecovery: max(4, 6+mastery×0.10)/mo), not just the one-time energy
// stat change above — and a "next level" hint naming the point gap to the next Mastery tier.
...
const recB=Math.max(4,Math.round(6+mB*0.10)),recA=Math.max(4,Math.round(6+mA*0.10));
if(recA!==recB)rows+='<div style="display:flex;justify-content:space-between;font-size:0.78rem;padding:2px 0;"><span style="color:var(--text2)">🔋 Energy generation/mo</span><span><span style="color:var(--text2)">+'+recB+'</span> <span style="color:'+(recA>recB?'var(--accent)':'var(--red)')+';font-weight:700;">→ +'+recA+'</span></span></div>';
if(!rows&&mA===mB)return '';const mUp=mA>=mB;
// Next-tier hint (tiers match the color thresholds used everywhere else: <30 red, 30-60 gold, 60+ blue). Only announces reaching the top tier once, on the actual crossing, so it doesn't repeat every month after.
let nextLine='';
if(mA<30)nextLine='🎯 <strong style="color:var(--gold);">'+(30-mA)+'</strong> more point'+((30-mA)===1?'':'s')+' to reach <strong>Developing</strong> Mastery (faster energy recovery)';
else if(mA<60)nextLine='🎯 <strong style="color:var(--gold);">'+(60-mA)+'</strong> more point'+((60-mA)===1?'':'s')+' to reach <strong>Strong</strong> Mastery (faster energy recovery)';
else if(mB<60)nextLine='🏅 You\'ve reached Strong Mastery — the top tier';
if(nextLine)rows+='<div style="font-size:0.74rem;color:var(--text2);margin-top:5px;padding-top:5px;border-top:1px dashed var(--border);">'+nextLine+'</div>';
...
{done:c('buy_str')||(s._str_units||0)>0,ids:['buy_str'],name:'Cash-Flow on Overdrive',got:'You ran a short-term rental — double the cash flow, and a tax shield against your active income.',miss:'Short-term rentals were on the menu — higher cash flow and the STR tax loophole, left untapped.'},
{done:c('cash_out_refi'),ids:['cash_out_refi'],name:'Recycle Your Capital',got:'You refinanced and pulled your equity back out tax-free to redeploy — the BRRRR engine.',miss:'A cash-out refinance was available — you left your capital trapped in equity instead of recycling it.'},
{done:c('private_banking'),ids:['private_banking'],name:'Your Assets, Working Twice',got:'You borrowed against your portfolio while it kept compounding — leverage without selling.',miss:'A pledged asset line was on the menu — cheap liquidity that keeps your assets invested, untapped.'},
...
this.showScreen('end-screen');const scores=this.calculateFinalScores(),arch=this.determineArchetype(scores),composite=this._compositeFor(scores);
...
_saveDefaults(){return {_asset_units:0,_asset_income:0,_keyman_active:false,_keyman_units:0,_keyman_premium:0,_keyman_claims_total:0,_credit_liquidated_total:0,_credit_liquidate_fees:0,_concierge_focus:'balanced',_concierge_paused:false,_q4_event_seen:false,_holding_company:false,_naics_ok:false,_rehire:{},_epic_savings_total:0,company_culture:45,credit_inquiries:0,_operator_count:0,_equip_income:0,_operator_assets:0,_operator_haircut_applied:0,_policyRescue:0};},
...
// Passive, mostly tax-free, monthly income — same canonical formula as showPassiveIncome()/Financial
// Health's dashboard (other_monthly_revenue already carries real estate/STR rent, private lending, an
// acquired business, and any other deployed capital; policy income and pledged-line carry are added on
// top). Used to hand-roll its own narrower estimate here (RE door count × flat $700, investment_positions
// × 1%, pledged balance × 0.4% with no loan-cost netting) — that silently dropped every OTHER passive
// source (private lending, an acquired business, STR beyond the flat estimate) from the score entirely.
const passiveMonthly=(s.other_monthly_revenue||0)+(s._passive_income_active?this._policyPassiveMonthly():0)+this._pbCarry(s);
...
let safety=1;if(s._re_margin_called)safety*=0.5;if(s._pal_margin_called)safety*=0.6;const _reVal=reEquity+reDebt,_reLTV=_reVal>0?reDebt/_reVal:0;if(_reLTV>0.85)safety*=0.6;else if(_reLTV>0.75)safety*=0.85;if(badDebt>0)safety*=0.85;
...
// Part 1 (m1–18) is about BUILDING the machine — score the build pillars (leverage, protection, the passive engine, net worth). Lifestyle & freedom are the Part 2 payoff, so Part 1 is NOT gated on lifestyle.
calcPart1Composite(scores){const w={leverage_efficiency:0.30,protection:0.25,passive_income:0.30,net_worth:0.15};let c=0;for(const k in w)c+=(scores[k]||0)*w[k];return Math.round(c*6);},
_part1Rank(comp){if(comp>=440)return{t:'🏗️ Machine Builder',c:'var(--gold)'};if(comp>=300)return{t:'⚙️ Operator',c:'var(--accent)'};if(comp>=170)return{t:'🔧 Builder',c:'var(--accent)'};return{t:'🌱 Bootstrapper',c:'var(--text2)'};},
// The composite that fits the endpoint: Part-1 weighting through m18 (build pillars, no lifestyle gate); full 6-pillar lifestyle-gated composite after.
_compositeFor(scores){return (this.month||0)<=18?this.calcPart1Composite(scores):this.calcComposite(scores);},
