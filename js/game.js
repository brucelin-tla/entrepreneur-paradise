...
{label:'Revenue/mo',value:this.fmtMoney(s.monthly_revenue),color:'positive'},
...
const moneyBar='<div class="stat-card wide" style="display:flex;align-items:center;justify-content:space-around;text-align:center;padding:10px 6px;"><div style="flex:1;"><div style="font-size:1.1rem;font-weight:700;color:'+cashCol+';">'+this.fmtMoney(s.cash)+'</div><div class="stat-label">Cash</div></div><div style="width:1px;height:34px;background:var(--border);"></div><div style="flex:1.5;cursor:pointer;" onclick="Game.showCreditAvail()"><div style="font-size:1.1rem;font-weight:700;color:'+(totalAvail>0?'var(--accent)':'var(--text2)')+';">'+this.fmtMoney(totalAvail)+'</div><div class="stat-label">Credit avail · P'+persUtil+'/B'+bizUtil+'% used <span class="info-btn">i</span></div></div></div>';
